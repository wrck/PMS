...
public class TokenResponse extends Response<Object> implements Serializable {
	...
	public TokenResponse expireTime(String expireTime) {
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.tokenType, response.tokenType) && Objects.equals(this.expiresIn, response.expiresIn)
				...
				&& Objects.equals(this.errorCodes, response.errorCodes)
				&& Objects.equals(this.timestamp, response.timestamp)
				&& Objects.equals(this.traceId, response.traceId)
				&& Objects.equals(this.correlationId, response.correlationId)
				&& Objects.equals(this.errorUri, response.errorUri);
	}
