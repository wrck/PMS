...
|------|------|----------|---------------|----------|
| PMS-struts Action | Struts2 2.3.35 | `*.action` | 200+ | [PMS-struts Action 方法参考](../../PMS-struts/docs/02-modules/action-methods-reference.md) |
...
| SPMS Action | Struts2 2.3.35 | `*.action` | 150+ | [SPMS 模块文档](../../SPMS/docs/02-模块/) |
...
| URL 模式 | 框架 | 处理器 |
|---------|------|--------|
| `*.action` | Struts2 2.3.35（PMS-struts）/ 2.5.30（PMS-springmvc 兼容） | StrutsPrepareAndExecuteFilter |
