			...
			<li class="dropdown user user-menu">
				...
				<ul class="dropdown-menu pt-0">
					...
					<li class="user-footer">
						<div class="pull-left">
							<a href="${pageContext.request.contextPath}/pm/user/<shiro:principal property='userId'/>.html" class="btn btn-default btn-flat"><spring:message code="sys.personal.setting"/></a>
						</div>
