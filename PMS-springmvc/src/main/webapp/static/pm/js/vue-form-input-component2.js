var FormInput = {
		...
		template: `<div v-if="isPermit">
						<template v-if="field.type == 'hidden' || !field.visible">
							<input :id="field.cssId || field.field" type="hidden" class="form-control" :class="field.cssClass" :name="field.field" :data-alias="field.alias"
						...
						<template v-else-if="field.type == 'textarea'">
							<div class="form-group display-flex" :class="getGroupClass(field) || groupTextareaClass">
								<label :for="field.cssId || field.field" style="text-align: right;" class="control-label flex-shrink-0" :style="{width: maxLabelWidth}"><span v-if="field.required" class="text-danger">*</span>{{field.name}}</label>
								<div class="flex-grow-2">
									<textarea :id="field.cssId || field.field" :type="field.type" class="form-control" :class="getSelfClass(field) || field.cssClass" :name="field.field" :data-alias="field.alias"
						...
						<template v-else-if="field.type == 'date'">
							<div class="form-group display-flex" :class="getGroupClass(field) || groupClass">
								<label :for="field.cssId || field.field" style="text-align: right;" class="control-label flex-shrink-0" :style="{width: maxLabelWidth}"><span v-if="field.required" class="text-danger">*</span>{{field.name}}</label>
								<div class="flex-grow-2">
									<input :id="field.cssId || field.field" type="text" class="form-control" :class="getSelfClass(field) || field.cssClass" :name="field.field" :data-alias="field.alias"
										:value="getFieldValue(field)" :placeholder="field.title || field.name" :style="field.cssStyle"
						...
						<template v-else-if="field.type == 'select'">
							<div class="form-group display-flex" :class="getGroupClass(field) || groupClass">
								<label :for="field.cssId || field.field" style="text-align: right;" class="control-label flex-shrink-0" :style="{width: maxLabelWidth}"><span v-if="field.required" class="text-danger">*</span>{{field.name}}</label>
								<div class="flex-grow-2">
									<select :id="field.cssId || field.field" type="search" class="form-control" :class="getSelfClass(field) || field.cssClass" :name="field.field" :data-alias="field.alias"
										:value="getFieldValue(field)" :placeholder="field.title || field.name" :style="field.cssStyle"
										:disabled="field.disabled || fieldReadonly" :readonly="fieldReadonly" :required="field.required">
									<option :value="item[field.extValue]" v-if="((parseValue(field, 'extData') || {}).data || field.extData).length"  v-for="item in ((parseValue(field, 'extData') || {}).data || field.extData)" :selected="item[field.extValue] == getFieldValue(field)" >{{item[field.extKey]}}</option>
									</select>
								</div>
							</div>
						</template>
						...
						<template v-else-if="field.type == 'autocomplete'">
							<div class="form-group display-flex" :class="getGroupClass(field) || groupClass">
								<label :for="field.cssId || field.field" style="text-align: right;" class="control-label flex-shrink-0" :style="{width: maxLabelWidth}"><span v-if="field.required" class="text-danger">*</span>{{field.name}}</label>
								<div class="flex-grow-2">
									<input :id="field.cssId || field.field" type="search" class="form-control" :class="getSelfClass(field) || field.cssClass" :name="field.field" :data-alias="field.alias"
										:value="getFieldValue(field)" :data-selected="getFieldValue(field)" :placeholder="field.title || field.name" :style="field.cssStyle"
										:disabled="field.disabled || fieldReadonly" :readonly="fieldReadonly" :required="field.required"
						...
						<template v-else-if="field.type == 'inputs'">
							<div class="form-group display-flex" :class="getGroupClass(field) || groupClass">
								<label :for="field.cssId || field.field" style="text-align: right;" class="control-label flex-shrink-0" :style="{width: maxLabelWidth}"><span v-if="field.required" class="text-danger">*</span>{{field.name}}</label>
								<div class="flex-grow-2">
									<input :id="input.cssId || input.field" v-for="input in field.inputs" :type="dataType == 'table' && input.searchable ? 'search' : 'text'" class="form-control" :class="getSelfClass(input) || input.cssClass" :name="input.field" :data-alias="input.alias"
						...
						<template v-else-if="field.type == 'file'">
							<div class="form-group display-flex" :class="getGroupClass(field) || groupClass">
								...
								<div class="flex-grow-2">
									...
									<input :id="field.cssId || field.field" :type="dataType == 'table' && field.searchable ? 'search' : field.type" class="form-control" :class="getSelfClass(field) || field.cssClass" 
										:disabled="field.disabled" :readonly="fieldReadonly" :required="field.required" autocomplete="off" :style="field.cssStyle" 
						...
						<template v-else>
							<div class="form-group display-flex" :class="getGroupClass(field) || groupClass">
								<label :for="field.cssId || field.field" style="text-align: right;" class="control-label flex-shrink-0" :style="{width: maxLabelWidth}"><span v-if="field.required" class="text-danger">*</span>{{field.name}}</label>
								<div class="flex-grow-2">
									<input :id="field.cssId || field.field" :type="dataType == 'table' && field.searchable ? 'search' : field.type" class="form-control" :class="getSelfClass(field) || field.cssClass" :name="field.field" :data-alias="field.alias"
