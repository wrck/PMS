						...
						<template v-else-if="field.type == 'radio'">
							<div class="form-group display-flex" :class="getGroupClass(field) || groupClass">
								...
								<template v-for="item in getDataValue(field.extData)">
									<label :for="field.field + '_' + item[field.extValue]" style="text-align: right;" class="control-label flex-shrink-0">{{item[field.extKey]}}
									<input :id="field.field + '_' + item[field.extValue]" :type="field.type" :class="getSelfClass(field) || field.cssClass" :name="field.field" :data-alias="field.alias"
