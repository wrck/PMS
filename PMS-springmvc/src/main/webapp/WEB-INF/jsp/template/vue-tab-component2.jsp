	...
	<div :id="tabContainerId" class="tab-content box box-primary mt-1">
		<ul :id="tabWrapperId" class="nav nav-tabs">
			<li v-for="navTab in navTabList">
				<a :href="'#' + navTab.type + 'Tab' + timestamp" data-toggle="tab" class="tab-bg-primary" aria-expanded="true" @click.native="refreshNavTab($event, navTab)">{{navTab.title}}<span class="tab-operation fa fa-refresh ml-05" @click="refreshNavTab($event, navTab)"></span></a>
			</li>
		</ul>
