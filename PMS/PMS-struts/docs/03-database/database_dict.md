...
| empID | int(10) | NO | - | UNI | empID | 员工ID，逻辑外键 -> ehr_employee.empID |
| workNo | varchar(25) | NO | '' | MUL | 工号 | 员工工号 |
| compID | int(10) | NO | - | | 公司id | 所属公司ID，逻辑外键 -> ehr_company.compID |
| depIDs | varchar(4096) | NO | '' | | 从ehr同步数据生成的部门权限，固定的 | 员工可访问的部门ID列表，逗号分隔 |
| extraDepIDs | varchar(4096) | NO | '' | | 额外授权的部门权限 | 手动额外授权的部门ID列表 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| jobID | int(10) | NO | - | PRI | 岗位ID | 岗位唯一标识，逻辑外键 -> ehr_employee.jobID |
| jobCode | varchar(20) | YES | - | | 岗位编码 | 岗位业务编码 |
| jobName | varchar(100) | YES | - | | 岗位名称 | 岗位名称 |
| jobAbbr | varchar(100) | YES | - | | 岗位简称 | 岗位缩写 |
| compID | int(10) | YES | - | MUL | 公司ID | 所属公司ID，逻辑外键 -> ehr_company.compID |
| depID | int(10) | YES | - | MUL | 部门ID | 所属部门ID，逻辑外键 -> ehr_department.depID |
| jobGrade | int(10) | YES | - | | 岗位级别 | 岗位层级等级 |
| jobType | int(10) | YES | - | | 岗位类型 | 岗位类型分类 |
| isDisabled | bit(1) | YES | - | | 失效状态 | 岗位是否已失效 |
...
|--------|----------|------|--------|------|----------|----------|
| id | int(10) | NO | - | PRI, AUTO_INCREMENT | 主键 | 自增主键 |
| empID | int(10) | NO | - | | 员工ID | 逻辑外键 -> ehr_employee.empID |
| workNo | varchar(100) | YES | - | | 工号 | 员工工号 |
| loginName | varchar(100) | YES | - | | 登录名 | PMS系统登录用户名，逻辑外键 -> fnd_user_info.username |
| loginType | int(10) | YES | - | | 登录类型 | 登录方式分类 |
| compID | int(10) | YES | - | | 公司ID | 逻辑外键 -> ehr_company.compID |
| depID | int(10) | YES | - | | 部门ID | 逻辑外键 -> ehr_department.depID |
| updateBy | varchar(50) | YES | - | | 更新人 | 最后修改人 |
| updateTime | datetime | YES | - | | 更新时间 | 最后修改时间 |
...
| compGrade | int(10) | YES | - | | 公司级别 | 公司层级等级 |
| compType | int(10) | YES | - | | 公司类别 | 公司类型分类 |
| compArea | int(10) | YES | - | | 公司区域 | 公司所在区域 |
| effectDate | datetime | YES | - | | 成立时间 | 公司成立日期 |
| lawyer | varchar(50) | YES | - | | 法人 | 公司法人代表 |
| address | varchar(200) | YES | - | | 地址 | 公司办公地址 |
| regAddress | varchar(200) | YES | - | | 注册地址 | 公司注册地址 |
...
| postCode | varchar(50) | YES | - | | 邮编 | 公司邮政编码 |
| webSite | varchar(100) | YES | - | | 网站 | 公司网站地址 |
| isDisabled | bit(1) | YES | - | | 失效状态 | 公司是否已失效 |
| disabledDate | datetime | YES | - | | 失效时间 | 公司失效的时间戳 |
| remark | varchar(500) | YES | - | | 备注 | 备注信息 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(10) | NO | - | PRI, AUTO_INCREMENT | 主键 | 用户唯一标识 |
| username | varchar(50) | NO | '' | UNI | 用户名 | 登录用户名，唯一 |
| password | varchar(200) | NO | '' | | 密码 | 加密后的登录密码 |
| email | varchar(100) | YES | - | | 邮箱 | 用户邮箱地址 |
| realName | varchar(100) | YES | - | | 真实姓名 | 用户真实姓名 |
| status | int(10) | YES | - | | 状态 | 用户状态，1=启用，0=禁用 |
| roleIds | varchar(200) | YES | - | | 角色ID列表 | 用户关联的角色ID，分号分隔 |
| isemail | int(10) | YES | - | | 是否发送邮件 | 邮件通知开关 |
| pwdoverdue | datetime | YES | - | | 密码过期时间 | 密码有效期截止时间 |
| defaultPage | varchar(200) | YES | - | | 默认首页 | 用户登录后的默认跳转页面路径 |
| dpNo | varchar(50) | YES | - | | 部门编号 | 用户所属部门编号 |
| customInfo | text | YES | - | | 自定义信息 | JSON格式扩展信息 |
| createBy | varchar(50) | YES | - | | 创建人 | 记录创建人 |
| createTime | datetime | YES | - | | 创建时间 | 记录创建时间 |
| updateBy | varchar(50) | YES | - | | 更新人 | 最后修改人 |
| updateTime | datetime | YES | - | | 更新时间 | 最后修改时间 |
| effectiveFrom | datetime | YES | - | | 生效开始时间 | 用户有效期起始 |
| effectiveTo | datetime | YES | - | | 生效结束时间 | 用户有效期截止 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(10) | NO | - | PRI | 用户ID | 逻辑外键 -> t_user.id |
| username | varchar(50) | NO | '' | | 用户名 | 登录用户名 |
| password | varchar(200) | NO | '' | | 密码 | 加密后的登录密码 |
| email | varchar(100) | YES | - | | 邮箱 | 用户邮箱地址 |
| realName | varchar(100) | YES | - | | 真实姓名 | 用户真实姓名 |
| status | int(10) | YES | - | | 状态 | 用户状态 |
| roleIds | varchar(200) | YES | - | | 角色ID列表 | 关联角色ID列表 |
| isemail | int(10) | YES | - | | 是否发送邮件 | 邮件通知开关 |
| pwdoverdue | datetime | YES | - | | 密码过期时间 | 密码有效期截止 |
| defaultPage | varchar(200) | YES | - | | 默认首页 | 登录默认页面 |
| dpNo | varchar(50) | YES | - | | 部门编号 | 所属部门编号 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(10) | NO | - | PRI, AUTO_INCREMENT | 主键 | 角色唯一标识 |
| roleName | varchar(100) | NO | '' | | 角色名称 | 角色显示名称 |
| status | int(10) | YES | - | | 状态 | 角色状态，1=启用，0=禁用 |
| defaultPage | varchar(200) | YES | - | | 默认首页 | 该角色用户登录后的默认页面 |
| remark | varchar(500) | YES | - | | 备注 | 角色描述备注 |
| createBy | varchar(50) | YES | - | | 创建人 | 记录创建人 |
| createTime | datetime | YES | - | | 创建时间 | 记录创建时间 |
| updateBy | varchar(50) | YES | - | | 更新人 | 最后修改人 |
| updateTime | datetime | YES | - | | 更新时间 | 最后修改时间 |
| effectiveFrom | datetime | YES | - | | 生效开始时间 | 角色有效期起始 |
| effectiveTo | datetime | YES | - | | 生效结束时间 | 角色有效期截止 |
...
|--------|----------|------|--------|------|----------|----------|
| id | int(10) | NO | - | PRI, AUTO_INCREMENT | 主键 | 自增主键 |
| roleId | int(10) | NO | - | | 角色ID | 逻辑外键 -> t_role.id |
| menuCode | varchar(50) | NO | '' | | 菜单编码 | 逻辑外键 -> t_menu.menuCode |
| menuValue | int(10) | YES | - | | 菜单权限值 | 菜单权限值，1=有权限 |
...
|--------|----------|------|--------|------|----------|----------|
| id | int(10) | NO | - | PRI, AUTO_INCREMENT | 主键 | 自增主键 |
| roleId | int(10) | NO | - | MUL | 角色ID | 逻辑外键 -> t_role.id |
| permissionId | int(10) | NO | - | | 权限ID | 逻辑外键 -> t_permission.id |
...
|--------|----------|------|--------|------|----------|----------|
| id | int(10) | NO | - | PRI, AUTO_INCREMENT | 主键 | 自增主键 |
| userId | int(10) | NO | - | MUL | 用户ID | 逻辑外键 -> t_user.id |
| roleId | int(10) | NO | - | MUL | 角色ID | 逻辑外键 -> t_role.id |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(10) | NO | - | PRI, AUTO_INCREMENT | 主键 | 菜单唯一标识 |
| menuCode | varchar(50) | NO | '' | | 菜单编码 | 菜单业务编码，唯一标识菜单项 |
| menuName | varchar(100) | NO | '' | | 菜单名称 | 菜单显示名称 |
| menuLevel | int(10) | YES | - | | 菜单层级 | 菜单在树中的层级 |
| superId | int(10) | YES | - | | 父菜单ID | 逻辑外键 -> t_menu.id |
| path | varchar(200) | YES | - | | 菜单路径 | 菜单对应的URL路径 |
| effectiveFrom | datetime | YES | - | | 生效开始时间 | 菜单有效期起始 |
| effectiveTo | datetime | YES | - | | 生效结束时间 | 菜单有效期截止 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(10) | NO | - | PRI, AUTO_INCREMENT | 主键 | 权限唯一标识 |
| permissionName | varchar(100) | NO | '' | | 权限名称 | 权限显示名称 |
| permissionCode | varchar(100) | NO | '' | | 权限编码 | 权限业务编码 |
| resourceId | int(10) | YES | - | | 资源ID | 逻辑外键 -> t_resource.id |
| permissionType | varchar(50) | YES | - | | 权限类型 | 权限分类 |
| description | varchar(500) | YES | - | | 描述 | 权限描述信息 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(10) | NO | - | PRI, AUTO_INCREMENT | 主键 | 资源唯一标识 |
| resourceName | varchar(100) | NO | '' | | 资源名称 | 资源显示名称 |
| resourceCode | varchar(100) | NO | '' | | 资源编码 | 资源业务编码 |
| resourceType | varchar(50) | YES | - | | 资源类型 | 资源分类 |
| description | varchar(500) | YES | - | | 描述 | 资源描述信息 |
...
### 2.11 t_data_field_relation -- 数据字段关系
...
| dataId | int(10) | YES | 0 | | 数据实例ID | 数据对象实例标识 |
| field | varchar(128) | NO | - | | 字段 | 原始字段名 |
| alias | varchar(128) | YES | - | | 别名 | 字段别名/映射名 |
...
### 2.12 t_data_operation -- 数据导入导出控制
...
| dataName | varchar(255) | NO | - | | 数据名 | 数据对象名称 |
| dataType | varchar(255) | NO | - | | 数据类型 | 数据对象类型 |
| operationType | varchar(50) | NO | - | | 操作类型 | 导入/导出类型标识 |
| templateFile | varchar(500) | YES | - | | 模板文件 | 导入导出模板文件路径 |
| description | varchar(500) | YES | - | | 描述 | 操作描述信息 |
...
|--------|----------|------|--------|------|----------|----------|
| id | int(10) | NO | - | PRI, AUTO_INCREMENT | 主键 | 自增主键 |
| dictCode | varchar(100) | NO | '' | | 字典编码 | 字典项编码 |
| dictName | varchar(200) | NO | '' | | 字典名称 | 字典项名称 |
| dictValue | text | YES | - | | 字典值 | 字典项值 |
| dictType | varchar(50) | YES | - | | 字典类型 | 字典分类 |
| parentId | int(10) | YES | - | | 父级ID | 父字典项ID |
| sort | int(10) | YES | - | | 排序 | 显示排序值 |
| remark | varchar(500) | YES | - | | 备注 | 备注信息 |
...
|--------|----------|------|--------|------|----------|----------|
| id | int(10) | NO | - | PRI, AUTO_INCREMENT | 主键 | 自增主键 |
| fileName | varchar(500) | YES | - | | 文件名 | 下载的文件名 |
| downloadUser | varchar(100) | YES | - | | 下载用户 | 下载操作的用户名 |
| downloadTime | datetime | YES | - | | 下载时间 | 下载操作时间 |
| fileType | varchar(50) | YES | - | | 文件类型 | 下载文件类型 |
| fileSize | bigint(20) | YES | - | | 文件大小 | 下载文件大小(字节) |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(10) | NO | - | PRI, AUTO_INCREMENT | 主键 | 文件唯一标识 |
| fileName | varchar(500) | YES | - | | 文件名 | 原始文件名 |
| filePath | varchar(500) | YES | - | | 文件路径 | 文件存储路径 |
| fileSize | bigint(20) | YES | - | | 文件大小 | 文件大小(字节) |
| fileType | varchar(50) | YES | - | | 文件类型 | 文件MIME类型 |
| fileTypeId | int(10) | YES | - | | 文件类型ID | 逻辑外键 -> t_file_type.id |
| uploadUser | varchar(100) | YES | - | | 上传用户 | 上传操作的用户名 |
| uploadTime | datetime | YES | - | | 上传时间 | 文件上传时间 |
| description | varchar(500) | YES | - | | 描述 | 文件描述信息 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(10) | NO | - | PRI, AUTO_INCREMENT | 主键 | 文件类型唯一标识 |
| typeName | varchar(100) | NO | '' | | 类型名称 | 文件类型名称 |
| typeCode | varchar(50) | NO | '' | | 类型编码 | 文件类型编码 |
| description | varchar(500) | YES | - | | 描述 | 类型描述信息 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(10) | NO | - | PRI, AUTO_INCREMENT | 主键 | 邮件记录唯一标识 |
| mailTo | text | YES | - | | 收件人 | 邮件收件人地址 |
| mailCc | text | YES | - | | 抄送人 | 邮件抄送人地址 |
| mailBcc | text | YES | - | | 密送人 | 邮件密送人地址 |
| subject | varchar(500) | YES | - | | 主题 | 邮件主题 |
| content | longtext | YES | - | | 内容 | 邮件正文内容 |
| sendTime | datetime | YES | - | | 发送时间 | 邮件发送时间 |
| sendStatus | int(10) | YES | - | | 发送状态 | 0=待发送，1=已发送，2=发送失败 |
| sendCount | int(10) | YES | - | | 发送次数 | 邮件发送尝试次数 |
| mailFrom | varchar(200) | YES | - | | 发件人 | 邮件发件人地址 |
| templateCode | varchar(100) | YES | - | | 模板编码 | 逻辑外键 -> t_notify_template.templateCode |
| retryTime | datetime | YES | - | | 重试时间 | 最后重试发送时间 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(10) | NO | - | PRI, AUTO_INCREMENT | 主键 | 模板唯一标识 |
| templateCode | varchar(100) | NO | '' | UNI | 模板编码 | 模板业务编码，唯一标识 |
| templateName | varchar(200) | YES | - | | 模板名称 | 模板显示名称 |
| notificationSubject | varchar(500) | YES | - | | 通知主题 | 通知标题模板 |
| notificationContent | text | YES | - | | 通知内容 | 通知正文模板，支持变量占位符 |
| templateType | varchar(50) | YES | - | | 模板类型 | 模板分类（邮件/短信/站内信） |
| effectiveFrom | datetime | YES | - | | 生效开始时间 | 模板有效期起始 |
| effectiveTo | datetime | YES | - | | 生效结束时间 | 模板有效期截止 |
...
|--------|----------|------|--------|------|----------|----------|
| id | int(10) | NO | - | PRI, AUTO_INCREMENT | 主键 | 自增主键 |
| syncType | varchar(100) | YES | - | | 同步类型 | 同步操作类型（如SAP订单同步、SMS项目同步等） |
| syncSource | varchar(100) | YES | - | | 同步来源 | 数据来源系统（SAP/D365/SMS/OA/CRM/ITR/License/SSE） |
| syncTarget | varchar(100) | YES | - | | 同步目标 | 数据目标表名 |
| startTime | datetime | YES | - | | 开始时间 | 同步操作开始时间 |
| endTime | datetime | YES | - | | 结束时间 | 同步操作结束时间 |
| status | int(10) | YES | - | | 状态 | 0=进行中，1=成功，2=失败 |
| recordCount | int(10) | YES | - | | 记录数 | 本次同步处理的记录数 |
| errorMessage | text | YES | - | | 错误信息 | 同步失败时的错误信息 |
| operator | varchar(100) | YES | - | | 操作人 | 执行同步操作的用户 |
...
|--------|----------|------|--------|------|----------|----------|
| id | int(10) | NO | - | PRI, AUTO_INCREMENT | 主键 | 自增主键 |
| syncName | varchar(100) | NO | '' | | 同步名称 | 同步任务名称标识 |
| lastSyncTime | datetime | YES | - | | 上次同步时间 | 增量同步的起始时间点 |
| lastSyncId | varchar(100) | YES | - | | 上次同步ID | 增量同步的起始ID |
| lastRecordCount | int(10) | YES | - | | 上次记录数 | 上次同步的记录数 |
| updateBy | varchar(50) | YES | - | | 更新人 | 最后修改人 |
| updateTime | datetime | YES | - | | 更新时间 | 最后修改时间 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | bigint(20) | NO | - | PRI, AUTO_INCREMENT | 主键 | 日志唯一标识 |
| logType | varchar(50) | YES | - | | 日志类型 | 操作类型分类 |
| logContent | longtext | YES | - | | 日志内容 | 操作详情 |
| operator | varchar(100) | YES | - | | 操作人 | 执行操作的用户名 |
| operateTime | datetime | YES | - | | 操作时间 | 操作执行时间 |
| ipAddress | varchar(50) | YES | - | | IP地址 | 操作来源IP |
| module | varchar(100) | YES | - | | 模块 | 操作所属功能模块 |
| result | varchar(50) | YES | - | | 结果 | 操作结果（成功/失败） |
...
| name | varchar(200) | YES | - | | 变量名称 | 变量显示名称 |
| var | text | YES | - | | 变量值 | 变量的值 |
| varType | varchar(50) | YES | - | | 变量类型 | 变量值类型（string/number/date等） |
| description | varchar(500) | YES | - | | 描述 | 变量描述信息 |
...
### 2.23 t_user_login_record -- 用户登录记录
...
|--------|----------|------|--------|------|----------|----------|
| id | int(10) | NO | - | PRI, AUTO_INCREMENT | 主键 | 自增主键 |
| userId | int(10) | NO | - | | 用户ID | 逻辑外键 -> t_user.id |
| username | varchar(50) | YES | - | | 用户名 | 登录用户名 |
| loginTime | datetime | YES | - | | 登录时间 | 登录操作时间 |
| loginIp | varchar(50) | YES | - | | 登录IP | 登录来源IP地址 |
| loginType | varchar(50) | YES | - | | 登录类型 | 登录方式（密码/SSO等） |
| logoutTime | datetime | YES | - | | 登出时间 | 登出操作时间 |
| sessionId | varchar(200) | YES | - | | 会话ID | 登录会话标识 |
...
#### 3.1.1 pm_order_data_from_erp -- ERP订单头汇总表
...
| contractNo | varchar(50) | YES | - | MUL | 合同号 | 销售合同编号，逻辑外键 -> pm_project_contract.contractNo |
| orderExecNumber | varchar(50) | YES | - | MUL | 订单执行号 | 订单执行编号 |
| orderCreateTime | datetime | YES | - | | 订单创建时间 | ERP系统中订单的创建时间 |
| customerRequireTime | datetime | YES | - | | 客户需求时间 | 客户要求的交付日期 |
| customerCode | varchar(50) | YES | - | | 客户编码 | ERP系统中的客户编码 |
| customerName | varchar(200) | YES | - | | 客户名称 | 客户全称 |
| projectName | varchar(200) | YES | - | | 项目名称 | ERP系统中的项目名称 |
| orderComment | text | YES | - | | 订单备注 | 订单备注信息 |
| orderType | int(10) | YES | - | MUL | 订单类型 | 0=销售订单，1=退货订单(RMA) |
| compCode | varchar(10) | YES | - | MUL | 公司编码 | 公司账套编码 |
| salesType | varchar(50) | YES | - | | 销售类型 | 销售订单类型分类 |
| customInfo | text | YES | - | | 自定义信息 | JSON格式扩展信息 |
...
#### 3.1.2 pm_order_data_from_erp_sap -- SAP订单头数据
...
与 pm_order_data_from_erp 结构相同，字段包括：id, orderNumber, contractNo, orderExecNumber, orderCreateTime, customerRequireTime, customerCode, customerName, projectName, orderComment, orderType, compCode, salesType

---

#### 3.1.3 pm_order_data_from_erp_d365 -- D365订单头数据
...
与 pm_order_data_from_erp 结构基本相同，额外包含 customInfo 字段。字段包括：id, orderNumber, contractNo, orderExecNumber, orderCreateTime, customerRequireTime, customerCode, customerName, projectName, orderComment, orderType, compCode, salesType, customInfo

---

#### 3.1.4 pm_order_data_from_erp_source -- ERP订单头源数据
...
与 pm_order_data_from_erp 结构相同，额外包含 dataSource 字段标识数据来源。
...
| orderExecNumber | varchar(50) | YES | - | MUL | 订单执行号 | 订单执行编号 |
| orderCreateTime | datetime | YES | - | | 订单创建时间 | ERP订单创建时间 |
| customerRequireTime | datetime | YES | - | | 客户需求时间 | 客户要求交付日期 |
| customerCode | varchar(50) | YES | - | | 客户编码 | ERP客户编码 |
| customerName | varchar(200) | YES | - | | 客户名称 | 客户全称 |
| projectName | varchar(200) | YES | - | | 项目名称 | ERP项目名称 |
| orderComment | text | YES | - | | 订单备注 | 订单备注 |
| orderType | int(10) | YES | - | MUL | 订单类型 | 0=销售，1=退货 |
| compCode | varchar(10) | YES | - | MUL | 公司编码 | 公司账套编码 |
| salesType | varchar(50) | YES | - | | 销售类型 | 销售类型分类 |
| customInfo | text | YES | - | | 自定义信息 | JSON扩展信息 |
| dataSource | varchar(50) | YES | - | MUL | 数据来源 | 数据来源系统标识（SAP/D365） |

---

#### 3.1.5 pm_order_line_from_erp -- ERP订单行汇总表
...
|--------|----------|------|--------|------|----------|----------|
| id | int(10) | NO | - | PRI, AUTO_INCREMENT | 主键 | 自增主键 |
| orderNumber | varchar(25) | YES | - | MUL | 订单号 | 逻辑外键 -> pm_order_data_from_erp.orderNumber |
| lineNum | varchar(20) | YES | - | | 行号 | 订单行号 |
| itemCode | varchar(50) | YES | - | MUL | 物料编码 | 产品物料编码 |
| itemDesc | varchar(500) | YES | - | | 物料描述 | 产品物料描述 |
| orderQuantity | int(10) | YES | 0 | | 订单数量 | 订单行订购数量 |
| openQuantity | int(10) | YES | 0 | | 未交数量 | 尚未交付的数量 |
| bundleCode | varchar(50) | YES | - | | 捆绑父项编码 | 捆绑销售时父项物料编码 |
| warrantyMonth | int(10) | YES | 0 | | 质保月数 | 产品质保期限（月） |
| lineType | int(10) | YES | - | MUL | 行类型 | 0=销售行，1=退货行 |
| compCode | varchar(10) | YES | - | MUL | 公司编码 | 公司账套编码 |
| profitCenter | varchar(50) | YES | - | | 利润中心 | ERP利润中心编码 |
...
#### 3.1.6 pm_order_line_from_erp_sap -- SAP订单行数据
...
与 pm_order_line_from_erp 结构相同。

---

#### 3.1.7 pm_order_line_from_erp_d365 -- D365订单行数据
...
与 pm_order_line_from_erp 结构基本相同，额外包含 realOrderExecNumber 和 customInfo 字段。
...
| itemCode | varchar(50) | YES | - | MUL | 物料编码 | 产品物料编码 |
| itemDesc | varchar(500) | YES | - | | 物料描述 | 产品物料描述 |
| orderQuantity | int(10) | YES | 0 | | 订单数量 | 订购数量 |
| openQuantity | int(10) | YES | 0 | | 未交数量 | 尚未交付数量 |
| bundleCode | varchar(50) | YES | - | | 捆绑父项编码 | 捆绑销售父项编码 |
| warrantyMonth | int(10) | YES | 0 | | 质保月数 | 质保期限（月） |
| lineType | int(10) | YES | - | MUL | 行类型 | 0=销售，1=退货 |
| compCode | varchar(10) | YES | - | MUL | 公司编码 | 公司账套编码 |
| profitCenter | varchar(50) | YES | - | | 利润中心 | 利润中心编码 |
| realOrderExecNumber | varchar(50) | YES | - | | 实际订单执行号 | D365实际订单执行编号 |
| customInfo | text | YES | - | | 自定义信息 | JSON扩展信息 |

---

#### 3.1.8 pm_order_line_from_erp_source -- ERP订单行源数据
...
与 pm_order_line_from_erp_source 结构类似，包含 dataSource 字段标识数据来源。

---

### 3.2 SMS回款计划同步表

#### 3.2.1 pm_pb_plan_from_sms -- SMS回款计划
...
#### 3.2.2 pm_pb_plan_from_sms_history -- SMS回款计划历史
...
与 pm_pb_plan_from_sms 结构相同。

---

### 3.3 OA人员同步表

#### 3.3.1 pm_person_from_oa -- OA销售人员信息
...
| salesmanMail | varchar(200) | YES | - | | 销售人员邮箱 | 销售人员邮箱地址 |
| salesmanTel | varchar(50) | YES | - | | 销售人员电话 | 销售人员联系电话 |
| department | varchar(200) | YES | - | | 部门 | 销售人员所属部门 |
| status | int(10) | YES | - | | 状态 | 人员状态 |
...
#### 3.4.1 pm_presales_lend_info_from_sms -- SMS借货信息
...
#### 3.4.2 pm_presales_lend_info_from_oa -- OA借货审批信息
...
#### 3.4.3 pm_presales_lend_detail_from_oa -- OA借货明细
...
#### 3.4.4 pm_presales_lend_product_from_sms -- SMS借货产品
...
|--------|----------|------|--------|------|----------|----------|
| id | int(10) | NO | - | PRI, AUTO_INCREMENT | 主键 | 自增主键 |
| lendInfoId | varchar(50) | YES | - | | 借货信息ID | 逻辑外键 -> pm_presales_lend_info_from_sms.lendInfoId |
| productFirstName | varchar(100) | YES | - | | 产品一级 | 产品大类名称 |
| productName | varchar(200) | YES | - | | 产品名称 | 产品名称 |
| productSubCode | varchar(50) | YES | - | | 产品小类编码 | 产品子类编码 |
| productSubModel | varchar(100) | YES | - | | 产品小类型号 | 产品子类型号 |
| productSubName | varchar(200) | YES | - | | 产品小类名称 | 产品子类名称 |
| lendNum | int(10) | YES | 0 | | 借货数量 | 借货数量 |
| memo | varchar(500) | YES | - | | 备注 | 备注信息 |
| orderNum | int(10) | YES | 0 | | 订单数量 | 已下单数量 |
| deliverNum | int(10) | YES | 0 | | 发货数量 | 已发货数量 |
| hexiaoNum | int(10) | YES | 0 | | 核销数量 | 已核销数量 |
| transferNum | int(10) | YES | 0 | | 转销数量 | 已转销数量 |
| dataSource | varchar(50) | YES | - | | 数据来源 | 数据来源系统标识 |

---

#### 3.4.5 pm_presales_lend_2_delivery_off_from_sap -- SAP发货核销
...
| lineId | int(10) | YES | - | | 行ID | 订单行ID |
| itemCode | varchar(10) | YES | - | | 物料编码 | 产品物料编码 |
| ppliCode | varchar(25) | YES | - | MUL | 销售订单号 | SAP销售订单参考号 |
| contract | varchar(50) | YES | - | MUL | 合同号 | 销售合同编号 |
| deliveryDate | datetime | YES | - | | 发货日期 | 实际发货日期 |
| rmaDate | datetime | YES | - | | RMA日期 | 退货日期 |
| dataSource | varchar(50) | YES | - | | 数据来源 | 数据来源系统标识 |
...
#### 3.4.6 pm_presales_lend_2_sale_from_sms -- SMS借转销数据
...
| orderNumber | varchar(50) | YES | - | | 订单号 | 销售订单号 |
| lineId | int(10) | YES | - | | 行ID | 订单行ID |
| contract | varchar(50) | YES | - | | 合同号 | 销售合同编号 |
| itemcode | varchar(50) | YES | - | | 物料编码 | 产品物料编码 |
| orderQty | int(10) | YES | 0 | | 订单数量 | 订单数量 |
| dlvQty | int(10) | YES | 0 | | 发货数量 | 发货数量 |
| rmaQty | int(10) | YES | 0 | | 核销数量 | 核销数量 |
| borrowNum | int(10) | YES | 0 | | 借货数量 | 借货数量 |
| dataSource | varchar(50) | YES | - | | 数据来源 | 数据来源系统标识 |

---

#### 3.4.7 pm_presales_lend_2_rma_from_sms -- SMS借货RMA数据
...
与 pm_presales_lend_2_sale_from_sms 结构类似。
...
#### 3.5.1 pm_product_info_from_crm -- CRM产品信息
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| itemCode | varchar(100) | YES | - | | item编码 | 产品物料编码 |
| productCode | varchar(100) | YES | - | | 产品大类 | 产品大类编码 |
| productSubCode | varchar(100) | YES | - | | 产品小类 | 产品子类编码 |
| itemModel | varchar(100) | YES | - | | 产品型号 | 产品型号 |
| itemDesc | varchar(500) | YES | - | | 产品描述 | 产品描述信息 |
| productFirstName | varchar(200) | YES | - | | 产品一级名称 | 产品大类名称 |
| productName | varchar(200) | YES | - | | 产品名称 | 产品名称 |
| productSubName | varchar(200) | YES | - | | 产品小类名称 | 产品子类名称 |
| productSubModel | varchar(200) | YES | - | | 产品小类型号 | 产品子类型号 |
| customInfo | text | YES | - | | 自定义信息 | JSON扩展信息 |
...
#### 3.6.1 pm_project_property_from_sms -- SMS项目属性
...
#### 3.6.2 pm_project_property_from_sms_history -- SMS项目属性历史
...
与 pm_project_property_from_sms 结构相同。

---

#### 3.6.3 pm_project_property_af_from_sms -- SMS项目资产属性
...
#### 3.6.4 pm_project_property_af_from_sms_history -- SMS项目资产属性历史
...
#### 3.6.5 pm_project_real_product_line_from_sms -- SMS实际产品行
...
#### 3.6.6 pm_project_real_product_line_from_sms_history -- SMS实际产品行历史
...
#### 3.6.7 pm_project_product_af_from_sms -- SMS产品资产
...
#### 3.6.8 pm_project_product_af_from_sms_history -- SMS产品资产历史
...
#### 3.6.9 pm_project_soleagent_lend_from_sms -- SMS总代借货
...
#### 3.6.10 pm_project_soleagent_lend_from_sms_history -- SMS总代借货历史
...
#### 3.6.11 pm_project_market_relations_from_sms -- SMS市场关系
...
#### 3.6.12 project_info_from_sms -- SMS项目信息
...
#### 3.7.1 pm_project_incident_table_from_itr -- ITR问题单
...
|--------|----------|------|--------|------|----------|----------|
| id | int(10) | NO | - | PRI, AUTO_INCREMENT | 主键 | 自增主键 |
| incidentId | varchar(50) | YES | - | | 问题单ID | ITR系统中的问题单ID |
| ticketNo | varchar(50) | YES | - | | 问题单号 | 工单编号 |
| status | varchar(50) | YES | - | | 工单状态 | 工单状态编码 |
| statusName | varchar(100) | YES | - | | 工单状态名称 | 工单状态名称 |
| caseTopic | varchar(200) | YES | - | | 问题单主题 | 问题单主题 |
| memo | text | YES | - | | 描述 | 问题描述 |
| principal | varchar(50) | YES | - | | 责任人 | 责任人域账号 |
| principalName | varchar(100) | YES | - | | 责任人名称 | 责任人姓名 |
| accepter | varchar(50) | YES | - | | 受理人 | 受理人域账号 |
| accepterName | varchar(100) | YES | - | | 受理人名称 | 受理人姓名 |
| processor | varchar(50) | YES | - | | 处理人 | 处理人域账号 |
| processorName | varchar(100) | YES | - | | 处理人名称 | 处理人姓名 |
| supplied | varchar(50) | YES | - | | 是否上报 | 是否已上报 |
| questionType | varchar(100) | YES | - | | 服务类型 | 问题服务类型 |
| questionLevel | varchar(50) | YES | - | | 问题级别 | 问题严重级别 |
| title | varchar(200) | YES | - | | 工单标题 | 工单标题 |
| acceptTime | datetime | YES | - | | 受理时间 | 受理时间 |
| productType | varchar(100) | YES | - | | 设备类型 | 产品设备类型 |
| productModel | varchar(100) | YES | - | | 设备型号 | 产品设备型号 |
| progress | text | YES | - | | 处理进展 | 处理进展描述 |
| questionReason | text | YES | - | | 问题根因 | 问题根因分析 |
| solutionType | varchar(100) | YES | - | | 解决方式 | 解决方式分类 |
| solutions | text | YES | - | | 解决方案 | 解决方案描述 |
| rmaNo | varchar(50) | YES | - | | RMA单号 | 关联RMA单号 |
| accidentNo | varchar(50) | YES | - | | 事故单号 | 关联事故单号 |
| caseType | varchar(50) | YES | - | | Case类型 | Case分类 |
| reasonFstType | varchar(100) | YES | - | | 原因大类 | 问题原因大类 |
| reasonSndType | varchar(100) | YES | - | | 原因小类 | 问题原因小类 |
| projectCode | varchar(50) | YES | - | | 项目编码 | 关联项目编码 |
| contractNo | varchar(50) | YES | - | | 合同号 | 关联合同编号 |
| barcode | varchar(50) | YES | - | | 序列号 | 设备序列号 |
| bulletinNo | varchar(50) | YES | - | | 技术公告编号 | 关联技术公告编号 |
| bugNo | varchar(50) | YES | - | | Bug单 | 关联Bug单号 |
| productLine | varchar(100) | YES | - | | 产品线 | 产品线名称 |
| url | varchar(500) | YES | - | | 链接 | ITR系统中问题单URL |
| customInfo | text | YES | - | | 自定义信息 | JSON扩展信息 |

---

#### 3.7.2 pm_project_license_info_from_license -- License授权信息
...
#### 3.7.3 pm_project_maintenance_sectary_from_sse -- SSE办事处秘书
...
#### 3.7.4 pm_project_product_config_level_info_from_crm -- CRM产品配置级别
...
#### 3.7.5 pm_project_product_lease_line_from_crm -- CRM租赁产品行
...
| processName | varchar(255) | YES | - | | 流程名称 | 流程显示名称 |
| businessId | int(10) | YES | - | | 业务ID | 关联业务表单的ID |
| businessType | varchar(50) | YES | - | | 业务类型 | 业务表单类型 |
| assignee | varchar(50) | YES | - | MUL | 办理人 | 当前任务办理人工号 |
| assigneeName | varchar(100) | YES | - | | 办理人姓名 | 当前任务办理人姓名 |
| taskName | varchar(200) | YES | - | | 任务名称 | 当前任务节点名称 |
| taskState | int(10) | YES | - | | 任务状态 | 0=待办，1=已办 |
| createTime | datetime | YES | - | | 创建时间 | 任务创建时间 |
| claimTime | datetime | YES | - | | 签收时间 | 任务签收时间 |
| endTime | datetime | YES | - | | 结束时间 | 任务完成时间 |
| processStartTime | datetime | YES | - | | 流程开始时间 | 流程启动时间 |
| projectCode | varchar(50) | YES | - | MUL | 项目编码 | 关联项目编码 |
| projectName | varchar(200) | YES | - | | 项目名称 | 项目名称 |
| customInfo | text | YES | - | | 自定义信息 | JSON扩展信息 |
...
### 4.2 pm_basic_deliver_detail -- 基础交付明细
...
|--------|----------|------|--------|------|----------|----------|
| id | int(10) | NO | - | PRI, AUTO_INCREMENT | 主键 | 自增主键 |
| deliverId | int(10) | NO | - | MUL | 交付模板ID | 逻辑外键 -> pm_basic_prj_deliver.id |
| deliverName | varchar(200) | YES | - | | 交付件名称 | 交付件名称 |
| deliverType | varchar(50) | YES | - | | 交付件类型 | 交付件分类 |
| isRequired | int(10) | YES | - | | 是否必须 | 1=必须，0=可选 |
| sortId | int(10) | YES | - | | 排序ID | 显示排序值 |
| description | varchar(500) | YES | - | | 描述 | 交付件描述 |
| effectiveFrom | datetime | YES | - | | 生效开始时间 | 有效期起始 |
| effectiveTo | datetime | YES | - | | 生效结束时间 | 有效期截止 |
...
### 4.3 pm_basic_prj_deliver -- 基础项目交付模板
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(10) | NO | - | PRI, AUTO_INCREMENT | 主键 | 交付模板唯一标识 |
| deliverName | varchar(200) | YES | - | | 模板名称 | 交付模板名称 |
| projectType | varchar(50) | YES | - | | 项目类型 | 适用项目类型 |
| description | varchar(500) | YES | - | | 描述 | 模板描述 |
| effectiveFrom | datetime | YES | - | | 生效开始时间 | 有效期起始 |
| effectiveTo | datetime | YES | - | | 生效结束时间 | 有效期截止 |
...
### 4.4 pm_column_of_relationship -- 列关系映射
...
|--------|----------|------|--------|------|----------|----------|
| id | int(10) | NO | - | PRI, AUTO_INCREMENT | 主键 | 自增主键 |
| tableName | varchar(100) | YES | - | | 表名 | 数据库表名 |
| columnName | varchar(100) | YES | - | | 列名 | 数据库列名 |
| relationType | varchar(50) | YES | - | | 关系类型 | 映射关系类型 |
| relationValue | varchar(500) | YES | - | | 关系值 | 映射目标值 |
| description | varchar(500) | YES | - | | 描述 | 关系描述 |

---

### 4.5 pm_common_related_data -- 公共关联数据
...
|--------|----------|------|--------|------|----------|----------|
| id | int(10) | NO | - | PRI, AUTO_INCREMENT | 主键 | 自增主键 |
| dataType | varchar(50) | YES | - | | 数据类型 | 关联数据类型 |
| dataId | int(10) | YES | - | | 数据ID | 源数据ID |
| relatedType | varchar(50) | YES | - | | 关联类型 | 关联目标类型 |
| relatedId | int(10) | YES | - | | 关联ID | 关联目标ID |
| relationName | varchar(200) | YES | - | | 关系名称 | 关系描述 |
| customInfo | text | YES | - | | 自定义信息 | JSON扩展信息 |
| effectiveFrom | datetime | YES | - | | 生效开始时间 | 有效期起始 |
| effectiveTo | datetime | YES | - | | 生效结束时间 | 有效期截止 |
...
|--------|----------|------|--------|------|----------|----------|
| id | int(10) | NO | - | PRI, AUTO_INCREMENT | 主键 | 自增主键 |
| projectId | int(10) | YES | - | MUL | 项目ID | 逻辑外键 -> pm_project.projectId |
| reportDate | datetime | YES | - | | 报告日期 | 日报日期 |
| reportContent | longtext | YES | - | | 报告内容 | 日报正文内容 |
| reportType | varchar(50) | YES | - | | 报告类型 | 日报类型分类 |
| createBy | varchar(50) | YES | - | | 创建人 | 日报创建人 |
...
### 4.7 pm_dispatch_project_header -- 派遣项目头
...
| projectName | varchar(200) | YES | - | | 项目名称 | 派遣项目名称 |
| dispatchType | varchar(50) | YES | - | | 派遣类型 | 派遣类型分类 |
| dispatchStatus | varchar(50) | YES | - | | 派遣状态 | 派遣单状态 |
| companyId | int(10) | YES | - | | 公司ID | 逻辑外键 -> ehr_company.compID |
| departmentId | int(10) | YES | - | | 部门ID | 逻辑外键 -> ehr_department.depID |
| startDate | datetime | YES | - | | 开始日期 | 派遣开始日期 |
| endDate | datetime | YES | - | | 结束日期 | 派遣结束日期 |
| customInfo | text | YES | - | | 自定义信息 | JSON扩展信息 |
| createBy | varchar(50) | YES | - | | 创建人 | 创建人 |
| createTime | datetime | YES | - | | 创建时间 | 创建时间 |
| updateBy | varchar(50) | YES | - | | 更新人 | 最后修改人 |
| updateTime | datetime | YES | - | | 更新时间 | 最后修改时间 |
...
### 4.8 pm_dispatch_project_settlement -- 派遣项目结算
...
|--------|----------|------|--------|------|----------|----------|
| id | int(10) | NO | - | PRI, AUTO_INCREMENT | 主键 | 自增主键 |
| dispatchId | int(10) | YES | - | MUL | 派遣ID | 逻辑外键 -> pm_dispatch_project_header.id |
| settlementCode | varchar(50) | YES | - | | 结算编码 | 结算单编码 |
| settlementAmount | decimal(15,2) | YES | - | | 结算金额 | 结算金额 |
| settlementStatus | varchar(50) | YES | - | | 结算状态 | 结算单状态 |
| settlementDate | datetime | YES | - | | 结算日期 | 结算日期 |
| customInfo | text | YES | - | | 自定义信息 | JSON扩展信息 |
| createBy | varchar(50) | YES | - | | 创建人 | 创建人 |
| createTime | datetime | YES | - | | 创建时间 | 创建时间 |
...
### 4.9 pm_dispatch_project_settlement_from_d365 -- D365派遣结算
...
| dispatchCode | varchar(50) | YES | - | | 派遣编码 | 关联派遣单编码 |
| settlementAmount | decimal(15,2) | YES | - | | 结算金额 | 结算金额 |
| settlementStatus | varchar(50) | YES | - | | 结算状态 | 结算状态 |
| settlementDate | datetime | YES | - | | 结算日期 | 结算日期 |
| customInfo | text | YES | - | | 自定义信息 | JSON扩展信息 |
...
|--------|----------|------|--------|------|----------|----------|
| id | int(10) | NO | - | PRI, AUTO_INCREMENT | 主键 | 自增主键 |
| facilitatorCode | varchar(50) | YES | - | | 供应商编码 | 供应商业务编码 |
| facilitatorName | varchar(200) | YES | - | | 供应商名称 | 供应商全称 |
| facilitatorType | varchar(50) | YES | - | | 供应商类型 | 供应商分类 |
| contactPerson | varchar(100) | YES | - | | 联系人 | 供应商联系人 |
| contactPhone | varchar(50) | YES | - | | 联系电话 | 联系电话 |
| status | int(10) | YES | - | | 状态 | 1=启用，0=禁用 |
| remark | varchar(500) | YES | - | | 备注 | 备注信息 |
...
### 4.11 pm_facilitator_form_d365 -- D365供应商
...
| facilitatorName | varchar(200) | YES | - | | 供应商名称 | 供应商全称 |
| facilitatorType | varchar(50) | YES | - | | 供应商类型 | 供应商分类 |
| contactPerson | varchar(100) | YES | - | | 联系人 | 联系人 |
| contactPhone | varchar(50) | YES | - | | 联系电话 | 联系电话 |
| bankName | varchar(200) | YES | - | | 银行名称 | 开户银行 |
| bankAccount | varchar(50) | YES | - | | 银行账号 | 银行账号 |
| customInfo | text | YES | - | | 自定义信息 | JSON扩展信息 |
...
### 4.12 pm_notification_template -- 项目通知模板
...
|--------|----------|------|--------|------|----------|----------|
| id | int(10) | NO | - | PRI, AUTO_INCREMENT | 主键 | 自增主键 |
| templateCode | varchar(100) | YES | - | | 模板编码 | 模板业务编码 |
| templateName | varchar(200) | YES | - | | 模板名称 | 模板显示名称 |
| notificationSubject | varchar(500) | YES | - | | 通知主题 | 通知标题模板 |
| notificationContent | text | YES | - | | 通知内容 | 通知正文模板 |
| templateType | varchar(50) | YES | - | | 模板类型 | 模板分类 |
| effectiveFrom | datetime | YES | - | | 生效开始时间 | 有效期起始 |
| effectiveTo | datetime | YES | - | | 生效结束时间 | 有效期截止 |

---

### 4.13 pm_report_line_data -- 报表行数据
...
|--------|----------|------|--------|------|----------|----------|
| id | int(10) | NO | - | PRI, AUTO_INCREMENT | 主键 | 自增主键 |
| dataTypeCode | varchar(50) | YES | - | | 数据类型编码 | 统计指标编码 |
| officeCode | varchar(50) | YES | - | | 办事处编码 | 统计办事处编码 |
| officeName | varchar(100) | YES | - | | 办事处名称 | 办事处名称 |
| conditionValue | varchar(100) | YES | - | | 条件值 | 统计条件值 |
| totalValue | varchar(100) | YES | - | | 被比值 | 统计被比值 |
| specificValue | varchar(100) | YES | - | | 比例值 | 统计比例值 |
| settingTime | datetime | YES | - | | 统计时间 | 数据统计时间 |
| settings | varchar(50) | YES | - | | 统计时间字符串 | 统计时间字符串表示 |

---

### 4.14 pm_workflow -- 工作流定义
...
|--------|----------|------|--------|------|----------|----------|
| id | int(10) | NO | - | PRI, AUTO_INCREMENT | 主键 | 自增主键 |
| processKey | varchar(100) | YES | - | | 流程定义Key | Activiti流程定义标识 |
| processName | varchar(200) | YES | - | | 流程名称 | 流程显示名称 |
| businessType | varchar(50) | YES | - | | 业务类型 | 关联业务表单类型 |
| businessTable | varchar(100) | YES | - | | 业务表名 | 关联业务表名 |
| formUrl | varchar(500) | YES | - | | 表单URL | 业务表单访问路径 |
| deploymentId | varchar(50) | YES | - | | 部署ID | Activiti部署ID |
| version | int(10) | YES | - | | 版本 | 流程定义版本号 |
| description | text | YES | - | | 描述 | 流程描述 |
| effectiveFrom | datetime | YES | - | | 生效开始时间 | 有效期起始 |
| effectiveTo | datetime | YES | - | | 生效结束时间 | 有效期截止 |
