...
public class OrderDataFromSap {
	private int id;
	private String contractNo;
	private String rmaContractNo;//退货合同号
	...
	public String getRmaContractNo() {
		return rmaContractNo;
	}
	public void setRmaContractNo(String rmaContractNo) {
		this.rmaContractNo = rmaContractNo;
	}
