        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="listView divHeader">
                    ...
                    <s:text name="probProduct.manage.import"></s:text>
                </div>
                <s:form method="post" action="module/probProduct_import.action" id="mainForm"
                    cssClass="form-horizontal" name="mainForm" enctype="multipart/form-data">
					<div class="panel panel-default mb-2">
						<div class="panel-body text-center">
                            <div style="display: inline-block;">
							    <div class="form-group text-left">
							        <label for="attachments" class="control-label"><s:text name="probProduct.info.attachments"></s:text></label>
							    ...
							    <div class="form-group text-left text-warning">
	                                ...
	                                <span class="pull-right"><img src="images/right_zhishi.gif" border="0"><a href="module/DownloadFile.action?downname=产品组件导入模板.xlsx&downpath=/template/probProduct_template.xlsx">产品组件导入模板</a></span>
	                            </div>
