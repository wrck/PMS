...
<!-- 引入对Bootstrap的自扩展文件 -->
<dp:link rel="stylesheet" href="css/bootstrap-ex.css" />
	...
	<div>
 		<div class="panel panel-default">
			<div class="panel-body">
				<s:form method="POST" action="module/sub/presales_callback.action"
					...
					<div class="panel panel-default">
						...
						<div id="cbcollapseOne" class="panel-collapse collapse in">
							<div class="panel-body">
								...
								<s:form method="post" action="module/sub/presales_callback.action" id="cbCLForm">
									...
									<s:hidden name="presales.presalesId"></s:hidden>
									<s:hidden name="presales.taskId"></s:hidden>
									...
									<s:iterator value="pmClosedLoopQuesnaireLineList" id="obja"
										status="indexa">
                                        <input type="hidden"
                                            name="pmClQuesnaireResultLineList[<s:property value="%{#indexa.index}"/>].quesnaireTemplateHeaderId"
                                            value="<s:property value="%{pmClosedLoopQuesnaire.id}"/>" />
										<input type="hidden"
