...
public class ByteUtils {
    ...
    public static void main(String[] args) {
        ByteBuffer builder = ByteBuffer.allocateDirect(25);
        builder = ByteUtils.append(builder, "这是第1个字符串".getBytes());
        builder = ByteUtils.append(builder, "这是第2个字符串".getBytes());
        builder = ByteUtils.append(builder, "这是第3个字符串".getBytes());
        builder = ByteUtils.append(builder, "这是第4个字符串".getBytes());
        
//        ByteUtils.addBytes(builder, "这是第1个字符串".getBytes());
//        ByteUtils.addBytes(builder, "这是第2个字符串".getBytes());
//        ByteUtils.addBytes(builder, "这是第3个字符串".getBytes());
//        ByteUtils.addBytes(builder, "这是第4个字符串".getBytes());
        
//        ByteArrayOutputStream builder = new ByteArrayOutputStream(10);
//        try {
//            builder.write("这是第1个字符串".getBytes());
//            builder.write("这是第2个字符串".getBytes());
//            builder.write("这是第3个字符串".getBytes());
//            builder.write("这是第4个字符串".getBytes());
//        } catch (IOException e) {
//            e.printStackTrace();
//        }
        
//        // 切换状态以准备读取数据
//        System.out.println(new String(builder.toByteArray()));
        System.out.println(new String(ByteUtils.readBytes(builder)));
    }
}
