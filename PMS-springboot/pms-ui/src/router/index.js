...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'callback/apply', name: 'CallbackApply', component: () => import('@/views/callback/apply.vue'), meta: { title: '回访申请' } },
      ...
      { path: 'closed-loop/apply', name: 'ClosedLoopApply', component: () => import('@/views/closedloop/apply.vue'), meta: { title: '闭环申请' } },
      ...
      { path: 'workflow/task/:id', name: 'WorkflowTask', component: () => import('@/views/workflow/task.vue'), meta: { title: '任务办理' } },
      { path: 'workflow/deploy', name: 'WorkflowDeploy', component: () => import('@/views/workflow/deploy.vue'), meta: { title: '流程部署' } },
      { path: 'workflow/history', name: 'WorkflowHistory', component: () => import('@/views/workflow/history.vue'), meta: { title: '历史任务' } },
      ...
      { path: 'maintenance/daily', name: 'MaintenanceDaily', component: () => import('@/views/maintenance/daily.vue'), meta: { title: '维保日报' } },
      ...
      { path: 'certificate/detail/:id', name: 'CertificateDetail', component: () => import('@/views/certificate/detail.vue'), meta: { title: '合格证详情' } },
