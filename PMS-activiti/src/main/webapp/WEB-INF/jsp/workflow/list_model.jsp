...
<body>
	...
	<div id="main">
      ...
      <div class="sort_content">
      	<form action=" ${ctx }/modelAction/listModel_page.html" method="post">
          <table class="tableHue1" width="100%" border="1" bordercolor="#a4d5e3" cellspacing="0" cellpadding="0">
              ...
              <c:forEach items="${list }" var="model">
				<tr>
					...
					<td>
						<a href="${ctx}/modeler/service/editor.html?id=${model.id}" target="_blank">编辑</a>|
						<a href="${ctx}/modelAction/deploy/${model.id}.html">部署</a>|
						<a href="${ctx}/modelAction/export/${model.id}.html" target="_blank">导出</a>|
                        <a href="${ctx}/modelAction/delete/${model.id}.html">删除</a>
					</td>
				</tr>
			</c:forEach>
              	<tr>
      ...
      <div id="dialog-form" title="创建模型" style="display: none;">
		 ...
		 <form id="modelForm" action="${ctx}/modelAction/create.html" target="_blank" method="post">
		    <fieldset>
