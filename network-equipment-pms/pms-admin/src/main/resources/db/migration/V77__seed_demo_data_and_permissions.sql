-- =============================================================
-- V77__seed_demo_data_and_permissions.sql
...
INSERT IGNORE INTO `sys_permission` (`code`, `name`, `type`, `parent_id`, `sort`, `create_time`) VALUES
('project:template:list',     '项目模板-查询',   'menu',   0, 100, NOW()),
('project:template:create',   '项目模板-新增',   'button', 0, 101, NOW()),
('project:template:edit',     '项目模板-编辑',   'button', 0, 102, NOW()),
('project:template:publish',  '项目模板-发布版本','button', 0, 103, NOW()),
('project:template:delete',   '项目模板-删除',   'button', 0, 104, NOW()),
('project:template:create-project','从模板创建项目','button', 0, 105, NOW()),
('project:phase:list',        '项目阶段-查询',   'menu',   0, 110, NOW()),
('project:phase:advance',     '项目阶段-推进',   'button', 0, 111, NOW()),
('project:phase:rollback',    '项目阶段-回退',   'button', 0, 112, NOW()),
('project:task:list',         '项目任务-查询',   'menu',   0, 120, NOW()),
('project:task:create',       '项目任务-新增',   'button', 0, 121, NOW()),
('project:task:edit',         '项目任务-编辑',   'button', 0, 122, NOW()),
('project:task:delete',       '项目任务-删除',   'button', 0, 123, NOW()),
('project:task:dependency',   '项目任务-依赖配置','button', 0, 124, NOW()),
('project:task:submit-review','项目任务-提交评审','button', 0, 125, NOW()),
('project:baseline:list',     '计划基线-查询',   'menu',   0, 130, NOW()),
('project:baseline:create',   '计划基线-创建快照','button', 0, 131, NOW()),
('project:baseline:change',   '计划基线-变更申请','button', 0, 132, NOW()),
('project:deliverable:list',  '交付件-查询',     'menu',   0, 140, NOW()),
('project:deliverable:revise','交付件-修订新版本','button', 0, 141, NOW()),
('project:deliverable:publish','交付件-发布',    'button', 0, 142, NOW()),
('workflow:approval:list',      '审批中心-查询',   'menu',   0, 150, NOW()),
('workflow:approval:handle',    '审批中心-审批',   'button', 0, 151, NOW()),
('workflow:approval:resubmit',  '审批中心-重新提交','button', 0, 152, NOW()),
('workflow:field:perm',         '审批中心-字段权限','button', 0, 153, NOW());
