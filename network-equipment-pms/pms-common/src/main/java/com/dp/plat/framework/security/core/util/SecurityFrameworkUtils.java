 ...
 * 安全服务工具类
 *
 * <p>直接复用自 yudao-framework。提供从 SecurityContext 获取当前登录用户的便捷方法。
 *
 * @author yudao
 */
public class SecurityFrameworkUtils {
     ...
     * 请求属性：登录用户编号
     */
    public static final String REQUEST_ATTRIBUTE_LOGIN_USER_ID = "loginUserId";
    /**
     * 请求属性：登录用户类型
     */
    public static final String REQUEST_ATTRIBUTE_LOGIN_USER_TYPE = "loginUserType";
    ...
    public static void setLoginUser(LoginUser loginUser, HttpServletRequest request) {
        ...
        // 额外设置到 request 中，便于日志过滤器获取用户编号
        if (request != null) {
            request.setAttribute(REQUEST_ATTRIBUTE_LOGIN_USER_ID, loginUser.getId());
            request.setAttribute(REQUEST_ATTRIBUTE_LOGIN_USER_TYPE, loginUser.getUserType());
        }
    }
