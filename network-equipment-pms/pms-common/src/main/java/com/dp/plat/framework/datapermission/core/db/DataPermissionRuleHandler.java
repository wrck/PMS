package com.dp.plat.framework.datapermission.core.db;
...
import static com.dp.plat.framework.security.core.util.SecurityFrameworkUtils.skipPermissionCheck;
 ...
 *
 * <p>底层基于 MyBatis-Plus 的
 * <a href="https://baomidou.com/plugins/data-permission/">数据权限插件</a>：
 * 在 SQL 执行前拦截，根据用户权限动态添加权限相关的 SQL 片段，
 * 使只有用户有权限访问的数据才会被查询出来。
 *
 * @author yudao
 */
