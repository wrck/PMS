...
function createEmptyForm(): SysDict {
  return { code: '', name: '', status: 1, remark: '' }
}
    ...
    <el-card shadow="never">
      <el-form :inline="true" @submit.prevent>
        <el-form-item label="关键字">
          <el-input v-model="query.keyword" placeholder="字典编码/名称" clearable @keyup.enter="handleSearch" />
        </el-form-item>
        <el-form-item>
      ...
      <el-table v-loading="loading" :data="tableData" border stripe>
        ...
        <el-table-column label="操作" width="180" fixed="right">
          <template #default="{ row }">
            ...
            <el-button link type="warning" disabled>字典项</el-button>
    ...
    <el-dialog v-model="dialogVisible" :title="dialogTitle" width="520px" destroy-on-close>
      <el-form ref="formRef" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="字典编码" prop="code">
          <el-input v-model="form.code" :disabled="!!form.id" placeholder="请输入字典编码" />
        </el-form-item>
