...
import { E as exportForm, H as listForms, K as publishForm, S as deleteForm, p as archiveForm } from "./lowcode-F-suzo7c.js";
...
//#region src/views/lowcode/form-list/index.vue?vue&type=script&setup=true&lang.ts
var _hoisted_1 = { class: "form-list-page" };
...
//#endregion
//#region src/views/lowcode/form-list/index.vue
var form_list_default = /*#__PURE__*/ _plugin_vue_export_helper_default(/* @__PURE__ */ defineComponent({
	__name: "index",
	setup(__props) {
		/**
		* 低代码表单列表页。
		...
		*/
		...
		return (_ctx, _cache) => {
			...
			return openBlock(), createElementBlock("div", _hoisted_1, [createVNode(_component_el_card, {
				...
				header: withCtx(() => [createElementVNode("div", _hoisted_2, [_cache[9] || (_cache[9] = createElementVNode("span", null, "表单配置列表", -1)), createVNode(_component_el_button, {
					type: "primary",
					icon: "Plus",
					onClick: handleAdd
				}, {
					default: withCtx(() => [..._cache[8] || (_cache[8] = [createTextVNode("新建表单", -1)])]),
					_: 1
				})])]),
...
}), [["__scopeId", "data-v-655a14e2"]]);
//#endregion
export { form_list_default as default };

//# sourceMappingURL=form-list-YoSKFSPc.js.map