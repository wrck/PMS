...
import { computed, defineComponent, effectScope, getCurrentInstance, getCurrentScope, h, hasInjectionContext, inject, isReactive, isRef, markRaw, nextTick, onScopeDispose, provide, reactive, ref, shallowReactive, shallowRef, toRaw, toRef, toRefs, unref, watch, watchEffect } from "vue";
...
var _navigator$1 = typeof navigator === "object" && navigator || void 0;
/**
...
* @returns {boolean}
*/
var hasStandardBrowserEnv = hasBrowserEnv && (!_navigator$1 || [
	"ReactNative",
	"NativeScript",
	"NS"
...
function createRouterError(type, params) {
	if (process.env.NODE_ENV !== "production" || false) return assign$2(new Error(ErrorTypeMessages[type](params)), {
		type,
		[NavigationFailureSymbol]: true
	}, params);
	else return assign$2(/* @__PURE__ */ new Error(), {
		type,
		[NavigationFailureSymbol]: true
	}, params);
}
...
function formatRouteLocation(routeLocation, tooltip) {
	const copy = assign$2({}, routeLocation, { matched: routeLocation.matched.map((matched) => omit(matched, [
		"instances",
		"children",
		"aliasOf"
	])) });
...
var useUserStore = defineStore("user", () => {
	...
	*/
	...
	async function login$1(params) {
		var _res$userInfo$permiss;
		const res = await login(params);
		token.value = res.token;
		localStorage.setItem(TOKEN_KEY, res.token);
		userInfo.value = res.userInfo;
		permissions.value = (_res$userInfo$permiss = res.userInfo.permissions) !== null && _res$userInfo$permiss !== void 0 ? _res$userInfo$permiss : [];
		return res;
	}
	async function fetchUserInfo() {
		var _info$permissions;
		const info = await getUserInfo();
		userInfo.value = info;
		permissions.value = (_info$permissions = info.permissions) !== null && _info$permissions !== void 0 ? _info$permissions : [];
		return info;
	}
...
var Layout = () => import("./DefaultLayout-7mj4ALxV.js");
var routes = [
	{
		path: "/login",
		name: "Login",
		component: () => import("./login-DvkjZFZF.js"),
		meta: {
			title: "登录",
			requiresAuth: false
		}
	},
	{
		path: "/help",
		name: "Help",
		component: () => import("./help-6lGIcq8x.js"),
		meta: {
			title: "帮助中心",
			requiresAuth: false
		}
		...
		children: [
			{
				path: "dashboard",
				name: "Dashboard",
				component: () => import("./dashboard-CSzKCDDn.js"),
				meta: {
					title: "首页",
					icon: "HomeFilled"
				}
			},
			{
				path: "system/user",
				name: "SysUser",
				component: () => import("./user-BK4YbQgV.js"),
				meta: {
					title: "用户管理",
					icon: "User"
				}
			},
			{
				path: "system/role",
				name: "SysRole",
				component: () => import("./role-BuYKzmc1.js"),
				meta: {
					title: "角色管理",
					icon: "UserFilled"
				}
			},
			{
				path: "system/menu",
				name: "SysMenu",
				component: () => import("./menu-C2RO2-ml.js"),
				meta: {
					title: "菜单管理",
					icon: "Menu"
				}
			},
			{
				path: "system/dict",
				name: "SysDict",
				component: () => import("./dict-Cv9kfSYJ.js"),
				meta: {
					title: "字典管理",
					icon: "Document"
				}
			},
			{
				path: "system/cache",
				name: "SysCache",
				component: () => import("./cache-YxsR-bus.js"),
				meta: {
					title: "缓存管理",
					icon: "Coin",
					requiresAuth: true
			...
			},
			{
				...
				name: "SysSchedule",
				component: () => import("./schedule-CEdzMBj2.js"),
				meta: {
					title: "定时任务",
					icon: "Timer",
					requiresAuth: true
			...
			},
			{
				path: "system/audit",
				name: "SysAudit",
				component: () => import("./audit-Bccg0yed.js"),
				meta: {
					title: "审计日志",
			...
			},
			{
				path: "project/list",
				name: "ProjectList",
				component: () => import("./list-CY7yAVtM.js"),
				meta: {
					title: "项目列表",
					icon: "Folder"
				}
			},
			{
				...
				name: "ProjectDetail",
				component: () => import("./detail-Yp-qntw7.js"),
				meta: {
					title: "项目详情",
					hidden: true
				}
			},
			{
				path: "project/kanban",
				name: "ProjectKanban",
				component: () => import("./kanban-D6zJ9DHY.js"),
				meta: {
					title: "交付看板",
					icon: "Grid"
				}
			},
			{
				path: "asset/category",
				name: "AssetCategory",
				component: () => import("./category-BqbI_uQV.js"),
				meta: {
					title: "设备分类",
					icon: "Files"
				}
			},
			{
				path: "asset/model",
				name: "AssetModel",
				component: () => import("./model-BR2zHO-F.js"),
				meta: {
					title: "设备型号",
					icon: "Box"
				}
			},
			{
				path: "asset/list",
				name: "AssetList",
				component: () => import("./list-DLz1dyw_.js"),
				meta: {
					title: "资产清单",
					icon: "List"
				}
			},
			{
				...
				name: "ImplTask",
				component: () => import("./task-BPLO5Zmt.js"),
				meta: {
					title: "实施任务",
					icon: "Tickets"
				}
			},
			{
				...
				name: "AgentManage",
				component: () => import("./agent-B-n8xl57.js"),
				meta: {
					title: "服务商管理",
					icon: "OfficeBuilding"
				}
			},
			{
				...
				name: "Settlement",
				component: () => import("./settlement-C7qQNhpq.js"),
				meta: {
					title: "结算管理",
					icon: "Money"
				}
			},
			{
				path: "workflow/todo",
				name: "WorkflowTodo",
				component: () => import("./todo-Co2USAuF.js"),
				meta: {
					title: "待办中心",
					icon: "Bell"
				}
			},
			{
				path: "punch-list",
				name: "PunchList",
				component: () => import("./punch-list-BuiV2gdd.js"),
				meta: {
					title: "Punch List",
					icon: "WarningFilled",
					requiresAuth: true
			...
			},
			{
				path: "rma",
				name: "Rma",
				component: () => import("./rma-f7CnoGYy.js"),
				meta: {
					title: "RMA 返修",
					icon: "RefreshRight",
					requiresAuth: true
			...
			},
			{
				path: "warranty",
				name: "Warranty",
				component: () => import("./warranty-CIWxtsi3.js"),
				meta: {
					title: "质保期管理",
					icon: "Timer",
					requiresAuth: true
			...
			},
			{
				path: "deliverable",
				name: "Deliverable",
				component: () => import("./deliverable-5oby2W2N.js"),
				meta: {
					title: "终验交付物",
					icon: "Document",
					requiresAuth: true
			...
			},
			{
				...
				component: () => import("./notification-Cv9_9ivL.js"),
				meta: {
					title: "消息中心",
					icon: "Bell",
					requiresAuth: true
			...
			},
			{
				...
				component: () => import("./integration-health-CKC3fYf4.js"),
				meta: {
					title: "集成健康检查",
					icon: "Monitor",
					requiresAuth: true
			...
			},
			{
				path: "risk",
				name: "Risk",
				component: () => import("./risk-DTpsLOz3.js"),
				meta: {
					title: "风险登记册",
					icon: "Warning",
					requiresAuth: true
			...
			},
			{
				path: "change-request",
				name: "ChangeRequest",
				component: () => import("./change-request-BkGnK-B-.js"),
				meta: {
					title: "变更管理",
					icon: "EditPen",
					requiresAuth: true
			...
			},
			{
				path: "issue",
				name: "Issue",
				component: () => import("./issue-B63emxVf.js"),
				meta: {
					title: "问题日志",
					icon: "ChatLineSquare",
					requiresAuth: true
			...
			},
			{
				path: "report",
				name: "Report",
				component: () => import("./report-Bd792gri.js"),
				meta: {
					title: "报表统计",
					icon: "TrendCharts"
				}
			},
			{
				...
				component: () => import("./form-list-YoSKFSPc.js"),
				meta: {
					title: "表单配置",
					icon: "Document",
					requiresAuth: true
			...
			},
			{
				...
				component: () => import("./form-designer-BAxu4Uhb.js"),
				meta: {
					title: "表单设计器",
					icon: "EditPen",
					requiresAuth: true,
			...
			},
			{
				...
				component: () => import("./list-list-BUrlrUcB.js"),
				meta: {
					title: "列表配置",
					icon: "List",
					requiresAuth: true
			...
			},
			{
				...
				component: () => import("./list-designer-DIR2PhPx.js"),
				meta: {
					title: "列表设计器",
					icon: "Grid",
					requiresAuth: true,
			...
			},
			{
				...
				name: "LowCodeTabList",
				component: () => import("./tab-list-BHeb5OIo.js"),
				meta: {
					title: "标签页配置",
					icon: "Files",
					requiresAuth: true
			...
			},
			{
				...
				component: () => import("./tab-designer-Dxeodnqq.js"),
				meta: {
					title: "标签页设计器",
					icon: "EditPen",
					requiresAuth: true,
			...
			},
			{
				...
				component: () => import("./related-page-list-Dd4hZhTv.js"),
				meta: {
					title: "关联页配置",
					icon: "Share",
					requiresAuth: true
			...
			},
			{
				...
				component: () => import("./related-page-designer-BTULUNRe.js"),
				meta: {
					title: "关联页设计器",
					icon: "EditPen",
					requiresAuth: true,
			...
			},
			{
				...
				component: () => import("./entity-designer-CbS0YA6A.js"),
				meta: {
					title: "实体设计器",
					icon: "Connection",
					requiresAuth: true
			...
			},
			{
				...
				component: () => import("./version-history-BSzpDZ3s.js"),
				meta: {
					title: "版本历史",
					icon: "Timer",
					requiresAuth: true
			...
			},
			{
				...
				component: () => import("./microflow-designer-ChR-Jtun.js"),
				meta: {
					title: "微流设计器",
					icon: "Share",
					requiresAuth: true
			...
			},
			{
				...
				component: () => import("./rule-designer-C8Ey-kbZ.js"),
				meta: {
					title: "规则设计器",
					icon: "Filter",
					requiresAuth: true
			...
			},
			{
				...
				component: () => import("./process-designer-D4B4fmAA.js"),
				meta: {
					title: "流程设计器",
					icon: "Connection",
					requiresAuth: true
			...
			},
			{
				...
				component: () => import("./trigger-list-mm3CXs5X.js"),
				meta: {
					title: "触发器",
					icon: "BellFilled",
					requiresAuth: true
			...
			},
			{
				...
				component: () => import("./connector-designer-CEWIyNzw.js"),
				meta: {
					title: "连接器配置",
					icon: "Connection",
					requiresAuth: true
			...
			},
			{
				...
				name: "LowcodePreview",
				component: () => import("./preview-mN7rlqmk.js"),
				meta: {
					title: "预览",
					icon: "View",
					requiresAuth: true,
			...
			},
			{
				...
				component: () => import("./publish-center-CSVcBi3k.js"),
				meta: {
					title: "发布中心",
					icon: "Promotion",
					requiresAuth: true
			...
			},
			{
				...
				component: () => import("./approval-chain-DDKalAmc.js"),
				meta: {
					title: "审批链配置",
					icon: "SetUp",
					requiresAuth: true
			...
			},
			{
				...
				component: () => import("./template-market-CEFo_OQN.js"),
				meta: {
					title: "模板市场",
					icon: "Goods",
					requiresAuth: true
			...
			},
			{
				...
				component: () => import("./apm-dashboard-D5U4X8IC.js"),
				meta: {
					title: "APM 看板",
					icon: "TrendCharts",
					requiresAuth: true
			...
			},
			{
				...
				component: () => import("./app-source-export-C_iwSDLy.js"),
				meta: {
					title: "应用源码导出",
					icon: "Download",
					requiresAuth: true
			...
			},
			{
				...
				name: "LowCodeRender",
				component: () => import("./render-CdAd4IFr.js"),
				meta: {
					title: "低代码页面",
					requiresAuth: true,
					hidden: true
			...
			},
			{
				path: "system-status",
				name: "SystemStatus",
				component: () => import("./system-status-BszB04y3.js"),
				meta: {
					title: "系统状态",
					icon: "Monitor",
					requiresAuth: true
			...
			},
			{
				path: "changelog",
				name: "Changelog",
				component: () => import("./changelog-CD96TvbK.js"),
				meta: {
					title: "版本日志",
					icon: "Notebook",
					requiresAuth: true
...
router.beforeEach((to, _from, next) => {
	...
	const title = (_to$meta$title = to.meta.title) !== null && _to$meta$title !== void 0 ? _to$meta$title : "";
...
var IDEMPOTENT_KEY_HEADER = "X-Idempotent-Key";
...
service.interceptors.request.use((config) => {
	...
	if (IDEMPOTENT_METHODS.includes(method) && !config.headers["X-Idempotent-Key"]) config.headers[IDEMPOTENT_KEY_HEADER] = generateIdempotentKey();
	return config;
...
service.interceptors.response.use((response) => {
	...
	var _error$response, _error$config2;
	if ((error === null || error === void 0 || (_error$response = error.response) === null || _error$response === void 0 ? void 0 : _error$response.status) === 401) {
		var _error$config;
		if (!(error === null || error === void 0 || (_error$config = error.config) === null || _error$config === void 0 ? void 0 : _error$config.silent)) ElMessage.error("登录状态已过期，请重新登录");
		localStorage.removeItem(TOKEN_KEY);
		router.push("/login");
		return Promise.reject(/* @__PURE__ */ new Error("未登录或登录已过期"));
	}
	if (!(error === null || error === void 0 || (_error$config2 = error.config) === null || _error$config2 === void 0 ? void 0 : _error$config2.silent)) {
		var _error$response2;
		const msg = (error === null || error === void 0 || (_error$response2 = error.response) === null || _error$response2 === void 0 || (_error$response2 = _error$response2.data) === null || _error$response2 === void 0 ? void 0 : _error$response2.message) || error.message || "网络异常，请稍后重试";
		ElMessage.error(msg);
	}
	return Promise.reject(error);
});
...
//#endregion
export { put as a, useUserStore as c, useRouter as d, axios as f, __toESM as g, __reExport as h, post as i, defineStore as l, __exportAll as m, del as n, service as o, __commonJSMin as p, get as r, routeLoading as s, TOKEN_KEY as t, useRoute as u };

//# sourceMappingURL=request-BQrAOfxW.js.map