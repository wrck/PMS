...
import { i as getImplementationStats, r as getDeliveryStats, t as getAssetStats } from "./report-D_OreQK4.js";
import { ElMessage } from "element-plus";
import { computed, createElementBlock, createElementVNode, createTextVNode, createVNode, defineComponent, nextTick, onBeforeUnmount, onMounted, openBlock, ref, resolveComponent, toDisplayString, watch, withCtx } from "vue";
...
XLSX.version;
//#endregion
//#region src/views/report/index.vue?vue&type=script&setup=true&lang.ts
...
var _hoisted_5 = { class: "stat-card stat-blue" };
var _hoisted_6 = { class: "stat-value" };
var _hoisted_7 = { class: "stat-card stat-green" };
var _hoisted_8 = { class: "stat-value" };
var _hoisted_9 = { class: "stat-card stat-orange" };
var _hoisted_10 = { class: "stat-value" };
var _hoisted_11 = { class: "stat-card stat-red" };
var _hoisted_12 = { class: "stat-value" };
var _hoisted_13 = { class: "section" };
var _hoisted_14 = { class: "stat-card stat-blue" };
var _hoisted_15 = { class: "stat-value" };
var _hoisted_16 = { class: "stat-card stat-green" };
var _hoisted_17 = { class: "stat-value" };
var _hoisted_18 = { class: "stat-card stat-orange" };
var _hoisted_19 = { class: "stat-value" };
var _hoisted_20 = { class: "stat-card stat-purple" };
var _hoisted_21 = { class: "stat-value" };
var _hoisted_22 = { class: "section" };
var _hoisted_23 = { class: "score-emph" };
//#endregion
//#region src/views/report/index.vue
var report_default = /*#__PURE__*/ _plugin_vue_export_helper_default(/* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		function getDefaultDateRange() {
			...
			return [fmtDate(new Date(now.getFullYear(), now.getMonth() - 5, 1)), fmtDate(now)];
		}
		function fmtDate(d) {
		...
		const utilizationRate = computed(() => {
			...
			return Math.round(used / Math.max(assetStats.value.total, 1) * 1e3) / 10;
		});
		...
		const completionRateChartRef = ref();
		...
		function renderCompletionRateChart() {
			...
			inst.setOption({
				...
				series: [{
					...
					type: "bar",
					data: [{
						value: e.OEM.completionRate,
						itemStyle: { color: "#409EFF" }
					}, {
						value: e.AGENT.completionRate,
						itemStyle: { color: "#E6A23C" }
					}],
					barWidth: "40%",
					label: {
		...
		function renderDurationChart() {
			...
			inst.setOption({
				...
				series: [{
					...
					type: "bar",
					data: [{
						value: e.OEM.avgDurationDays,
						itemStyle: { color: "#67C23A" }
					}, {
						value: e.AGENT.avgDurationDays,
		...
		async function loadAll() {
			loading.value = true;
			try {
				var _dateRange$value, _dateRange$value2, _delivery$monthlyStat, _delivery$totalInitia, _delivery$totalInProg, _delivery$totalComple, _delivery$avgCycleDay, _delivery$delayRate, _impl$agentRanking;
				...
				monthlyStats.value = (_delivery$monthlyStat = delivery.monthlyStats) !== null && _delivery$monthlyStat !== void 0 ? _delivery$monthlyStat : [];
				deliveryStats.value = {
					totalInitiated: (_delivery$totalInitia = delivery.totalInitiated) !== null && _delivery$totalInitia !== void 0 ? _delivery$totalInitia : 0,
					totalInProgress: (_delivery$totalInProg = delivery.totalInProgress) !== null && _delivery$totalInProg !== void 0 ? _delivery$totalInProg : 0,
					totalCompleted: (_delivery$totalComple = delivery.totalCompleted) !== null && _delivery$totalComple !== void 0 ? _delivery$totalComple : 0,
					avgCycleDays: Number((_delivery$avgCycleDay = delivery.avgCycleDays) !== null && _delivery$avgCycleDay !== void 0 ? _delivery$avgCycleDay : 0),
					delayRate: Number((_delivery$delayRate = delivery.delayRate) !== null && _delivery$delayRate !== void 0 ? _delivery$delayRate : 0)
				};
				assetStats.value = asset;
				implementationStats.value = impl;
				agentRanking.value = (_impl$agentRanking = impl.agentRanking) !== null && _impl$agentRanking !== void 0 ? _impl$agentRanking : [];
				renderAllCharts();
			} catch (e) {
		...
		async function handleDateChange() {
			try {
				var _dateRange$value3, _dateRange$value4, _delivery$monthlyStat2, _delivery$totalInitia2, _delivery$totalInProg2, _delivery$totalComple2, _delivery$avgCycleDay2, _delivery$delayRate2;
				...
				monthlyStats.value = (_delivery$monthlyStat2 = delivery.monthlyStats) !== null && _delivery$monthlyStat2 !== void 0 ? _delivery$monthlyStat2 : [];
				deliveryStats.value = {
					totalInitiated: (_delivery$totalInitia2 = delivery.totalInitiated) !== null && _delivery$totalInitia2 !== void 0 ? _delivery$totalInitia2 : 0,
					totalInProgress: (_delivery$totalInProg2 = delivery.totalInProgress) !== null && _delivery$totalInProg2 !== void 0 ? _delivery$totalInProg2 : 0,
					totalCompleted: (_delivery$totalComple2 = delivery.totalCompleted) !== null && _delivery$totalComple2 !== void 0 ? _delivery$totalComple2 : 0,
					avgCycleDays: Number((_delivery$avgCycleDay2 = delivery.avgCycleDays) !== null && _delivery$avgCycleDay2 !== void 0 ? _delivery$avgCycleDay2 : 0),
					delayRate: Number((_delivery$delayRate2 = delivery.delayRate) !== null && _delivery$delayRate2 !== void 0 ? _delivery$delayRate2 : 0)
				};
		...
		function exportExcel() {
			...
			const deliverySheet = utils.json_to_sheet(deliveryRows);
			utils.book_append_sheet(workbook, deliverySheet, "项目交付统计");
			const assetRows = [
				{
					项目: "设备总数",
					数值: assetStats.value.total
				},
				{
					项目: "在库数",
					数值: assetStats.value.inStock
				},
				{
					项目: "已分配数",
					数值: assetStats.value.allocated
				},
				{
					项目: "调拨中数",
					数值: assetStats.value.inTransfer
				},
				{
					项目: "已报废数",
					数值: assetStats.value.scrapped
				},
				{
					项目: "设备总价值",
					数值: assetStats.value.totalValue
				},
				{
					项目: "利用率(%)",
					数值: utilizationRate.value
				}
			];
			const assetSheet = utils.json_to_sheet(assetRows);
			utils.book_append_sheet(workbook, assetSheet, "设备资产统计");
			const e = efficiencyByType.value;
			const implRows = [{
				类型: "原厂(OEM)",
				任务总数: e.OEM.total,
			...
			const implSheet = utils.json_to_sheet(implRows);
			utils.book_append_sheet(workbook, implSheet, "实施效能统计");
			...
			const rankingSheet = utils.json_to_sheet(rankingRows);
			utils.book_append_sheet(workbook, rankingSheet, "代理商排名");
			const fileName = `报表_${(/* @__PURE__ */ new Date()).toISOString().slice(0, 10)}.xlsx`;
		...
		return (_ctx, _cache) => {
			...
			return openBlock(), createElementBlock("div", _hoisted_1, [createVNode(_component_el_card, { shadow: "never" }, {
				header: withCtx(() => [createElementVNode("div", _hoisted_2, [_cache[2] || (_cache[2] = createElementVNode("span", { class: "page-title" }, "数据报表分析", -1)), createVNode(_component_el_button, {
					type: "success",
					...
					default: withCtx(() => [createVNode(_component_el_icon, null, {
						...
						_: 1
					}), _cache[1] || (_cache[1] = createTextVNode(" 导出 Excel ", -1))]),
					_: 1
				}, 8, ["loading"])])]),
				default: withCtx(() => [
					createElementVNode("div", _hoisted_3, [
						createElementVNode("div", _hoisted_4, [_cache[3] || (_cache[3] = createElementVNode("span", { class: "section-title" }, "项目交付统计", -1)), createVNode(_component_el_date_picker, {
						...
						createVNode(_component_el_row, {
							...
							default: withCtx(() => [
								createVNode(_component_el_col, { span: 6 }, {
									default: withCtx(() => [createElementVNode("div", _hoisted_5, [_cache[4] || (_cache[4] = createElementVNode("div", { class: "stat-label" }, "总立项数", -1)), createElementVNode("div", _hoisted_6, toDisplayString(deliveryStats.value.totalInitiated), 1)])]),
									_: 1
								}),
								createVNode(_component_el_col, { span: 6 }, {
									default: withCtx(() => [createElementVNode("div", _hoisted_7, [_cache[5] || (_cache[5] = createElementVNode("div", { class: "stat-label" }, "已完成数", -1)), createElementVNode("div", _hoisted_8, toDisplayString(deliveryStats.value.totalCompleted), 1)])]),
									_: 1
								}),
								createVNode(_component_el_col, { span: 6 }, {
									default: withCtx(() => [createElementVNode("div", _hoisted_9, [_cache[6] || (_cache[6] = createElementVNode("div", { class: "stat-label" }, "平均交付周期(天)", -1)), createElementVNode("div", _hoisted_10, toDisplayString(deliveryStats.value.avgCycleDays), 1)])]),
									_: 1
								}),
								createVNode(_component_el_col, { span: 6 }, {
									default: withCtx(() => [createElementVNode("div", _hoisted_11, [_cache[7] || (_cache[7] = createElementVNode("div", { class: "stat-label" }, "延期率", -1)), createElementVNode("div", _hoisted_12, toDisplayString(deliveryStats.value.delayRate) + "%", 1)])]),
									_: 1
								})
							]),
							_: 1
						...
						createElementVNode("div", {
							ref_key: "projectChartRef",
							ref: projectChartRef,
							class: "chart-box"
						}, null, 512)
					]),
					createVNode(_component_el_divider),
					createElementVNode("div", _hoisted_13, [_cache[12] || (_cache[12] = createElementVNode("div", { class: "section-header" }, [createElementVNode("span", { class: "section-title" }, "设备资产统计")], -1)), createVNode(_component_el_row, { gutter: 16 }, {
						default: withCtx(() => [createVNode(_component_el_col, { span: 10 }, {
							default: withCtx(() => [createVNode(_component_el_row, {
								...
								default: withCtx(() => [
									createVNode(_component_el_col, { span: 12 }, {
										default: withCtx(() => [createElementVNode("div", _hoisted_14, [_cache[8] || (_cache[8] = createElementVNode("div", { class: "stat-label" }, "设备总数", -1)), createElementVNode("div", _hoisted_15, toDisplayString(assetStats.value.total), 1)])]),
										_: 1
									}),
									createVNode(_component_el_col, { span: 12 }, {
										default: withCtx(() => [createElementVNode("div", _hoisted_16, [_cache[9] || (_cache[9] = createElementVNode("div", { class: "stat-label" }, "在库数", -1)), createElementVNode("div", _hoisted_17, toDisplayString(assetStats.value.inStock), 1)])]),
										_: 1
									}),
									createVNode(_component_el_col, { span: 12 }, {
										default: withCtx(() => [createElementVNode("div", _hoisted_18, [_cache[10] || (_cache[10] = createElementVNode("div", { class: "stat-label" }, "已分配数", -1)), createElementVNode("div", _hoisted_19, toDisplayString(assetStats.value.allocated), 1)])]),
										_: 1
									}),
									createVNode(_component_el_col, { span: 12 }, {
										default: withCtx(() => [createElementVNode("div", _hoisted_20, [_cache[11] || (_cache[11] = createElementVNode("div", { class: "stat-label" }, "利用率", -1)), createElementVNode("div", _hoisted_21, toDisplayString(utilizationRate.value) + "%", 1)])]),
										_: 1
									})
								]),
								_: 1
					...
					createElementVNode("div", _hoisted_22, [
						_cache[15] || (_cache[15] = createElementVNode("div", { class: "section-header" }, [createElementVNode("span", { class: "section-title" }, "实施效能分析")], -1)),
						createVNode(_component_el_row, { gutter: 16 }, {
							default: withCtx(() => [createVNode(_component_el_col, { span: 12 }, {
								default: withCtx(() => [_cache[13] || (_cache[13] = createElementVNode("h4", { class: "chart-sub-title" }, "任务完成率对比", -1)), createElementVNode("div", {
									ref_key: "completionRateChartRef",
									ref: completionRateChartRef,
									class: "chart-box"
								}, null, 512)]),
								_: 1
							}), createVNode(_component_el_col, { span: 12 }, {
								default: withCtx(() => [_cache[14] || (_cache[14] = createElementVNode("h4", { class: "chart-sub-title" }, "平均任务周期对比", -1)), createElementVNode("div", {
									ref_key: "durationChartRef",
						...
						_cache[16] || (_cache[16] = createElementVNode("h4", { class: "chart-sub-title" }, "代理商质量评分排名", -1)),
						createVNode(_component_el_table, {
							data: agentRanking.value,
							border: "",
							stripe: "",
							size: "small"
						}, {
							default: withCtx(() => [
								createVNode(_component_el_table_column, {
									...
									default: withCtx(({ row }) => [createVNode(_component_el_tag, {
										...
										default: withCtx(() => [createTextVNode(toDisplayString(row.rank), 1)]),
										_: 2
									}, 1032, ["type"])]),
									_: 1
								}),
								...
								createVNode(_component_el_table_column, {
									...
									default: withCtx(({ row }) => [createElementVNode("span", _hoisted_23, toDisplayString(Number(row.overallScore).toFixed(1)), 1)]),
									_: 1
								}),
								createVNode(_component_el_table_column, {
									...
									default: withCtx(({ row }) => [createTextVNode(toDisplayString(Number(row.responseSpeedScore).toFixed(1)), 1)]),
									_: 1
								}),
								createVNode(_component_el_table_column, {
									...
									default: withCtx(({ row }) => [createTextVNode(toDisplayString(Number(row.constructionQualityScore).toFixed(1)), 1)]),
									_: 1
								}),
								createVNode(_component_el_table_column, {
									...
									default: withCtx(({ row }) => [createTextVNode(toDisplayString(Number(row.documentCompletenessScore).toFixed(1)), 1)]),
									_: 1
								}),
								createVNode(_component_el_table_column, {
									prop: "taskCount",
...
}), [["__scopeId", "data-v-d30fbce0"]]);
//#endregion
export { report_default as default };

//# sourceMappingURL=report-Bd792gri.js.map