...
import { G as listTabs, T as deleteTab, Y as publishTab, g as archiveTab, k as exportTab } from "./lowcode-F-suzo7c.js";
...
//#region src/views/lowcode/tab-list/index.vue?vue&type=script&setup=true&lang.ts
var _hoisted_1 = { class: "tab-list-page" };
...
//#endregion
//#region src/views/lowcode/tab-list/index.vue
var tab_list_default = /*#__PURE__*/ _plugin_vue_export_helper_default(/* @__PURE__ */ defineComponent({
	__name: "index",
	setup(__props) {
		/**
		* 低代码标签页配置列表页。
		...
		*/
		...
		return (_ctx, _cache) => {
			...
			return openBlock(), createElementBlock("div", _hoisted_1, [createVNode(_component_el_card, {
				...
				header: withCtx(() => [createElementVNode("div", _hoisted_2, [_cache[9] || (_cache[9] = createElementVNode("span", null, "标签页配置列表", -1)), createVNode(_component_el_button, {
					type: "primary",
					icon: "Plus",
					onClick: handleAdd
				}, {
					default: withCtx(() => [..._cache[8] || (_cache[8] = [createTextVNode("新建标签页", -1)])]),
					_: 1
				})])]),
...
}), [["__scopeId", "data-v-a83729a5"]]);
//#endregion
export { tab_list_default as default };

//# sourceMappingURL=tab-list-BHeb5OIo.js.map