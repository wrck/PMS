...
public class ProjectController {
    ...
    @PostMapping
    @PreAuthorize("@ss.hasPermission('project:project:add')")
    ...
    @GetMapping("/{id}")
    @PreAuthorize("@ss.hasPermission('project:project:list')")
    ...
    @PutMapping
    @PreAuthorize("@ss.hasPermission('project:project:edit')")
    ...
    @DeleteMapping("/{id}")
    @PreAuthorize("@ss.hasPermission('project:project:remove')")
    ...
    @PreAuthorize("@ss.hasPermission('project:project:approve')")
    @OperLog(title = "项目管理", businessType = 2)
    @RateLimit(key = "T(com.dp.plat.common.util.SecurityUtils).getCurrentUserId()", capacity = 10, refillTokens = 10, refillPeriodSeconds = 60)
    ...
    @PreAuthorize("@ss.hasPermission('project:close')")
