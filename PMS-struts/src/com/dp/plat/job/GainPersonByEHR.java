...
public class GainPersonByEHR implements Job{
	...
	private void work() throws IOException, SQLException{
		Reader readerSap = Resources.getResourceAsReader("sqlMapConfigEHR.xml");
		...
		//开始同步，增加日志
		paramMap.put("refreshTaskName", GainPersonByEHR.class.toString());
		paramMap.put("handleUser", "system");
		paramMap.put("dataFrom", "EHR");
