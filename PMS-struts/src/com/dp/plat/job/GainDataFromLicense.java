 ...
 * @author w02611
 */
public class GainDataFromLicense extends AbstractSynchronizeTask implements Job {

    public GainDataFromLicense() {
	...
	public void work() {
        ...
        // 刷新同步License授权信息数据
        syncLicenseInfoFormLicense(params);
	}
	
	/**
     * 刷新同步License授权信息数据
     */
    public boolean syncLicenseInfoFormLicense(Map<String, Object> params) {
        String tag = "同步License授权信息数据";
        try {
            log.info("{}-开始", tag);
            // 刷新License同步授权信息数据
            syncData("LicenseInfoFormLicense", "License", params);
            return true;
        } catch (Exception e) {
...
//        }
	...
	public static void main(String[] args) {
		try {
			new GainDataFromLicense().execute(null);
