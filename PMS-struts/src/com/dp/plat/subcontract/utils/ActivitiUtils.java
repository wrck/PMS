...
public class ActivitiUtils {
	 ...
	 * @param taskList
	 */
	public static void terminateActivities(List<?> taskList, String terminateReason) {
		...
		for (Object task : taskList) {
			...
			for (Iterator<ActivityImpl> iterator = endActivityImpls.iterator(); iterator.hasNext();) {
				...
				if (!iterator.hasNext() || endActivityImpl.getId().contains("terminate")) {
					// 当前节点
					...
					// 执行转向任务
					taskService.addComment(taskId, null, terminateReason);
