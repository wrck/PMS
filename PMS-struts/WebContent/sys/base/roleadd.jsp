...
<div class="div-bottom divHeader" >
	<img src="images/right_zhishi.gif" border="0">
				<s:text name="sys.role.addDetail"></s:text>
</div>
<s:form method="post" action="base/RoleAddSubmit.action" id="mainForm" onsubmit="return checkallsub();" name="mainForm" cssClass="form-horizontal">
	<div class="panel panel-default">
	   <div class="panel-body">
	   			<div class="form-group">
				    ...
				    <div class="col-sm-3">
				      <input type="text" class="form-control" name="role.roleName" id="roleName" placeholder="请填入角色名称">
				    </div>
			    </div>
				<div class="form-group">
