...
<body>
	<display:table name="orderDataList" pagesize="${orderDataList.size()}" id="displaytable2"
		...
		<display:setProperty name="export.excel.filename" value='设备清单.xls'></display:setProperty>
	</display:table>
</body>
</html>