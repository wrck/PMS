	...
	*/
	...
	function changeServiceManagerTxt(e){
		...
		//	$("#programManagerDiv3").hide();
			...
			$("#agentChannelBr").show();
			$("#agentChannelBrHidden").hide();
			//$("#agentChannel").attr("placeholder", ($("#agentChannel").attr("placeholder") || "").replace("施工", "下单"));
			//$("label[for='agentChannel']").html(($("label[for='agentChannel']").html() || "").replace("施工", "下单"));
		}else if(sel == 1){
...
<!-- 	    	<s:textfield disabled="true" value="<s:date name='project.projectStartTime'/>" id="projectStartTime" placeholder="项目开始时间..." cssClass="form-control" cssStyle="width: 180px;display: inline-block;" />
 --> 		<s:if test="%{project.projectStartTime == null}">
        ...
        <div class="form-group form-group-query">
            ...
            <s:textfield disabled="true" name="project.majorProjectLevel" id="majorProjectLevel" placeholder="重大项目级别" cssClass="form-control" cssStyle="width: 180px;display: inline-block;" />
        </div>
		<br/>
		<div class="form-group form-group-query">
		...
		<div class="form-group form-group-query" style="display: none;" id="programManagerDiv3">
	    	...
	    	<s:textfield name="project.agentChannel" id="agentChannel" placeholder="下单/施工代理商..." cssClass="form-control" cssStyle="width: 180px;display: inline-block;" />
		</div>
        ...
        </div><br id="agentChannelBrHidden"/>
        <div class="form-group form-group-query">
		...
		<s:if test="%{((project.projectState == '20' && project.isback == '50')
			...
			<div class="form-group form-group-query" >
				<button type="button" onclick="back20Submit()" class="btn btn-default btn-block submitBtn" style="width: 100px;"><s:text name="不予跟踪"></s:text></button>
			</div>
		</s:if>
		<s:if test="%{(project.projectState == '20' && project.isback == '50')&& user.isHasRole(13)}">
			<div class="form-group form-group-query" >
				<button type="button" onclick="back30Submit()" class="btn btn-default btn-block submitBtn" style="width: 100px;"><s:text name="可以跟踪"></s:text></button>
			</div>
		</s:if>
