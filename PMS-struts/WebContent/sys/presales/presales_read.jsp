...
<body>
    ...
    <nav class="navbar navbar-default" role="navigation" style="margin-top: 20px;">
        <div>
            <ul class="nav navbar-nav">
                <li name="navli" class="active nav0" onclick="clickNavLi(0, 'workPlanDiv')"><a href="javascript:void(0)">工程计划</a></li>
            </ul>
        </div>
    </nav>
	<s:if test="taskList.size() != 0">
		<fieldset class="navDiv workPlanDiv">
	...
	<fieldset class="navDiv hideDiv deliverListDiv">
	...
	<fieldset id="product" class="navDiv hideDiv productListDiv">
    ...
    <!-- <fieldset class="navDiv hideDiv lend2SaleInfoListDiv">
    ...
    <fieldset class="navDiv hideDiv lend2RmaInfoListDiv">
        <legend><b>核销信息</b></legend>
        <div class="loading" style='height:180px;display:-webkit-flex;display: flex;justify-content:center;align-items:center;'>
            <img src='./images/loading-circle.gif'/>
        </div>
    </fieldset>
    <fieldset class="navDiv hideDiv shipmentInfoListDiv">
        <legend><b>发货信息</b></legend>
        <div class="loading" style='height:180px;display:-webkit-flex;display: flex;justify-content:center;align-items:center;'>
            <img src='./images/loading-circle.gif'/>
        </div>
    </fieldset> -->
	<fieldset class="navDiv hideDiv workflowListDiv">
