		...
		<div class="panel panel-default">
 		...
 		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<!-- 问卷已提交 -->
				<s:if test="cbQuesnaire.quesnaireState == 1">
					<s:form method="post" action="module/sub/callback_aduit.action" cssClass="form-inline" id="submitWorkFlow">
						...
						<div class="form-group form-group-query" style="margin-top:10px;">
							...
							<textarea id="seeScoreEvaluationComment" name="param.comment" class="form-control" rows="3"  style="float:left; width: 350px;"></textarea>
						</div>	
						<div class="form-group form-group-query" style="margin-top:10px;">
							<div id="cbResultRadio">								
								<label class="checkbox-inline" style="margin-left:80px;margin-top:20px;">
						      		<input type="radio" name="param.outcome" id="seeEvaluationResultNoYes" 
						         value="1" checked> <s:text name="workflow.agree"></s:text>
						   		</label>
						   		<label class="checkbox-inline" style="margin-right:4px;margin-top:20px;">
						      		<input type="radio" name="param.outcome" id="seeEvaluationResultNo" 
						         	value="-1"> <s:text name="workflow.reject"></s:text>
						   		</label>
					   		</div>
						</div>
						<br/>
						<div class="btn-group btn-group-sm" style="margin-left:80px;margin-top:20px;">
							 <button id="submitFlow" type="button" class="btn btn-info" style="margin-right:4px;">
				...
				<s:else>
					<s:form method="POST" action="module/sub/callback_aduit.action"
						id="cbCLDivChoseForm" cssClass="form-inline" style="float:left;">
						<s:hidden name="callBack.projectId" />
						<s:hidden name="callBack.callBackId"></s:hidden>
						<s:hidden name="callBack.taskId"></s:hidden>
						<div class="form-group form-group-query">
							<label for="pmCLQuesName" style="width: 90px;"><span
								class="redmark">*</span>
							<s:text name="pm.cl.questionnaireName" /></label> 
							<%-- <select
					...
					<div class="panel panel-default">
						...
						<div id="cbcollapseOne" class="panel-collapse collapse in">
							<div class="panel-body">
								...
								<s:form method="post" action="module/sub/callback_aduit.action" id="cbCLForm">
									...
									<s:if test="cbQuesnaire.quesnaireState == 1">
										<div> 
											<div class="pmclnotice">
												...
												<s:iterator value="cbQuesnaire.quesResultMarkList" id="objRMark" status="indexRmark">
									...
									<!-- 新问卷或者草稿 -->
									<s:if test="(callBack.quesnaireId==0|| cbQuesnaire.quesnaireState == -1)&&pmClosedLoopQuesnaireLineList.size()>0 ">
										<div>
