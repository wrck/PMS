...
| createTime | datetime | YES | - |  | 创建时间 | 记录创建时间（指定服务经理时间） |
| createBy | varchar(45) | YES | - |  | 创建用户 | 记录创建用户 |
| updateTime | datetime | YES | - |  | 最新更新时间 | 记录最新更新时间 |
| updateBy | varchar(45) | YES | - |  | 最新更新用户 | 记录最新更新用户 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 合同记录唯一标识 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 自增主键，项目组唯一标识 |
...
| updateTime | datetime | YES | - |  | 最新更新时间 | 记录最新更新时间 |
| updateBy | varchar(15) | YES | - |  | 最新更新用户 | 记录最新更新用户编码 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 自增主键，关系记录唯一标识 |
| projectGroupCode | varchar(45) | NO | - | MUL | 项目组编码 | 逻辑外键 -> pm_project_group.projectGroupCode |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 自增主键，成员记录唯一标识 |
| projectId | int(11) | YES | - | MUL | 项目头信息主键,跟项目其他具体信息关联 | 逻辑外键 -> pm_project.projectId 或 pm_presales_project_header.presalesId |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| projectId | int(11) | NO | - | PRI | 项目头信息主键 | 项目头信息主键,跟项目其他具体信息关联，逻辑外键 -> pm_project.projectId |
...
| projectId | int(11) | YES | - | MUL | 项目头信息主键 | 项目头信息主键,跟项目其他具体信息关联逻辑外键 -> pm_project.projectId |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 自增主键，相关方记录唯一标识 |
| projectId | int(11) | YES | - | MUL | 项目表ID | 逻辑外键 -> pm_project.projectId |
| partyRole | varchar(45) | YES | - | MUL | 渠道类型 | 0=服务商渠道，1=代理商渠道 |
| partyCode | varchar(45) | YES | - | 代理商/服务商编码 | 相关方（渠道商/代理商）编码 | 相关方（渠道商/代理商）编码 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | MUL, auto_increment | 主键ID | 自增主键，产品线记录唯一标识 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 自增主键，发货记录唯一标识 |
| projectId | int(11) | YES | - | MUL | 项目头信息主键 | 项目头信息主键,跟项目其他具体信息关联，逻辑外键 -> pm_project.projectId |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 自增主键，维护记录唯一标识 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 自增主键，日志记录唯一标识 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 自增主键，批示记录唯一标识 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 自增主键，督查记录唯一标识 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| weeklyId | int(11) | NO | - | PRI, auto_increment | 周报主信息ID | 周报自增主键 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 自增主键，内容记录唯一标识 |
...
| barCode | varchar(25) | YES | - | MUL | 序列号 | 设备序列号/条码 |
| conp | varchar(100) | YES | - | MUL | CONP软件版本号 | CONP软件版本号 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 自增主键，通知记录唯一标识 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 自增主键，状态记录唯一标识 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, AUTO_INCREMENT | 主键ID | 项目周报回复内容 |
| weeklyId | int(11) | YES | - | MUL | 周报主信息ID | 逻辑外键 -> pm_project_weekly.weeklyId |
| feedback | text | YES | - |  | 反馈 | 反馈 |
| feedbacker | varchar(25) | YES | - |  | 反馈人 | 反馈人 |
| feedbackTime | datetime | YES | - |  | 反馈时间 | 反馈时间 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 自增主键，关联记录唯一标识 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) unsigned | NO | - | PRI, auto_increment | 主键ID | 自增主键，评价记录唯一标识 |
| projectCode | varchar(45) | NO | - | MUL | 项目编码 | 项目编码 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) unsigned | NO | - | PRI, auto_increment | 主键ID | 自增主键，问卷结果唯一标识 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) unsigned | NO | - | PRI, auto_increment | 主键ID | 自增主键，结果行唯一标识 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(10) unsigned | NO | - | PRI, auto_increment | 主键ID | 自增主键，模板唯一标识 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) unsigned | NO | - | PRI, auto_increment | 主键ID | 自增主键，题目唯一标识 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) unsigned | NO | - | PRI, auto_increment | 主键ID | 自增主键，选项唯一标识 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| productLineId | int(11) | NO | - | PRI, auto_increment | 产品线自增主键 | 产品线自增主键 |
...
| effectiveFrom | datetime | YES | - |  | 数据有效开始时间 | 数据有效性开始时间（软删除模式） |
| effectiveTo | datetime | YES | - |  | 数据有效结束时间 | 数据有效性结束时间，NULL=当前有效 |
| source | varchar(25) | YES | SMS |  | 数据来源 | 数据来源标识，默认SMS |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| presalesId | int(11) | NO | - | PRI | 售前项目主表 | 逻辑外键 -> pm_presales_project_header.presalesId |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 自增主键，转包项目唯一标识 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 自增主键，转包明细唯一标识 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 自增主键，服务商唯一标识 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 自增主键，付款记录唯一标识 |
| subcontractId | int(11) | NO | - | MUL | 转包项目Id | 逻辑外键 -> pm_subcontract_project_header.id |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 自增主键，交付件唯一标识 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | Java Bean中映射为probId |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 自增主键，产品关联唯一标识 |
...
| itemDesc | varchar(255) | YES | - |  | 产品描述 | 产品描述 |
| status | int(11) | YES | 1 |  | 0 失效 1 有效 | 0 失效 1 有效 |
| customInfo | json | YES | - |  | 自定义信息 | JSON扩展字段 |
| createBy | varchar(25) | YES | - |  | 创建用户 | 记录创建用户编码 |
| createTime | datetime | YES | CURRENT_TIMESTAMP |  | 创建时间 | 记录创建时间 |
| updateBy | varchar(25) | YES | - |  | 最新更新用户 | 记录最新更新用户编码 |
| updateTime | datetime | YES | - | on update CURRENT_TIMESTAMP | 记录数据最新更新时间 | 记录最新更新时间 |
...
| conp | varchar(100) | YES | - | MUL | CONP软件版本 | 受影响主控版本号 |
| cpld | varchar(100) | YES | - | MUL | CPLD版本号 | 受影响CPLD版本号 |
| boot | varchar(100) | YES | - | MUL | Boot版本号 | 受影响Boot版本号 |
| pcb | varchar(100) | YES | - | MUL | PCB版本号 | 受影响PCB版本号 |
...
| createBy | varchar(10) | YES | - |  | 创建用户 | 记录创建用户编码 |
| createTime | datetime | YES | - |  | 创建时间 | 记录创建时间 |
| updateBy | varchar(10) | YES | - |  | 最新更新用户 | 记录最新更新用户编码 |
| updateTime | datetime | YES | - |  | 最新更新时间 | 记录最新更新时间 |
| customInfo | json | YES | - |  | 自定义信息 | JSON扩展字段，存储动态属性 |
...
| conp | varchar(255) | YES | - |  | CONP软件版本 | 任务发布时的软件版本 |
| boot | varchar(100) | YES | - |  | Boot版本号 | BOOT引导程序版本号 |
| cpld | varchar(100) | YES | - |  | CPLD版本号 | CPLD固件版本号 |
| pcb | varchar(100) | YES | - |  | PCB版本号 | PCB电路板版本号 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 自增主键，阅读记录唯一标识 |
| probId | int(11) | NO | - |  | 技术公告ID | 逻辑外键 -> prob_main.id |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 自增主键，基础数据唯一标识 |
| dataTypeCode | varchar(45) | YES | - | MUL | 数据类型编码 | 逻辑外键 -> fnd_basic_data_type.dataTypeCode |
| basicDataId | varchar(255) | YES | - | MUL | 基础数据ID | 数据项编码 |
| basicDataName | varchar(255) | YES | - |  | 活动 | 数据项名称 |
| basicDataAttri1 | varchar(255) | YES | - |  | 字段属性1 | 字段属性1 |
| sortId | int(11) | YES | - |  | 排序 | 查询排序字段数值越大越在前 |
| createTime | datetime | YES | - |  | 创建时间 | 记录创建时间 |
| createBy | varchar(45) | YES | - |  | 创建用户 | 记录创建用户编码 |
| updateTime | datetime | YES | - |  | 最新更新时间 | 记录最新更新时间 |
| updateBy | varchar(45) | YES | - |  | 最新更新用户 | 记录最新更新用户编码 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 自增主键，数据类型唯一标识 |
| dataTypeCode | varchar(45) | YES | - |  | 数据类型编码 | 数据类型唯一编码 |
| dataTypeName | varchar(45) | YES | - |  | 数据类型名称 | 数据类型名称 |
| status | int(11) | YES | - |  | 是否前台管理 | 是否需要放在前台管理 |
| createTime | datetime | YES | - |  | 创建时间 | 记录创建时间 |
| createBy | varchar(45) | YES | - |  | 创建用户 | 记录创建用户编码 |
| updateTime | datetime | YES | - |  | 最新更新时间 | 记录最新更新时间 |
| updateBy | varchar(45) | YES | - |  | 最新更新用户 | 记录最新更新用户编码 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 自增主键，公司唯一标识 |
...
| status | smallint(1) | NO | 1 |  | 有效性 | 有效性（1-有效，0-失效），默认有效 |
| createTime | datetime | YES | - |  | 创建时间 | 记录创建时间 |
| createBy | varchar(32) | YES | - |  | 创建用户 | 记录创建用户编码 |
| updateTime | datetime | YES | - |  | 最新更新时间 | 记录最新更新时间 |
| updateBy | varchar(32) | YES | - |  | 最新更新用户 | 记录最新更新用户编码 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 自增主键，部门唯一标识 |
| departmentNum | varchar(20) | NO | - | UNI | 部门编码，全局唯一 | 部门编码，全局唯一 |
| departmentName | varchar(20) | NO | - |  | 部门名称 | 部门名称 |
| isparam | int(11) | YES | 0 |  | 是否为参数部门 | 是否为参数部门，1=参数部门（如办事处/市场部），0=非参数部门 |
| status | int(11) | NO | 1 |  | 状态 | 部门状态，1=启用，0=禁用 |
| createTime | datetime | YES | - |  | 创建时间 | 记录创建时间 |
| effectiveFrom | datetime | YES | - |  | 有效开始时间 | 数据有效性开始时间（软删除模式） |
| effectiveTo | datetime | YES | - |  | 有效结束时间 | 数据有效性结束时间，NULL=当前有效 |
| updateTime | datetime | YES | - |  | 最新更新时间 | 记录最新更新时间 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(8) | NO | - | PRI, auto_increment | 主键ID | 自增主键，用户唯一标识 |
| username | varchar(128) | NO | - | MUL | 关联用户账号 | 用户登录名，全局唯一 |
| password | varchar(32) | NO | 5416d7cd6ef195a0f7622a9c56b55e84 |  | 密码 | 加密后的用户密码 |
| email | varchar(128) | NO | - |  | 邮箱账号 | 用户邮箱 |
| dpNo | varchar(25) | YES | - |  | 用户所属部门编码，逻辑外键 -> fnd_department.departmentNum | 用户所属部门编码，逻辑外键 -> fnd_department.departmentNum |
| realName | varchar(128) | NO | - |  | 姓名 | 用户真实姓名 |
| roleIds | varchar(64) | YES | - |  | 用户角色，支持多角色 | 用户角色，支持多角色 |
| isemail | int(11) | YES | - |  | 是否接收邮件 | 是否接收邮件通知，1=接收，0=不接收 |
| status | int(1) | YES | - |  | 有效性 | 用户状态，1=启用，0=禁用 |
| defaultPage | varchar(255) | YES | - |  | 该用户登录首页 | 该用户登录首页 |
| pwdoverdue | datetime | YES | - |  | 密码过期时间，超过此时间需强制修改密码 | 密码过期时间，超过此时间需强制修改密码 |
| createBy | varchar(25) | YES | - |  | 创建用户 | 记录创建用户编码 |
| createTime | datetime | YES | - |  | 创建时间 | 记录创建时间 |
| updateBy | varchar(25) | YES | - |  | 最新更新用户 | 记录最新更新用户编码 |
| updateTime | datetime | YES | - |  | 最新更新时间 | 记录最新更新时间 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(6) | NO | - | PRI, auto_increment | 主键ID | 自增主键，角色唯一标识 |
| roleName | varchar(64) | NO | - | UNI | 角色名称 | 角色名称 |
| defaultPage | varchar(255) | YES | - |  | 该角色登录的默认首页 | 该角色登录的默认首页 |
| status | int(1) | NO | - |  | 有效性 | 角色状态，1=启用，0=禁用 |
| effectiveFrom | datetime | YES | - |  | 有效开始时间 | 数据有效性开始时间（软删除模式） |
| effectiveTo | datetime | YES | - |  | 有效结束时间 | 数据有效性结束时间，NULL=当前有效 |
| createBy | varchar(25) | YES | - |  | 创建用户 | 记录创建用户编码 |
| createTime | datetime | YES | - |  | 创建时间 | 记录创建时间 |
| updateBy | varchar(25) | YES | - |  | 最新更新用户 | 记录最新更新用户编码 |
| updateTime | datetime | YES | - |  | 最新更新时间 | 记录最新更新时间 |
| roleRemark | varchar(200) | YES | - |  | 角色备注说明 | 角色备注说明 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 自增主键，权限记录唯一标识 |
| fndUserId | int(11) | YES | - |  | 关联用户ID，逻辑外键 -> fnd_user_info.id | 关联用户ID，逻辑外键 -> fnd_user_info.id |
| username | varchar(25) | YES | - |  | 关联用户账号 | 逻辑外键 -> fnd_user_info.username |
| areapower | varchar(4096) | YES | - |  | 用户数据权限区域编码，逗号分隔的部门编码列表，-1=全部权限 | 用户数据权限区域编码，逗号分隔的部门编码列表，-1=全部权限 |
| createTime | datetime | YES | - |  | 创建时间 | 记录创建时间 |
| createBy | varchar(25) | YES | - |  | 创建用户 | 记录创建用户编码 |
| updateTime | datetime | YES | - |  | 最新更新时间 | 记录最新更新时间 |
| updateBy | varchar(25) | YES | - |  | 最新更新用户 | 记录最新更新用户编码 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 自增主键，邮件记录唯一标识 |
...
| mailServerPort | varchar(25) | YES | - |  | 邮件服务器端口 | 邮件服务器端口 |
| mailServerHost | varchar(25) | YES | - |  | 邮件服务器地址 | 邮件服务器地址 |
| mailUsername | varchar(25) | YES | - |  | 邮件服务器登录用户名 | 邮件服务器登录用户名 |
| mailPassword | varchar(25) | YES | - |  | 邮件服务器登录密码 | 邮件服务器登录密码 |
| mailFromaddress | varchar(25) | YES | - |  | 邮件发件人地址 | 邮件发件人地址 |
| sendFlag | int(11) | YES | 0 |  | 邮件是否发送 1 为已发送 | 邮件是否发送 1 为已发送 |
| createBy | varchar(25) | YES | - |  | 创建用户 | 记录创建用户编码 |
| createTime | datetime | YES | - |  | 创建时间 | 记录创建时间 |
| updateBy | varchar(25) | YES | - |  | 最新更新用户 | 记录最新更新用户编码 |
| updatteTime | datetime | YES | - |  | 记录更新时间（字段名拼写错误，应为updateTime） | 记录更新时间（字段名拼写错误，应为updateTime） |
| effectiveFrom | datetime | YES | - |  | 有效开始时间 | 数据有效性开始时间（软删除模式） |
| effectiveTo | datetime | YES | - |  | 有效结束时间 | 数据有效性结束时间，NULL=当前有效 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 自增主键，刷新日志唯一标识 |
| refreshTaskName | varchar(100) | YES | - |  | 刷新任务名称（Java类全限定名） | 刷新任务名称（Java类全限定名） |
| handleUser | varchar(15) | YES | - |  | 操作用户 | 执行刷新操作的用户，通常为system |
| dataFrom | varchar(25) | YES | - |  | 同步数据源 | 数据来源系统标识（如SMS/CRM/Local） |
| dataTo | varchar(25) | YES | - |  | 同步目标数据源 | 数据目标系统标识 |
...
| refreshException | mediumtext | YES | - |  | 刷新异常堆栈信息，失败时记录完整异常 | 刷新异常堆栈信息，失败时记录完整异常 |
...
| code | varchar(64) | YES | - |  | 系统参数编码 | 系统参数编码（唯一标识，如sys.envirment.argu） |
| var | text | YES | - |  | 系统参数值 | 系统参数值（支持字符串/JSON/数字等多种格式） |
| effectiveFrom | datetime | YES | - |  | 有效开始时间 | 数据有效性开始时间（软删除模式） |
| effectiveTo | datetime | YES | - |  | 有效结束时间 | 数据有效性结束时间，NULL=当前有效 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 自增主键，菜单唯一标识 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 自增主键，角色菜单关联唯一标识 |
| roleId | int(11) | NO | - |  | 关联角色ID，逻辑外键 -> fnd_roles.id | 关联角色ID，逻辑外键 -> fnd_roles.id |
| menuId | int(11) | NO | - |  | 关联菜单ID | 关联菜单ID |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 自增主键，用户菜单关联唯一标识 |
| fnd_user_id | int(11) | YES | - |  | 关联用户ID，逻辑外键 -> fnd_user_info.id | 关联用户ID，逻辑外键 -> fnd_user_info.id |
| username | varchar(128) | YES | - |  | 关联用户账号 | 逻辑外键 -> fnd_user_info.username |
| menuCode | varchar(50) | YES | - |  | 菜单编码 | 逻辑外键 -> fnd_menus.menuCode |
| menuValue | int(1) | YES | - |  | 菜单权限值，1=有权限 | 菜单权限值，1=有权限 |
| effectiveFrom | datetime | YES | - |  | 有效开始时间 | 数据有效性开始时间（软删除模式） |
| effectiveTo | datetime | YES | - |  | 有效结束时间 | 数据有效性结束时间，NULL=当前有效 |
| createdBy | varchar(25) | YES | - |  | 创建人 | 记录创建人用户编码 |
| createTime | datetime | YES | - |  | 创建时间 | 记录创建时间 |
| updateBy | varchar(25) | YES | - |  | 最新更新用户 | 记录最新更新用户编码 |
| updateTime | datetime | YES | - |  | 最新更新时间 | 记录最新更新时间 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 自增主键，项目状态唯一标识 |
...
| code | varchar(25) | YES | - |  | 系统参数编码 | SPMS系统参数编码（唯一标识） |
| var | text | YES | - |  | 系统参数值 | SPMS系统参数值（支持字符串/JSON等格式） |
| mark | varchar(255) | YES | - |  | SPMS系统参数说明/备注 | SPMS系统参数说明/备注 |
| effectiveFrom | datetime | YES | - |  | 有效开始时间 | 数据有效性开始时间（软删除模式） |
| effectiveTo | datetime | YES | - |  | 有效结束时间 | 数据有效性结束时间，NULL=当前有效 |
...
| productSubCode | varchar(255) | YES | '' | - | 产品编码 | 产品编码 |
| productSubModel | varchar(255) | YES | '' | - | 产品型号 | 产品型号 |
| productSubName | varchar(255) | YES | '' | - | 产品名称 | 产品名称 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 主键ID |
| maintenanceId | int(11) | NO | - | MUL | 维保ID | 维保ID |
| projectId | int(11) | YES | - | MUL | 项目头信息主键 | 项目头信息主键,跟项目其他具体信息关联，逻辑外键 -> pm_project.projectId 或 pm_presales_project_header.presalesId |
| projectType | varchar(25) | YES | 10 |  | 项目数据类型 | 售前:20/售后:10，逻辑外键 -> fnd_basic_data(dataTypeCode=presalesType) |
| serviceType | varchar(25) | YES | - | MUL | 服务类型 | 服务类型 |
| processTime | datetime | YES | - |  | 处理时间 | 服务处理时间 |
| year | int(4) | YES | - |  | 所属年度 | 服务记录所属年度 |
| quarter | int(2) | YES | - |  | 所属季度 | 服务记录所属季度(1-4) |
| month | int(2) | YES | - |  | 所属月份 | 服务记录所属月份(1-12) |
| deliveried | int(1) | YES | 0 |  | 已交付标识 | 已交付标识 |
| startDate | date | YES | - |  | 开始日期 | 开始日期 |
| endDate | date | YES | - |  | 结束日期 | 结束日期 |
| count | int(2) | YES | 0 |  | 数量 | 数量 |
| yearCount | int(2) | YES | 0 |  | year数量 | year数量 |
| remark | varchar(2048) | YES | - |  | 关于资源定义的备注说明 | 关于资源定义的备注说明 |
| createBy | varchar(25) | YES | - |  | 创建用户 | 记录创建用户编码 |
| createTime | datetime | YES | - |  | 创建时间 | 记录创建时间（指定服务经理时间） |
| updateBy | varchar(25) | YES | - |  | 最新更新用户 | 记录最新更新用户编码 |
| updateTime | datetime | YES | - |  | 最新更新时间 | 记录最后更新时间，自动更新（on update CURRENT_TIMESTAMP） |
...
| industryName | varchar(25) | YES | - | - | 行业名称 | 客户所属行业名称 |
...
| userOfficeName | varchar(20) | YES | - | - | 用户办事处名称 | 维保人员所属办事处名称 |
| serviceManager | varchar(45) | YES | - | - | 服务经理 | 服务经理姓名（冗余自pm_project） |
| programManagerA | varchar(45) | YES | - | - | 项目经理A | 第一项目经理姓名 |
| programManagerB | varchar(45) | YES | - | - | 项目经理B | 第二项目经理姓名 |
| createUser | varchar(174) | YES | - | - | 创建用户名 | 创建人姓名（冗余，含工号+姓名拼接） |
| typeName | varchar(255) | YES | - | - | 类型名称 | 维保类型中文名称（冗余自fnd_basic_data） |
| projectExecutionStateName | varchar(255) | YES | - | - | 项目执行状态名称 | 项目执行状态中文名称 |
| categoryName | varchar(258) | YES | - | - | 分类名称 | 维保分类中文名称 |
| subCategoryName | varchar(255) | YES | - | - | 子分类名称 | 维保子分类中文名称 |
| marketName | varchar(255) | YES | - | - | 市场部名称 | 市场部名称 |
| systemName | varchar(255) | YES | - | - | 系统部名称 | 系统部名称 |
| expendName | varchar(255) | YES | - | - | 拓展部名称 | 拓展部名称 |
| industryNameN | varchar(255) | YES | - | - | 行业名称N | 子行业名称（冗余，与industryName区分） |
| finalCustomerName | varchar(255) | YES | - | - | 最终客户名称 | 最终客户名称 |
| salerName | varchar(91) | YES | - | - | 销售人员名称 | 销售人员姓名 |
...
| warrantyStatusName | varchar(4) | YES | - | - | 维保状态名称 | 维保状态中文名称 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | auto_increment | PRI, auto_increment | 主键 | 主键ID |
...
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 主键ID |
| username | varchar(10) | NO | - | - | 关联用户账号 | 逻辑外键 -> fnd_user_info.username |
| updateType | int(11) | YES | - | - | 更新类型 | 更新类型 |
| barcode | varchar(20) | YES | - | - | 设备序列号 | 设备序列号/条码 |
| warrantyStartTime | datetime | YES | - | - | 维保开始日期 | 维保合同开始日期 |
| warrantyEndTime | datetime | YES | - | - | 维保结束日期 | 维保合同结束日期 |
| warrantyTimes | int(11) | YES | - | - | 续保次数 | 续保次数 |
| updateTime | datetime | YES | - | - | 最新更新时间 | 记录最后更新时间，自动更新（on update CURRENT_TIMESTAMP） |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(10) | NO | - | PRI, auto_increment | 主键ID | 主键ID |
...
| applicant_project | varchar(255) | YES | - | - | 申请项目 | 申请项目 |
| start_time | date | YES | - | - | 开始时间 | 开始时间 |
| promise_returntime | date | YES | - | - | 承诺备件归还时间 | 承诺备件归还时间 |
| kept_place | varchar(255) | YES | - | - | 备件存放地 | 备件存放地 |
| beforeChange_spareCode | varchar(50) | YES | - | - | 转移前编码 | 转移前编码 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| newId | bigint(20) | NO | - | PRI, AUTO_INCREMENT | 主键ID | 主键ID |
| id | bigint(20) | YES | - |  | 发货记录ID | 发货记录ID |
| barcode | varchar(50) | YES | - | MUL | 设备序列号 | 设备序列号/条码 |
| comBarCode | varchar(50) | YES | - | MUL | 组合编码 | 组合编码 |
| old_warrantyEndTime | datetime | YES | - |  | 维保结束时间（旧规则） | 维保结束时间（旧规则） |
| warrantyEndTime | datetime | YES | - | MUL | 维保结束日期 | 维保合同结束日期 |
| old_diff | int(7) | YES | - |  | 差异（旧规则） | 差异（旧规则） |
| diff | int(7) | YES | - | MUL | 差异 | 差异 |
| warrantyStartTime | datetime | YES | - |  | 维保开始日期 | 维保合同开始日期 |
| old_warrantyStartTime | datetime | YES | - |  | 维保开始时间（旧规则） | 维保开始时间（旧规则） |
| item | varchar(16) | YES | - | MUL | 物料 | 子公司物料编码 |
| describe_ | varchar(255) | YES | - |  | 物料描述 | 物料描述 |
| itemName | varchar(255) | YES | - |  | 产品名称 | 忽略的物料名称 |
| gradeName | varchar(125) | YES | - |  | grade名称 | grade名称 |
| gradeCode | varchar(25) | YES | - | MUL | grade编码 | grade编码 |
| packdate | datetime | YES | - |  | 发货日期 | 发货日期 |
| contract_code | varchar(25) | YES | - | MUL | 合同号（业务编号） | 合同号（业务编号） |
| contract_type | int(11) | YES | - |  | 合同类型（0销售合同/11维修合同等） | 合同类型（0销售合同/11维修合同等） |
| contract_type_name | varchar(25) | YES | - |  | 合同类型名称 | 合同类型名称 |
| project_name | varchar(512) | YES | - |  | 项目名称/申请原因 | 项目名称/申请原因 |
| customer_name | varchar(512) | YES | - |  | 客户名称 | 客户名称 |
| office_code | varchar(25) | YES | - | MUL | 办事处编码 | 办事处编码 |
| office_name | varchar(25) | YES | - |  | 办事处名称 | 办事处名称 |
| marketCode | varchar(10) | YES | - | MUL | 市场部编码 | 市场部编码 |
| marketName | varchar(15) | YES | - |  | 市场部名称 | 市场部名称 |
| systemId | int(11) | YES | - |  | 系统部ID | 系统部ID |
| systemName | varchar(15) | YES | - |  | 系统部名称 | 系统部名称 |
| warranty | varchar(2) | YES | - |  | 维保年限 | 维保年限 |
| warrantyMonth | double | YES | - |  | 维保月数 | 维保月数 |
| barcode2 | varchar(50) | YES | - | MUL | 母子公司发货序列号对应关系 | 母子公司发货序列号对应关系 |
| item2 | varchar(16) | YES | - |  | 母子公司发货物料编码对应关系 | 母子公司发货物料编码对应关系 |
| describe_2 | varchar(255) | YES | - |  | 产品描述2 | 产品描述2 |
| itemName2 | varchar(255) | YES | - |  | 产品名称2 | 产品名称2 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| contractNo | varchar(25) | YES | - | MUL | 合同编号 | 合同编号，逻辑外键 -> pm_project_product_line.contractNo |
| diff | decimal(23,0) | YES | - |  | 差异 | 差异 |
| warrantyStatusName | varchar(4) | YES | - |  | 维保状态名称 | 维保状态中文名称 |
| warrantyStartTime | datetime | YES | - |  | 维保开始日期 | 维保合同开始日期 |
| warrantyEndTime | datetime | YES | - |  | 维保结束日期 | 维保合同结束日期 |
| 维保等级 | int(3) | YES | - |  | 维保等级 | 维保等级 |
| 维保等级StartTime | datetime | YES | - |  | 维保等级开始时间 | 维保等级开始时间 |
| 维保等级EndTime | datetime | YES | - |  | 维保等级结束时间 | 维保等级结束时间 |
| gradecodes | mediumtext | YES | - |  | 等级编码 | 等级编码 |
| gradenames | mediumtext | YES | - |  | 等级名称 | 等级名称 |
| gradedesc | mediumtext | YES | - |  | 等级描述 | 等级描述 |
| hasRenewal | int(1) | NO | 0 |  | 拥有标识 | 拥有标识 |
| renewalDesc | mediumtext | YES | - |  | 续保描述 | 续保描述 |
| hasLiscense | bigint(1) | YES | - |  | 是否含授权 | 是否含授权 |
| liscenseCodes | mediumtext | YES | - |  | liscenseCodes | liscenseCodes |
| liscenseDesc | mediumtext | YES | - |  | liscense描述 | liscense描述 |
| wafService | bigint(1) | YES | - |  | wafService | wafService |
| wafServiceStartTime | datetime | YES | - |  | wafServiceStart时间 | wafServiceStart时间 |
| wafServiceEndTime | datetime | YES | - |  | wafServiceEnd时间 | wafServiceEnd时间 |
| itemCode | mediumtext | YES | - |  | item编码 | ERP系统产品编码 |
| itemDesc | mediumtext | YES | - |  | 产品描述 | 产品描述 |
...
|--------|----------|------|--------|------|----------|----------|
| newId | bigint(20) | NO | - | PRI, AUTO_INCREMENT | 主键ID | 主键ID |
| id | bigint(20) | YES | - |  | 发货记录ID | 发货记录ID，对应pm_project_maintenance.id |
| barcode | varchar(50) | YES | - | MUL | 设备序列号 | 设备序列号/条码 |
| comBarCode | varchar(50) | YES | - | MUL | 组合编码 | 组合编码 |
| old_warrantyEndTime | datetime | YES | - |  | 维保结束时间（旧规则） | 维保结束时间（旧规则） |
| warrantyEndTime | datetime | YES | - | MUL | 维保结束日期 | 维保合同结束日期 |
...
| packdate | datetime | YES | - |  | 发货日期 | 发货日期 |
| contract_code | varchar(25) | YES | - | MUL | 合同号（业务编号） | 合同号（业务编号） |
| contract_type | int(11) | YES | - |  | 合同类型 | 合同类型（0销售合同/11维修合同等） |
| contract_type_name | varchar(25) | YES | - |  | 合同类型名称 | 合同类型名称 |
| project_name | varchar(512) | YES | - |  | 项目名称/申请原因 | 项目名称/申请原因 |
| customer_name | varchar(512) | YES | - |  | 客户名称 | 客户名称 |
| office_code | varchar(25) | YES | - | MUL | 办事处编码 | 办事处编码 |
...
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 主键ID |
| gradecode | varchar(25) | YES | - | MUL | 等级编码 | 等级编码 |
| gradename | varchar(125) | YES | - | - | 等级名称 | 等级名称 |
| gradestatus | int(11) | YES | 0 | - | 等级状态 | 等级状态 |
| sort | int(3) | YES | 0 | - | 子菜单排序 | 排序 |
| effectiveFrom | datetime | YES | - | - | 有效开始时间 | 生效开始时间 |
| effectiveTo | datetime | YES | - | - | 有效结束时间 | 生效结束时间 |
...
| createBy | varchar(25) | YES | - | - | 创建用户 | 记录创建用户编码 |
| createTime | datetime | YES | CURRENT_TIMESTAMP | - | 创建时间 | 创建时间 |
| updateBy | varchar(25) | YES | - | - | 最新更新用户 | 记录最新更新用户编码 |
| updateTime | datetime | YES | - | - | 最新更新时间 | 更新时间 |
...
| createBy | varchar(25) | YES | - | - | 创建用户 | 记录创建用户编码 |
| createTime | datetime | YES | CURRENT_TIMESTAMP | - | 创建时间 | 记录创建时间（指定服务经理时间） |
| updateBy | varchar(25) | YES | - | - | 最新更新用户 | 记录最新更新用户编码 |
| updateTime | datetime | YES | - | - | 最新更新时间 | 记录最后更新时间，自动更新（on update CURRENT_TIMESTAMP） |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| agent_id | int(10) | NO | - | PRI, auto_increment | agentID | agentID |
| id | varchar(16) | NO | - | MUL | 主键ID | 主键ID |
| name | varchar(64) | NO | - | - | 组织机构全名 | 名称 |
| type | int(8) | NO | - | - | 交付件类型,0:用服交付合同，1：用服服务单，2：工程合同 | 类型 |
| level | varchar(64) | YES | - | - | 级别 | 级别 |
| enable | int(8) | NO | 1 | - | 启用标识 | 启用标识 |
| agent_version | int(8) | NO | 0 | - | agentversion | agentversion |
...
| back | varchar(10) | NO | - | MUL | 返回类型 | 退回类型编码 |
| back_type | varchar(50) | YES | - | - | 返回类型('1'为"开坏箱",'2'为"开局坏",'3'为“网上运行坏”,'4'为"备件发货坏",'5'为"其他") | 退回类型名称 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| serve | varchar(10) | NO | - | MUL | 服务类型 | 服务编码 |
| serve_type | varchar(10) | YES | - | - | 服务类型('1'为“坏件先退”,'2'为“好件先行”) | 服务类型名称 |
| remark | text | YES | - | - | 备注 | 备注 |
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 主键ID |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| tain | varchar(10) | NO | - | MUL | 维保类型 | 维修编码 |
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 主键ID |
| tain_type | varchar(50) | YES | - | - | 维保类型(‘1’为“服务合同”,'2'为"项目订单") | 维修类型名称 |
| remark | text | YES | - | - | 备注 | 备注 |
...
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 主键ID |
| sheetID | varchar(10) | NO | - | - | RMA申请流水号，多个合同号_n | RMA申请流水号，多个合同号_n |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI | 主键ID | 主键ID |
| projectCode | varchar(100) | YES | - |  | 原始项目编码 | 逻辑外键 -> pm_project.projectCode |
| itemGroup | decimal(23,10) | YES | - |  | item分组 | item分组 |
| itemCode | varchar(100) | YES | - |  | item编码 | ERP系统产品编码 |
| parentCode | varchar(1000) | YES | - |  | parent编码 | parent编码 |
| quantity | decimal(23,10) | YES | - |  | 数量 | 数量 |
| bomPaths | varchar(1000) | YES | - |  | bomPaths | bomPaths |
| itemModel | varchar(100) | YES | - |  | item型号 | 忽略的物料型号 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 自增主键 |
...
| createBy | varchar(25) | NO |  |  | 创建用户 | 记录创建用户编码 |
| createTime | datetime | NO | CURRENT_TIMESTAMP |  | 创建时间 | 记录创建时间（指定服务经理时间） |
| updateBy | varchar(25) | YES |  |  | 最新更新用户 | 最后修改人 |
...
| jobNum | int(11) | YES | - |  | 岗位数量 | 岗位数量 |
| isCore | bit(1) | YES | b'0' |  | 标识 | 标识 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI | 主键ID | 自增主键 |
| title | varchar(255) | YES | - |  | 字段标题 | 字段标题 |
| account | varchar(255) | YES | - |  | 组织机构账套 | 组织机构账套 |
| empID | int(11) | YES | - |  | 员工ID | 逻辑外键 -> ehr_employee.empID |
| workNo | varchar(255) | YES | - |  | 工号 | 员工工号 |
| name | varchar(255) | YES | - |  | 组织机构全名 | 付款申请人/服务商姓名 |
| isDisabled | int(11) | YES | - |  | 失效状态 | 公司是否已失效，0=正常，1=失效 |
...
| create_time | datetime | NO | CURRENT_TIMESTAMP |  | 创建时间 | 创建时间 |
| update_by | varchar(25) | YES |  |  | 更新人 | 更新人 |
| update_time | datetime | YES | - |  | 更新时间 | 更新时间 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键 | 主键ID |
...
| target | varchar(15) | YES | - |  | 目标 | 目标 |
| remark | varchar(255) | YES |  |  | 备注说明 | 备注说明 |
| create_by | varchar(25) | YES |  |  | 创建用户 | 创建用户 |
| crate_time | datetime | YES | - |  | crate时间 | crate时间 |
| update_by | varchar(25) | YES |  |  | 更新人 | 更新人 |
| update_time | datetime | YES | - |  | 更新时间 | 更新时间 |
...
| effectiveFrom | datetime | NO | CURRENT_TIMESTAMP |  | 有效开始时间 | 数据有效性开始时间（软删除模式） |
| effectiveTo | datetime | YES | - |  | 有效结束时间 | 数据有效性结束时间，NULL=当前有效 |
| createBy | varchar(25) | NO |  |  | 创建用户 | 记录创建用户编码 |
| createTime | datetime | NO | CURRENT_TIMESTAMP |  | 创建时间 | 记录创建时间（指定服务经理时间） |
| updateBy | varchar(25) | YES |  |  | 最新更新用户 | 记录最新更新用户编码 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(16) | NO | - | PRI, auto_increment | 主键ID | 自增主键 |
...
| createTime | datetime | YES | CURRENT_TIMESTAMP |  | 创建时间 | 记录创建时间（指定服务经理时间） |
| updateTime | datetime | YES | CURRENT_TIMESTAMP |  | 最新更新时间 | 记录最后更新时间，自动更新（on update CURRENT_TIMESTAMP） |
...
| createTime | datetime | YES | CURRENT_TIMESTAMP |  | 创建时间 | 记录创建时间（指定服务经理时间） |
| createBy | varchar(15) | YES | - |  | 创建用户 | 记录创建用户编码 |
| downloadKey | varchar(255) | YES | - |  | downloadKey | downloadKey |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 邮件记录唯一标识 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 模板唯一标识 |
| templateCode | varchar(64) | YES | - | UNI | 模板业务编码，唯一标识 | 模板业务编码，唯一标识 |
...
| updateBy | varchar(45) | YES | - |  | 最新更新用户 | 记录最新更新用户编码 |
| updateTime | datetime | YES | - |  | 最新更新时间 | 记录最后更新时间，自动更新（on update CURRENT_TIMESTAMP） |
| effectiveFrom | datetime | NO | CURRENT_TIMESTAMP |  | 有效开始时间 | 模板有效期起始 |
| effectiveTo | datetime | YES | - |  | 有效结束时间 | 模板有效期截止 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(32) unsigned | NO | - | PRI, auto_increment | 主键ID | 日志唯一标识 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | MUL, auto_increment | 主键ID | 自增主键 |
...
| id | int(11) | NO | - | PRI, AUTO_INCREMENT | 主键ID | 主键ID |
| menuCode | varchar(50) | YES | - |  | 菜单编码 | 逻辑外键 -> fnd_menus.menuCode |
| menuName | varchar(50) | YES | - |  | 菜单名称 | 菜单名称 |
| menuLevel | int(11) | YES | - |  | 菜单级别 | 菜单级别 |
| superId | int(11) | YES | - |  | 父菜单ID | 父菜单ID |
| effectiveFrom | datetime | YES | - |  | 有效开始时间 | 数据有效性开始时间（软删除模式） |
| effectiveTo | datetime | YES | - |  | 有效结束时间 | 数据有效性结束时间，NULL=当前有效 |
| createBy | varchar(25) | YES | - |  | 创建用户 | 记录创建用户编码 |
...
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, AUTO_INCREMENT | 主键ID | 主键ID |
| username | varchar(10) | YES | - |  | 关联用户账号 | 逻辑外键 -> fnd_user_info.username |
| permissionKey | varchar(50) | YES | - |  | 权限键 | 权限键 |
| permissionValue | int(1) | YES | - |  | 权限值 | 权限值 |
| menuName | varchar(50) | YES | - |  | 菜单名称 | 菜单名称 |
| menuLevel | int(1) | YES | - |  | 菜单级别 | 菜单级别 |
| effectiveFrom | datetime | YES | - |  | 有效开始时间 | 数据有效性开始时间（软删除模式） |
| effectiveTo | datetime | YES | - |  | 有效结束时间 | 数据有效性结束时间，NULL=当前有效 |
...
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 主键ID |
| orderNumber | varchar(25) | YES | - | MUL | 订单号 | ERP订单号 |
| contractNo | varchar(50) | YES | - | MUL | 合同编号 | 合同编号，逻辑外键 -> pm_project_product_line.contractNo |
| orderExecNumber | varchar(50) | YES | - | MUL | 订单执行编号 | ERP订单执行行号 |
| orderCreateTime | datetime | YES | - |  | 订单创建时间 | 订单创建时间 |
| customerRequireTime | datetime | YES | - |  | 客户要货时间 | 客户要货时间 |
| customerCode | varchar(55) | YES | - |  | 客户编码 | 客户编码 |
| customerName | varchar(255) | YES | - |  | 客户名称 | 客户名称 |
| projectName | varchar(255) | YES | - |  | 项目名称 | 项目名称 |
| orderComment | varchar(2048) | YES | - |  | 订单备注 | 订单备注 |
| orderType | int(11) | YES | 0 | MUL | 订单类型 | 0=销售订单，1=退货订单(RMA) |
| compCode | varchar(25) | YES | 0 |  | 公司编码 | 公司编码 |
| salesType | varchar(25) | YES | 01 |  | 销售类型 | 销售类型,01:正常合同，02:借转销，14:销售类借货 |
| source | varchar(25) | YES | SAP |  | 数据来源 | 数据来源，默认:SAP,D365,总代借货:SMS |
| customInfo | json | YES | - |  | 自定义字段 | 自定义字段 |
| syncTime | datetime | YES | CURRENT_TIMESTAMP |  | 同步时间 | 缓存数据最后同步刷新时间 |
...
| customerName | varchar(255) | YES | - |  | 客户名称 | 客户名称 |
| projectName | varchar(255) | YES | - |  | 项目名称 | 项目名称 |
| orderComment | varchar(255) | YES | - |  | 订单备注 | 订单备注 |
| orderType | int(11) | YES | 0 |  | 订单类型 | 0 正常销售 1 退货 |
| compCode | varchar(25) | YES | 0 |  | 公司编码 | 公司编码 |
| salesType | varchar(25) | YES | 01 |  | 销售类型 | 销售类型,01:正常合同，02:借转销，14:销售类借货 |
...
| orderType | int(11) | YES | 0 |  | 订单类型 | 0 正常销售 1 退货 |
| compCode | varchar(25) | YES | 0 |  | 公司编码 | 公司编码 |
| salesType | varchar(25) | YES | 01 |  | 销售类型 | 数据来源 |
| customInfo | json | YES | - |  | 自定义字段 | 自定义字段 |
| syncTime | datetime | YES | CURRENT_TIMESTAMP |  | 同步时间 | 缓存数据最后同步刷新时间 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 表主键 |
| orderNumber | varchar(25) | YES | - | MUL | 订单号 | ERP订单号 |
| contractNo | varchar(50) | YES | - | MUL | 合同编号 | 合同编号，逻辑外键 -> pm_project_product_line.contractNo |
| orderExecNumber | varchar(50) | YES | - | MUL | 订单执行编号 | ERP订单执行行号 |
| orderExecNumberShort | varchar(50) | YES | - |  | 忽略版本执行单号 | 去除分隔符的执行号 |
| orderCreateTime | datetime | YES | - |  | 订单创建时间 | 订单创建时间 |
| customerRequireTime | datetime | YES | - |  | 客户要货时间 | 客户要货时间 |
| customerCode | varchar(55) | YES | - |  | 客户编码 | 客户编码 |
| customerName | varchar(255) | YES | - |  | 客户名称 | 客户名称 |
| projectName | varchar(255) | YES | - |  | 由商务输入 | 项目的业务名称 |
| orderComment | varchar(2048) | YES | - |  | 订单备注 | 订单备注 |
| orderType | int(11) | YES | 0 | MUL | 订单类型 | 0=销售，1=退货 |
| compCode | varchar(25) | YES | 0 |  | 公司编码 | 公司编码 |
| salesType | varchar(25) | YES | 01 |  | 销售类型 | 销售类型,01:正常合同，02:借转销，14:销售类借货 |
| source | varchar(25) | YES | SAP |  | 数据来源 | 数据来源，默认:SAP,D365,总代借货:SMS |
| customInfo | json | YES | - |  | 自定义字段 | 自定义字段 |
...
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 主键ID |
| orderNumber | varchar(25) | YES | - | MUL | 订单号 | ERP订单号 |
| lineNum | varchar(25) | YES | - |  | 行号 | 行号 |
| itemCode | varchar(25) | YES | - | MUL | item编码 | ERP系统产品编码 |
| itemDesc | varchar(255) | YES | - |  | 产品描述 | 产品描述 |
| orderQuantity | int(11) | YES | - |  | 产品订单数量 | 已下单产品数量 |
| openQuantity | int(11) | YES | - |  | 未发货数量 | 未发货产品数量 |
| bundleCode | varchar(25) | YES | - |  | bundle编码 | bundle编码 |
| warrantyMonth | int(11) | YES | - |  | 维保月数 | 维保月数 |
| lineType | int(11) | YES | 0 |  | 行类型 | 行类型，orderLine:订单行，leaseLine:租赁行 |
| compCode | varchar(25) | YES | 0 |  | 公司编码 | 公司编码 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(10) | NO | - | PRI, AUTO_INCREMENT | 主键 | 主键ID |
...
| effectiveFrom | datetime | YES | - |  | 有效开始时间 | 数据有效性开始时间（软删除模式） |
| effectiveTo | datetime | YES | - |  | 有效结束时间 | 数据有效性结束时间，NULL=当前有效 |
| dataSource | varchar(25) | YES | SMS |  | 数据来源 | 数据来源系统标识 |
...
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 主键ID |
| salesmanCode | varchar(45) | YES | - | MUL | salesman编码 | salesman编码 |
| salesmanTel | varchar(45) | YES | - |  | salesmanTel | salesmanTel |
| salesmanName | varchar(45) | YES | - |  | salesman名称 | salesman名称 |
| salesmanMail | varchar(100) | YES | - |  | salesmanMail | salesmanMail |
...
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 主键ID |
| lendInfoId | varchar(64) | NO | - |  | 借货申请主键 | 借货申请数据来源主键，标识存在则不再刷新过来 |
| productfirstName | varchar(255) | YES | - |  | 产品一级分类 | 产品一级分类名称 |
| productName | varchar(128) | YES | - |  | 产品名称 | 产品名称 |
| productsubCode | varchar(765) | YES | - |  | 产品编码 | 产品编码 |
| productSubModel | varchar(765) | YES | - |  | 产品型号 | 产品型号 |
| productSubName | varchar(765) | YES | - |  | 产品名称 | 产品名称 |
| lendNum | int(11) | YES | - |  | 借货数量 | 借货数量 |
| memo | text | YES | - |  | 此次付款说明 | 此次付款说明 |
| dataSource | varchar(25) | YES | SMS |  | 数据来源 | 数据来源系统标识 |
| productfirstCode | varchar(64) | YES | - |  | 产品一级编码 | 产品一级编码 |
| productCode | varchar(64) | YES | - |  | 产品大类 | 产品大类 |
...
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 主键ID |
| orderNumber | varchar(11) | YES | - | MUL | 订单号 | ERP订单号 |
| lineId | int(11) | YES | - |  | lineID | lineID |
| itemCode | varchar(10) | YES | - |  | item编码 | ERP系统产品编码 |
| ppliCode | varchar(25) | YES | - | MUL | 借货执行单号 | SAP销售订单参考号 |
| contract | varchar(25) | YES | - | MUL | 合同号 | 销售合同编号 |
...
| productfirstName | varchar(255) | YES | - |  | 产品一级分类 | 产品一级分类名称 |
| productName | varchar(128) | YES | - |  | 产品名称 | 产品名称 |
| projectCode | varchar(255) | NO | - | MUL | 原始项目编码 | 逻辑外键 -> pm_project.projectCode |
| productSubCode | varchar(255) | NO | - |  | 产品编码 | 产品编码 |
| productSubModel | varchar(255) | YES | - |  | 产品型号 | 产品型号 |
| productSubName | varchar(255) | YES | - |  | 产品名称 | 产品名称 |
| num | int(11) | NO | - |  | 订单数量 | 产品数量 |
| borrowNum | int(11) | YES | - |  | borrowNum | borrowNum |
| contract | varchar(255) | YES | - |  | 合同号 | 销售合同编号 |
| memo | text | YES | - |  | 此次付款说明 | 此次付款说明 |
| dataSource | varchar(25) | YES | SMS |  | 数据来源 | 数据来源系统标识 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | 0 |  | 主键ID | 主键ID |
| orderNumber | varchar(11) | YES | - | MUL | 订单号 | ERP订单号 |
| ppliCode | varchar(25) | YES | - | MUL | 借货执行单号 | 借货执行单号 |
| orderType | varchar(10) | YES | - |  | 订单类型 | 0=销售订单，1=退货订单(RMA) |
| contract | varchar(25) | YES | - | MUL | 合同号 | 销售合同编号 |
| customer | varchar(255) | YES | - |  | 客户 | 客户 |
| projectName | varchar(255) | YES | - |  | 由商务输入 | 项目的业务名称 |
| businessunit | varchar(50) | YES | - |  | 业务单元 | 业务单元 |
| office | varchar(20) | YES | - |  | 所在区域办事处 | 所在区域办事处 |
| dutyperson | varchar(10) | YES | - |  | 负责人 | 负责人 |
| itemcode | varchar(10) | YES | - |  | 产品编码 | 产品编码 |
| description | varchar(255) | YES | - |  | 产品描述 | 操作描述信息 |
| productfirstName | varchar(255) | YES | - |  | 产品一级分类 | 产品一级分类名称 |
| productName | varchar(255) | YES | - |  | 产品名称 | 产品名称 |
| orderQty | int(11) | YES | - |  | 订单数量 | 订单数量 |
| dlvQty | int(11) | YES | - |  | 已发货数量 | 已发货数量 |
| rmaQty | int(11) | YES | - |  | RMA退货数量 | RMA退货数量 |
| lineStatus | varchar(5) | YES | - |  | line状态 | line状态 |
| createDate | date | YES | - |  | 创建日期 | 订单创建日期 |
| lineId | int(11) | YES | - |  | lineID | lineID |
| systemId | int(11) | YES | - |  | 系统部ID | 系统部ID |
| canceled | char(1) | YES | - |  | 是否取消 | 是否取消，Y=已取消，N=未取消 |
...
| itemDesc | varchar(500) | YES | - |  | 产品描述 | 产品描述 |
| remark | text | YES | - |  | 备注 | 备注 |
| status | int(11) | YES | - |  | 有效性 | 有效性（1-有效，0-失效），默认有效|
| BU | varchar(100) | YES | - |  | 业务单元 | 业务单元 |
| productLine | varchar(100) | YES | - |  | 产品线 | 产品线编码 |
| orgId | int(11) | NO | - |  | 所属公司 | 组织ID |
| createTime | datetime | YES | - |  | 创建时间 | 记录创建时间（指定服务经理时间） |
| updateTime | datetime | YES | - |  | 最新更新时间 | 记录最后更新时间，自动更新（on update CURRENT_TIMESTAMP） |
| statecode | int(11) | NO | - |  | state编码 | state编码 |
| statuscode | int(11) | YES | - |  | status编码 | status编码 |
| productStage | int(11) | YES | - |  | productStage | productStage |
...
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 主键ID |
| orderExecNumber | varchar(25) | YES | - | MUL | 订单执行编号 | ERP订单执行行号 |
| projectCode | varchar(25) | YES | - | MUL | 原始项目编码 | 逻辑外键 -> pm_project.projectCode |
| projectName | varchar(255) | YES | - |  | 由商务输入 | 项目的业务名称 |
| salesManCode | varchar(10) | YES | - |  | 人员编码,外部人员为空 | 人员编码,外部人员为空 |
| salesManName | varchar(10) | YES | - |  | 销售人员姓名 | 销售人员姓名 |
| marketCode | varchar(64) | YES | - |  | 市场部编码 | 市场部编码 |
| marketName | varchar(255) | YES | - |  | 市场部名称 | 市场部名称 |
| systemId | varchar(64) | YES | - |  | 系统部ID | 系统部ID |
| systemName | varchar(255) | YES | - |  | 系统部名称 | 系统部名称 |
| expendId | varchar(64) | YES | - |  | 拓展部ID | 拓展部ID |
| expendName | varchar(255) | YES | - |  | 拓展部名称 | 拓展部名称 |
| industryId | varchar(64) | YES | - |  | 行业ID | 行业ID |
| industryName | varchar(255) | YES | - |  | 客户所属行业 | 客户所属行业名称 |
| officeCode | varchar(15) | YES | - |  | 办事处或部门编码 | 办事处编码，逻辑外键 -> fnd_department.departmentNum |
| officeName | varchar(15) | YES | - |  | 办事处名称 | 办事处名称（冗余自fnd_department） |
| serviceTypeName | varchar(10) | YES | - |  | 服务类型名称 | 服务类型 |
...
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | 0 |  | 主键ID | 主键ID |
| orderExecNumber | varchar(60) | YES | - |  | 订单执行编号 | ERP订单执行行号 |
| projectCode | varchar(255) | NO | - |  | 原始项目编码 | 逻辑外键 -> pm_project.projectCode |
| projectName | varchar(765) | YES | - |  | 由商务输入 | 项目的业务名称 |
| marketCode | varchar(64) | YES | - |  | 市场部编码 | 市场部编码 |
| officeCode | varchar(765) | YES | - |  | 办事处或部门编码 | 办事处编码，逻辑外键 -> fnd_department.departmentNum |
| expendId | varchar(64) | YES | - |  | 拓展部ID | 拓展部ID |
| marketName | varchar(255) | YES | - |  | 市场部名称 | 市场部名称 |
| officeName | varchar(128) | YES | - |  | 办事处名称 | 办事处名称（冗余自fnd_department） |
| systemName | varchar(255) | YES | - |  | 系统部名称 | 系统部名称 |
| salesManCode | varchar(60) | YES | - |  | 人员编码,外部人员为空 | 人员编码,外部人员为空 |
| systemId | varchar(64) | YES | - |  | 系统部ID | 系统部ID |
| industryId | varchar(64) | YES | - |  | 行业ID | 行业ID |
| salesManName | varchar(128) | YES | - |  | 销售人员姓名 | 销售人员姓名 |
| expendName | varchar(255) | YES | - |  | 拓展部名称 | 拓展部名称 |
| industryName | varchar(255) | YES | - |  | 客户所属行业 | 客户所属行业名称 |
| serviceTypeName | varchar(128) | YES | - |  | 服务类型名称 | 服务类型 |
| channelName | varchar(765) | YES | - |  | 出货代理商名称 | 出货代理商名称 |
| engineeFee | decimal(19,2) | YES | - |  | 安全服务先行类借货有值，表示出货价 | 安全服务先行类借货有值，表示出货价 |
| objId | varchar(64) | YES | - |  | 参数1 | 参数1 |
| applyType | varchar(60) | YES | - |  | 申请类型 | 借货申请类型 |
| corporationCode | varchar(10) | YES | - |  | 公司编码 | 公司编码 |
| customerProjectName | varchar(765) | YES | - |  | 客户项目名称 | 客户侧的项目名称 |
| finalCustomerName | varchar(765) | YES | - |  | 最终客户单位 | 最终客户名称 |
| agentName | varchar(765) | YES | - |  | 代理商名称 | 代理商名称 |
| pspm | varchar(765) | YES | - |  | 产品经理 | 产品经理标识 |
| pspmName | varchar(257) | YES | - |  | pspm名称 | pspm名称 |
| salesMenTel | varchar(300) | YES | - |  | salesMenTel | salesMenTel |
| decPath | varchar(765) | YES | - |  | 决策路径 | 审批决策路径 |
| requireInDate | date | YES | - |  | requireIn日期 | requireIn日期 |
| receiveMen | varchar(450) | YES | - |  | receiveMen | receiveMen |
| reveiveContactWay | varchar(300) | YES | - |  | reveiveContactWay | reveiveContactWay |
| receiveAddress | varchar(765) | YES | - |  | receiveAddress | receiveAddress |
| lendCause | text | YES | - |  | 借货原因 | 借货原因 |
| projectType | varchar(4) | NO |  |  | 项目数据类型 | 项目数据类型，售前:20/售后:10，逻辑外键 -> fnd_basic_data(dataTypeCode=presalesType) |
| projectMoney | decimal(16,2) | YES | 0.00 |  | 出货价 | 出货价 |
...
| linkmanTel | varchar(64) | YES | - |  | 客户联系方式 | 客户联系方式 |
| customInfo | json | YES | - |  | 自定义信息 | 自定义信息 |
| dataSource | varchar(25) | YES | CRM |  | 数据来源 | 数据来源系统标识 |
...
| reveiveContactWay | varchar(300) | YES | - |  | reveiveContactWay | reveiveContactWay |
| receiveAddress | varchar(765) | YES | - |  | receiveAddress | receiveAddress |
| lendCause | text | YES | - |  | lendCause | lendCause |
| projectType | varchar(4) | NO |  |  | 项目类型，售前:20/售后:10 | 逻辑外键 -> fnd_basic_data(dataTypeCode=presalesType) |
| projectMoney | decimal(16,2) | YES | 0.00 |  | 出货价 | 出货价 |
| afProjectMoney | decimal(16,2) | YES | 0.00 |  | 安服出货价 | 安服出货价 |
| submitTime | datetime | YES | - |  | 提交时间 | 提交时间 |
| predBidDate | datetime | YES | - |  | 项目投标时间 | 项目投标时间 |
...
| productSubName | varchar(255) | YES | - |  | 产品描述 | 产品描述 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | varchar(64) | NO | 0 |  | 主键ID | 主键ID |
| projectCode | varchar(255) | NO | - |  | 原始项目编码 | 逻辑外键 -> pm_project.projectCode |
| orderExecNumber | varchar(255) | YES | - |  | 订单执行编号 | ERP订单执行行号 |
| corporationCode | varchar(50) | YES | - |  | 公司编码 | 公司编码 |
| ssfrId | varchar(64) | YES | - |  | 安全服务先行核销ID | 安全服务先行核销ID |
| productCode | varchar(255) | YES | - |  | 产品大类 | 产品大类 |
| productfirstCode | varchar(255) | YES | - |  | 产品一级编码 | 产品一级编码 |
| productName | varchar(128) | YES | - |  | 产品名称 | 产品名称 |
| productfirstName | varchar(255) | YES | - |  | 产品一级分类 | 产品一级分类名称 |
| productsubCode | varchar(255) | YES | - |  | 产品编码 | 产品编码 |
| productSubModel | varchar(255) | YES | - |  | 产品型号 | 产品型号 |
| productSubName | varchar(255) | YES | - |  | 产品名称 | 产品名称 |
| num | int(11) | YES | - |  | 订单数量 | 产品数量 |
| borrowNum | int(11) | YES | - |  | borrowNum | borrowNum |
| price | decimal(19,6) | YES | - |  | 收货单价 | 收货单价 |
| purchaseDiscount | decimal(19,6) | YES | - |  | purchaseDis数量 | purchaseDis数量 |
| purchasePrice | decimal(29,2) | YES | - |  | purchase价格 | purchase价格 |
| dataSource | varchar(25) | YES | CRM |  | 数据来源 | 数据来源系统标识 |
| lineType | varchar(25) | YES | orderLine |  | 行类型 | 行类型，orderLine:订单行，leaseLine:租赁行 |
| customInfo | json | YES | - |  | 自定义信息 | 自定义信息 |
...
| profitCenter | varchar(6) | YES | - |  | 办事处编码 | 利润中心编码 |
| dataSource | varchar(25) | YES | SMS |  | 数据来源 | 数据来源系统标识 |
...
| marketCode | varchar(64) | YES | - |  | 市场部编码 | 市场部编码 |
| marketName | varchar(255) | YES | - |  | 市场部名称 | 市场部名称 |
| systemCode | varchar(64) | YES | - |  | system编码 | system编码 |
| systemName | varchar(255) | YES | - |  | 系统部名称 | 系统部名称 |
| expendCode | varchar(64) | YES | - |  | expend编码 | expend编码 |
| expendName | varchar(255) | YES | - |  | 拓展部名称 | 拓展部名称 |
| industryCode | varchar(64) | YES | - |  | 所属行业 | 所属行业 |
| industryName | varchar(255) | YES | - |  | 客户所属行业 | 客户所属行业名称 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| smsId | bigint(11) | NO | 0 |  | smsID | smsID |
| orderCode | varchar(25) | NO | - | MUL | order编码 | order编码 |
| predBidDate | datetime | YES | - |  | 预计投标日期 | 预计投标日期 |
| projectName | varchar(255) | YES | - |  | 由商务输入 | 项目的业务名称 |
| firstChannelCode | varchar(255) | YES | - |  | firstChannel编码 | firstChannel编码 |
| firstChannelName | varchar(100) | YES | - |  | firstChannel名称 | firstChannel名称 |
| channelCode | varchar(255) | YES | - |  | channel编码 | channel编码 |
| channelName | varchar(255) | YES | - |  | 出货代理商名称 | 出货代理商名称 |
| contractNo | varchar(25) | YES | - |  | 合同编号 | 合同编号，逻辑外键 -> pm_project_product_line.contractNo |
| marketName | varchar(25) | YES | - |  | 市场部名称 | 市场部名称 |
| systemName | varchar(25) | YES | - |  | 系统部名称 | 系统部名称 |
| expendName | varchar(25) | YES | - |  | 拓展部名称 | 拓展部名称 |
| industryName | varchar(25) | YES | - |  | 客户所属行业 | 客户所属行业名称 |
| industryNewName | varchar(25) | YES | - |  | 对应的子行业 | 对应的子行业 |
| totaljine | decimal(12,2) | YES | - |  | 总金额 | 总金额 |
| salesName | varchar(25) | YES | - |  | sales名称 | sales名称 |
| officeName | varchar(25) | YES | - |  | 办事处名称 | 办事处名称（冗余自fnd_department） |
| solutionname | varchar(1000) | YES | - |  | solution名称 | solution名称 |
| projectpropertyName | varchar(20) | YES | - |  | projectproperty名称 | projectproperty名称 |
| customerProjectCode | varchar(255) | YES | - |  | 客户项目编码 | 客户项目编码 |
| customerProjectName | varchar(255) | YES | - |  | 客户项目名称 | 客户项目名称 |
| username | varchar(255) | YES | - |  | 关联用户账号 | 逻辑外键 -> fnd_user_info.username |
| realname | varchar(128) | YES | - |  | 姓名 | 姓名 |
| officeCode | varchar(255) | YES | - |  | 办事处或部门编码 | 办事处编码，逻辑外键 -> fnd_department.departmentNum |
| org_id | int(11) | YES | - | MUL | orgID | orgID |
| customInfo | json | YES | - |  | 自定义信息 | 自定义信息 |
...
| projectCode | varchar(100) | YES | - |  | 原始项目编码 | 逻辑外键 -> pm_project.projectCode |
| orderExecNumber | varchar(255) | YES |  |  | 订单执行编号 | ERP订单执行行号 |
| itemGroup | int(11) | YES | - |  | item分组 | item分组 |
| itemCode | varchar(100) | YES | - |  | item编码 | ERP系统产品编码 |
| parentCode | varchar(1000) | YES | - |  | parent编码 | parent编码 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| contract_code | varchar(25) | YES | - |  | 合同号（业务编号） | 合同号（业务编号） |
| barcode | varchar(50) | YES | - |  | 设备序列号 | 设备序列号/条码 |
| itemCode | varchar(16) | YES | - |  | item编码 | ERP系统产品编码 |
| barcode2 | varchar(50) | YES | - |  | 母子公司发货序列号对应关系 | 母子公司发货序列号对应关系 |
| itemCode2 | varchar(16) | YES | - |  | 母子公司发货物料编码对应关系 | 母子公司发货物料编码对应关系 |
| rmaState | int(1) | NO | 0 |  | rma状态 | rma状态 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | bigint(20) | NO | - | PRI, AUTO_INCREMENT | 主键ID | 自增主键 |
| contract_num | varchar(45) | YES | - | MUL | contractnum | contractnum |
| batch_code | varchar(10) | YES | - |  | batch编码 | batch编码 |
| project_name | varchar(200) | YES | - |  | 项目名称/申请原因 | 项目名称/申请原因 |
| order_num | varchar(25) | YES | - |  | ordernum | ordernum |
| client_supplier_code | varchar(20) | YES | - |  | clientsupplier编码 | clientsupplier编码 |
| client_supplier_name | varchar(200) | YES | - |  | clientsupplier名称 | clientsupplier名称 |
| contract_money_amount | decimal(20,2) | NO | - |  | contractmoney金额 | contractmoney金额 |
| delivered_money_amount | decimal(20,2) | NO | - |  | deliveredmoney金额 | deliveredmoney金额 |
| collected_money_amount | decimal(20,2) | NO | - |  | collectedmoney金额 | collectedmoney金额 |
| collected_money_ratio | double | YES | 0 |  | collectedmoneyratio | collectedmoneyratio |
| receivables_money_amount | decimal(20,2) | YES | - |  | receivablesmoney金额 | receivablesmoney金额 |
| over_due_money_amount | decimal(20,2) | YES | - |  | overduemoney金额 | overduemoney金额 |
| maketing_department_name | varchar(40) | YES | - |  | maketingdepartment名称 | maketingdepartment名称 |
| office_name | varchar(20) | YES | - |  | 办事处名称 | 办事处名称 |
| industry_name | varchar(40) | YES | - |  | industry名称 | industry名称 |
| marketing_representative_name | varchar(20) | YES | - |  | marketingrepresentative名称 | marketingrepresentative名称 |
| currency_name | varchar(25) | YES | - |  | 币种 | 币种 |
| create_by | varchar(20) | YES | - |  | 创建用户 | 创建用户 |
| create_time | datetime | YES | - |  | 创建时间 | 创建时间 |
| update_by | varchar(20) | YES | - |  | 更新人 | 更新人 |
| update_time | datetime | YES | - |  | 更新时间 | 更新时间 |
| effective_from | datetime | YES | - |  | effectivefrom | effectivefrom |
| effective_to | datetime | YES | - |  | effectiveto | effectiveto |
| import_batch_num | varchar(12) | YES | - |  | importbatchnum | importbatchnum |
| contract_create_date | datetime | YES | - |  | SAP合同创建日期 | SAP合同创建日期 |
| projectCode | varchar(80) | YES | - |  | 原始项目编码 | 逻辑外键 -> pm_project.projectCode |
| marketCode | varchar(80) | YES | - |  | 市场部编码 | 市场部编码 |
| systemId | int(11) | YES | - |  | 系统部ID | 系统部ID |
| industryId | int(11) | YES | - |  | 行业ID | 行业ID |
| officeCode | varchar(80) | YES | - |  | 办事处或部门编码 | 办事处编码，逻辑外键 -> fnd_department.departmentNum |
| expendId | int(11) | YES | - |  | 拓展部ID | 拓展部ID |
| usernamec | varchar(10) | YES | - |  | 销售用户账号 | 销售用户账号 |
| latest_ship_date | datetime | YES | - |  | 交货日期 | 交货日期 |
| usernamec2 | varchar(10) | YES | - |  | 用户名称C2 | 用户名称C2 |
| systemid_o | int(11) | YES | - |  | systemido | systemido |
| expendid_o | int(11) | YES | - |  | expendido | expendido |
| industry_name_o | varchar(40) | YES | - |  | industrynameo | industrynameo |
| dataSource | varchar(25) | YES | CRM |  | 数据来源 | 数据来源系统标识 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(1) | NO | - | PRI, AUTO_INCREMENT | 主键ID | 主键ID |
| lendInfoId | varchar(64) | NO | 0 |  | 借货申请主键 | 借货申请数据来源主键，标识存在则不再刷新过来 |
| projectCode | varchar(64) | YES | - |  | 原始项目编码 | 逻辑外键 -> pm_project.projectCode |
| projectName | varchar(765) | YES | - |  | 由商务输入 | 项目的业务名称 |
| dutyName | varchar(189) | YES | - |  | 负责人 | 借货负责人 |
| dutyContactWay | varchar(300) | YES | - |  | 联系方式 | 负责人联系方式 |
| decPath | varchar(765) | YES | - |  | 决策路径 | 审批决策路径 |
| officeCode | varchar(765) | YES | - |  | 办事处或部门编码 | 办事处编码，逻辑外键 -> fnd_department.departmentNum |
| marketName | varchar(255) | YES | - |  | 市场部名称 | 市场部名称 |
| systemName | varchar(128) | YES | - |  | 系统部名称 | 系统部名称 |
| expendName | varchar(255) | YES | - |  | 拓展部名称 | 拓展部名称 |
| industryName | varchar(128) | YES | - |  | 客户所属行业 | 客户所属行业名称 |
| pspm | varchar(257) | YES | - |  | 产品经理 | 产品经理标识 |
...
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | 0 |  | 主键ID | 主键ID |
| orderNumber | varchar(11) | YES | - |  | 订单号 | ERP订单号 |
| ppliCode | varchar(25) | YES | - |  | 借货执行单号 | 借货执行单号 |
| orderType | varchar(10) | YES | - |  | 订单类型 | 0=销售订单，1=退货订单(RMA) |
| contract | varchar(25) | YES | - |  | 合同号 | 销售合同编号 |
| customer | varchar(255) | YES | - |  | 客户 | 客户 |
| projectName | varchar(255) | YES | - |  | 由商务输入 | 项目的业务名称 |
| businessunit | varchar(50) | YES | - |  | 业务单元 | 业务单元 |
| office | varchar(10) | YES | - |  | 所在区域办事处 | 所在区域办事处 |
| dutyperson | varchar(10) | YES | - |  | 负责人 | 负责人 |
| itemcode | varchar(10) | YES | - |  | 产品编码 | 产品编码 |
| description | varchar(255) | YES | - |  | 产品描述 | 操作描述信息 |
| orderQty | int(11) | YES | - |  | 订单数量 | 订单数量 |
...
| systemId | int(11) | YES | - |  | 系统部ID | 系统部ID |
| canceled | char(1) | YES | - |  | 是否取消 | 是否取消，Y=已取消，N=未取消 |
| discountVersion | varchar(255) | YES | - |  | discountVersion | discountVersion |
| borrowNum | bigint(12) | YES | - |  | borrowNum | borrowNum |
| dataSource | varchar(25) | YES | SMS |  | 数据来源 | 数据来源系统标识 |
...
| createBy | varchar(45) | NO |  |  | 创建用户 | 记录创建用户编码 |
| createTime | timestamp | NO | CURRENT_TIMESTAMP |  | 创建时间 | 任务创建时间 |
| updateBy | varchar(45) | NO |  |  | 最新更新用户 | 记录最新更新用户编码 |
| updateTime | datetime | YES | - |  | 最新更新时间 | 记录最后更新时间，自动更新（on update CURRENT_TIMESTAMP） |
...
| effectiveFrom | datetime | YES | - |  | 有效开始时间 | 有效期起始 |
| effectiveTo | datetime | YES | - |  | 有效结束时间 | 有效期截止 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 交付模板唯一标识 |
...
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 自增主键 |
| projectType | int(11) | YES | - |  | 项目类型，售前:20/售后:10 | 逻辑外键 -> fnd_basic_data(dataTypeCode=presalesType) |
| columnCode | varchar(45) | YES | - |  | column编码 | column编码 |
| colemnName | varchar(45) | YES | - |  | colemn名称 | colemn名称 |
| columnDesc | varchar(45) | YES | - |  | column描述 | column描述 |
| createTime | datetime | YES | - |  | 创建时间 | 记录创建时间（指定服务经理时间） |
| createBy | varchar(45) | YES | - |  | 创建用户 | 记录创建用户编码 |
| effectiveFrom | datetime | YES | - |  | 有效开始时间 | 数据有效性开始时间（软删除模式） |
| effectiveTo | datetime | YES | - |  | 有效结束时间 | 数据有效性结束时间，NULL=当前有效 |
...
| field1 | varchar(255) | YES | - |  | 扩展字段1 | 扩展字段1 |
| field2 | varchar(255) | YES | - |  | 扩展字段2 | 扩展字段2 |
| field3 | varchar(255) | YES | - |  | 扩展字段3 | 扩展字段3 |
| field4 | varchar(255) | YES | - |  | 扩展字段4 | 扩展字段4 |
| field5 | varchar(255) | YES | - |  | 扩展字段5 | 扩展字段5 |
| field6 | varchar(255) | YES | - |  | 扩展字段6 | 扩展字段6 |
| field7 | varchar(255) | YES | - |  | 扩展字段7 | 扩展字段7 |
| field8 | varchar(255) | YES | - |  | 扩展字段8 | 扩展字段8 |
| field9 | varchar(255) | YES | - |  | 扩展字段9 | 扩展字段9 |
| field10 | varchar(255) | YES | - |  | 扩展字段10 | 扩展字段10 |
| disabled | bit(1) | NO | b'0' |  | 数据是否失效 | 员工是否失效，0=正常 |
| effectiveFrom | datetime | YES | - |  | 有效开始时间 | 有效期起始 |
| effectiveTo | datetime | YES | - |  | 有效结束时间 | 有效期截止 |
| createBy | varchar(25) | YES | - |  | 创建用户 | 记录创建用户编码 |
| createTime | datetime | YES | CURRENT_TIMESTAMP |  | 创建时间 | 记录创建时间（指定服务经理时间） |
...
| createBy | varchar(25) | YES |  |  | 创建用户 | 创建人 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| slipId | bigint(20) | YES | - | MUL | slipID | slipID |
| inventTransId | varchar(20) | YES | - |  | 批次号 | 批次号 |
| vendAccount | varchar(20) | YES | - |  | 供应商账号 | 供应商账号 |
| innerInvoiceId | varchar(20) | YES | - |  | innerInvoiceID | innerInvoiceID |
| invoiceDate | timestamp | YES | - |  | invoice日期 | invoice日期 |
| invoiceId | varchar(20) | YES | - |  | invoiceID | invoiceID |
| purchId | varchar(20) | YES | - | MUL | 采购订单号 | 采购订单号 |
| purchName | varchar(255) | YES | - |  | 采购事项 | 采购事项 |
| purchPoolId | varchar(10) | YES | - |  | 采购订单池 | 采购订单池 |
| packingSlipId | varchar(20) | YES | - | MUL | 采购收货单号 | 采购收货单号 |
| packingSlipRemark | varchar(255) | YES | - |  | 采购收货备注 | 采购收货备注 |
| slipQty | decimal(32,6) | YES | - |  | slipQty | slipQty |
| receiveQty | decimal(32,6) | YES | - |  | receiveQty | receiveQty |
| invoiceQty | decimal(32,6) | YES | - |  | invoiceQty | invoiceQty |
| price | decimal(32,6) | YES | - |  | 收货单价 | 收货单价 |
| invoicePrice | decimal(32,6) | YES | - |  | invoice价格 | invoice价格 |
| receiveAmount | decimal(38,6) | YES | - |  | receive金额 | receive金额 |
| invoiceAmount | decimal(38,6) | YES | - |  | invoice金额 | invoice金额 |
| settleQty | decimal(38,6) | YES | - |  | settleQty | settleQty |
| lineAmount | decimal(38,6) | YES | - |  | line金额 | line金额 |
| invoiceAmountTotal | decimal(32,6) | YES | - |  | invoiceAmountTotal | invoiceAmountTotal |
| settleAmountTotal | decimal(38,6) | YES | - |  | settleAmountTotal | settleAmountTotal |
| settleAmount | decimal(38,6) | YES | - |  | settle金额 | settle金额 |
| confirmTime | timestamp | YES | - |  | 提交时间 | 付款确认时间 |
| settleTime | timestamp | YES | - |  | settle时间 | settle时间 |
| projectProgress | varchar(64) | YES | - |  | 项目进度 | 项目进度 |
| otherSysNum | varchar(20) | YES | - |  | 外部系统编号 | 外部系统编号 |
| partition | bigint(20) | YES | - |  | 分区 | 分区 |
| dataAreaId | varchar(4) | YES | - |  | 账套 | 账套 |
| settleId | bigint(20) | YES | - |  | settleID | settleID |
...
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 自增主键 |
| templateCode | varchar(45) | YES | - |  | 模板业务编码 | 模板业务编码 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| 单据编号 | double | YES | - |  | 单据编号 | 单据编号 |
| 过帐日期 | timestamp | YES | - |  | 过帐日期 | 过帐日期 |
| 物料代码 | varchar(255) | YES | - |  | 物料代码 | 物料代码 |
| 物料/服务描述 | varchar(255) | YES | - |  | 物料/服务描述 | 物料/服务描述 |
| 未核销数量 | double | YES | - |  | 未核销数量 | 未核销数量 |
| 设备序列号 | varchar(255) | YES | - |  | 设备序列号 | 设备序列号 |
| 注释 | varchar(255) | YES | - |  | 注释 | 注释 |
| 合同号 | varchar(255) | YES | - |  | 合同号 | 合同号 |
| 责任部门 | varchar(255) | YES | - |  | 责任部门 | 责任部门 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| transNum | int(50) | YES | - |  | transNum | transNum |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| LOG_NR_ | bigint(20) | NO | - | PRI, auto_increment | 日志编号（自增主键） | 日志编号（自增主键） |
| TYPE_ | varchar(64) | YES | NULL | - | 事件类型（如process-start, task-create等） | 事件类型（如process-start, task-create等） |
| PROC_DEF_ID_ | varchar(64) | YES | NULL | - | 流程定义ID，关联act_re_procdef | 流程定义ID，关联act_re_procdef |
| PROC_INST_ID_ | varchar(64) | YES | NULL | - | 流程实例ID，关联act_ru_execution | 流程实例ID，关联act_ru_execution |
| EXECUTION_ID_ | varchar(64) | YES | NULL | - | 执行实例ID，关联act_ru_execution | 执行实例ID，关联act_ru_execution |
| TASK_ID_ | varchar(64) | YES | NULL | - | 任务ID，关联act_ru_task | 任务ID，关联act_ru_task |
| TIME_STAMP_ | timestamp(3) | NO | CURRENT_TIMESTAMP(3) | - | 事件时间戳 | 事件时间戳 |
| USER_ID_ | varchar(255) | YES | NULL | - | 用户ID | 用户ID |
| DATA_ | longblob | YES | NULL | - | 事件数据（二进制序列化） | 事件数据（二进制序列化） |
| LOCK_OWNER_ | varchar(255) | YES | NULL | - | 事件处理锁拥有者 | 事件处理锁拥有者 |
| LOCK_TIME_ | timestamp(3) | YES | NULL | - | 事件处理锁获取时间 | 事件处理锁获取时间 |
| IS_PROCESSED_ | tinyint(4) | YES | 0 | - | 是否已处理（0:未处理 1:已处理） | 是否已处理（0:未处理 1:已处理） |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| ID_ | varchar(64) | NO | '' | PRI | 主键ID | 主键ID |
| REV_ | int(11) | YES | NULL | - | 乐观锁版本号，用于并发控制 | 乐观锁版本号，用于并发控制 |
| NAME_ | varchar(255) | YES | NULL | - | 名称 | 名称 |
| DEPLOYMENT_ID_ | varchar(64) | YES | NULL | MUL, FK | 部署ID，关联act_re_deployment | 部署ID，关联act_re_deployment |
| BYTES_ | longblob | YES | NULL | - | 二进制数据内容 | 二进制数据内容 |
| GENERATED_ | tinyint(4) | YES | NULL | - | 是否自动生成（0:否 1:是） | 是否自动生成（0:否 1:是） |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| NAME_ | varchar(64) | NO | '' | PRI | 名称 | 名称 |
| VALUE_ | varchar(300) | YES | NULL | - | 值 | 值 |
| REV_ | int(11) | YES | NULL | - | 乐观锁版本号，用于并发控制 | 乐观锁版本号，用于并发控制 |
...
|--------|----------|------|--------|------|----------|----------|
| ID_ | varchar(64) | NO | - | PRI | 主键ID | 主键ID |
| PROC_DEF_ID_ | varchar(64) | NO | - | - | 流程定义ID，关联act_re_procdef | 流程定义ID，关联act_re_procdef |
| PROC_INST_ID_ | varchar(64) | NO | - | MUL | 流程实例ID，关联act_ru_execution | 流程实例ID，关联act_ru_execution |
| EXECUTION_ID_ | varchar(64) | NO | - | MUL | 执行实例ID，关联act_ru_execution | 执行实例ID，关联act_ru_execution |
| ACT_ID_ | varchar(255) | NO | - | - | 活动节点ID（BPMN中的节点标识） | 活动节点ID（BPMN中的节点标识） |
| TASK_ID_ | varchar(64) | YES | NULL | - | 任务ID，关联act_ru_task | 任务ID，关联act_ru_task |
| CALL_PROC_INST_ID_ | varchar(64) | YES | NULL | - | 调用子流程实例ID | 调用子流程实例ID |
| ACT_NAME_ | varchar(255) | YES | NULL | - | 活动节点名称 | 活动节点名称 |
| ACT_TYPE_ | varchar(255) | NO | - | - | 活动节点类型（如userTask, startEvent等） | 活动节点类型（如userTask, startEvent等） |
| ASSIGNEE_ | varchar(255) | YES | NULL | - | 任务受理人/办理人 | 任务受理人/办理人 |
| DURATION_ | bigint(20) | YES | NULL | - | 持续时间（毫秒） | 持续时间（毫秒） |
| TENANT_ID_ | varchar(255) | YES | '' | - | 租户ID，多租户隔离 | 租户ID，多租户隔离 |
| START_TIME_ | datetime(3) | NO | - | - | 开始时间 | 开始时间 |
| END_TIME_ | datetime(3) | YES | NULL | - | 结束时间 | 结束时间 |
...
| USER_ID_ | varchar(255) | YES | NULL | - | 用户ID | 用户ID |
| NAME_ | varchar(255) | YES | NULL | - | 名称 | 名称 |
| DESCRIPTION_ | varchar(4000) | YES | NULL | - | 描述 | 描述 |
| TYPE_ | varchar(255) | YES | NULL | - | 附件类型 | 附件类型 |
| TASK_ID_ | varchar(64) | YES | NULL | - | 任务ID，关联act_ru_task | 任务ID，关联act_ru_task |
| PROC_INST_ID_ | varchar(64) | YES | NULL | - | 流程实例ID，关联act_ru_execution | 流程实例ID，关联act_ru_execution |
| URL_ | varchar(4000) | YES | NULL | - | 附件URL地址 | 附件URL地址 |
| CONTENT_ID_ | varchar(64) | YES | NULL | - | 内容ID，关联act_ge_bytearray | 内容ID，关联act_ge_bytearray |
| TIME_ | datetime(3) | YES | NULL | - | 附件创建时间 | 附件创建时间 |
...
|--------|----------|------|--------|------|----------|----------|
| ID_ | varchar(64) | NO | - | PRI | 主键ID | 主键ID |
| TYPE_ | varchar(255) | YES | NULL | - | 评论类型（如comment, event等） | 评论类型（如comment, event等） |
| USER_ID_ | varchar(255) | YES | NULL | - | 用户ID | 用户ID |
| TASK_ID_ | varchar(64) | YES | NULL | - | 任务ID，关联act_ru_task | 任务ID，关联act_ru_task |
| PROC_INST_ID_ | varchar(64) | YES | NULL | - | 流程实例ID，关联act_ru_execution | 流程实例ID，关联act_ru_execution |
| ACTION_ | varchar(255) | YES | NULL | - | 评论动作（如AddComment, AddAttachment等） | 评论动作（如AddComment, AddAttachment等） |
| MESSAGE_ | varchar(4000) | YES | NULL | - | 评论内容 | 评论内容 |
| FULL_MSG_ | longblob | YES | NULL | - | 完整消息内容（二进制） | 完整消息内容（二进制） |
| TIME_ | datetime(3) | NO | - | - | 评论时间 | 评论时间 |
...
|--------|----------|------|--------|------|----------|----------|
| ID_ | varchar(64) | NO | - | PRI | 主键ID | 主键ID |
| TYPE_ | varchar(255) | NO | - | - | 详情类型（如VariableUpdate, FormProperty等） | 详情类型（如VariableUpdate, FormProperty等） |
| PROC_INST_ID_ | varchar(64) | YES | NULL | MUL | 流程实例ID，关联act_ru_execution | 流程实例ID，关联act_ru_execution |
| EXECUTION_ID_ | varchar(64) | YES | NULL | - | 执行实例ID，关联act_ru_execution | 执行实例ID，关联act_ru_execution |
| TASK_ID_ | varchar(64) | YES | NULL | MUL | 任务ID，关联act_ru_task | 任务ID，关联act_ru_task |
| ACT_INST_ID_ | varchar(64) | YES | NULL | MUL | 活动实例ID，关联act_hi_actinst | 活动实例ID，关联act_hi_actinst |
| NAME_ | varchar(255) | NO | - | MUL | 名称 | 名称 |
| VAR_TYPE_ | varchar(255) | YES | NULL | - | 变量类型 | 变量类型 |
| REV_ | int(11) | YES | NULL | - | 乐观锁版本号，用于并发控制 | 乐观锁版本号，用于并发控制 |
| BYTEARRAY_ID_ | varchar(64) | YES | NULL | - | 字节数组ID，关联act_ge_bytearray | 字节数组ID，关联act_ge_bytearray |
| DOUBLE_ | double | YES | NULL | - | 双精度浮点值 | 双精度浮点值 |
| LONG_ | bigint(20) | YES | NULL | - | 长整型值 | 长整型值 |
| TEXT_ | varchar(4000) | YES | NULL | - | 文本值 | 文本值 |
| TEXT2_ | varchar(4000) | YES | NULL | - | 文本值2（存储长文本的第二部分） | 文本值2（存储长文本的第二部分） |
| TIME_ | datetime(3) | NO | - | - | 变量变更时间 | 变量变更时间 |
...
|--------|----------|------|--------|------|----------|----------|
| ID_ | varchar(64) | NO | '' | PRI | 主键ID | 主键ID |
| GROUP_ID_ | varchar(255) | YES | NULL | - | 组ID | 组ID |
| TYPE_ | varchar(255) | YES | NULL | - | 参与者关系类型（如candidate, participant, assignee等） | 参与者关系类型（如candidate, participant, assignee等） |
| USER_ID_ | varchar(255) | YES | NULL | MUL | 用户ID | 用户ID |
| TASK_ID_ | varchar(64) | YES | NULL | MUL | 任务ID，关联act_ru_task | 任务ID，关联act_ru_task |
| PROC_INST_ID_ | varchar(64) | YES | NULL | MUL | 流程实例ID，关联act_ru_execution | 流程实例ID，关联act_ru_execution |
...
|--------|----------|------|--------|------|----------|----------|
| ID_ | varchar(64) | NO | - | PRI | 主键ID | 主键ID |
| PROC_INST_ID_ | varchar(64) | NO | - | UNI | 流程实例ID，关联act_ru_execution | 流程实例ID，关联act_ru_execution |
| BUSINESS_KEY_ | varchar(255) | YES | NULL | MUL | 业务主键 | 业务主键 |
| PROC_DEF_ID_ | varchar(64) | NO | - | - | 流程定义ID，关联act_re_procdef | 流程定义ID，关联act_re_procdef |
| DURATION_ | bigint(20) | YES | NULL | - | 持续时间（毫秒） | 持续时间（毫秒） |
| START_USER_ID_ | varchar(255) | YES | NULL | - | 流程发起人ID | 流程发起人ID |
| START_ACT_ID_ | varchar(255) | YES | NULL | - | 开始活动节点ID | 开始活动节点ID |
| END_ACT_ID_ | varchar(255) | YES | NULL | - | 结束活动节点ID | 结束活动节点ID |
| SUPER_PROCESS_INSTANCE_ID_ | varchar(64) | YES | NULL | - | 父流程实例ID | 父流程实例ID |
| DELETE_REASON_ | varchar(4000) | YES | NULL | - | 删除原因 | 删除原因 |
| TENANT_ID_ | varchar(255) | YES | '' | - | 租户ID，多租户隔离 | 租户ID，多租户隔离 |
| START_TIME_ | datetime(3) | NO | - | - | 开始时间 | 开始时间 |
| END_TIME_ | datetime(3) | YES | NULL | - | 结束时间 | 结束时间 |
| NAME_ | varchar(255) | YES | NULL | - | 名称 | 名称 |
...
| ID_ | varchar(64) | NO | - | PRI | 主键ID | 主键ID |
| PROC_DEF_ID_ | varchar(64) | YES | NULL | - | 流程定义ID，关联act_re_procdef | 流程定义ID，关联act_re_procdef |
| TASK_DEF_KEY_ | varchar(255) | YES | NULL | - | 任务定义Key（BPMN中的任务标识） | 任务定义Key（BPMN中的任务标识） |
| PROC_INST_ID_ | varchar(64) | YES | NULL | MUL | 流程实例ID，关联act_ru_execution | 流程实例ID，关联act_ru_execution |
| EXECUTION_ID_ | varchar(64) | YES | NULL | - | 执行实例ID，关联act_ru_execution | 执行实例ID，关联act_ru_execution |
| NAME_ | varchar(255) | YES | NULL | - | 名称 | 名称 |
| PARENT_TASK_ID_ | varchar(64) | YES | NULL | - | 父任务ID | 父任务ID |
| DESCRIPTION_ | varchar(4000) | YES | NULL | - | 描述 | 描述 |
| OWNER_ | varchar(255) | YES | NULL | - | 任务拥有者（委托前的原受理人） | 任务拥有者（委托前的原受理人） |
| ASSIGNEE_ | varchar(255) | YES | NULL | - | 任务受理人/办理人 | 任务受理人/办理人 |
| DURATION_ | bigint(20) | YES | NULL | - | 持续时间（毫秒） | 持续时间（毫秒） |
| DELETE_REASON_ | varchar(4000) | YES | NULL | - | 删除原因 | 删除原因 |
| PRIORITY_ | int(11) | YES | NULL | - | 优先级 | 优先级 |
| FORM_KEY_ | varchar(255) | YES | NULL | - | 表单Key，关联表单标识 | 表单Key，关联表单标识 |
| CATEGORY_ | varchar(255) | YES | NULL | - | 分类 | 分类 |
| TENANT_ID_ | varchar(255) | YES | '' | - | 租户ID，多租户隔离 | 租户ID，多租户隔离 |
| START_TIME_ | datetime(3) | NO | - | - | 开始时间 | 开始时间 |
| CLAIM_TIME_ | datetime(3) | YES | NULL | - | 任务签收/认领时间 | 任务签收/认领时间 |
| END_TIME_ | datetime(3) | YES | NULL | - | 结束时间 | 结束时间 |
| DUE_DATE_ | datetime(3) | YES | NULL | - | 到期日期 | 到期日期 |
...
| TASK_ID_ | varchar(64) | YES | NULL | MUL | 任务ID，关联act_ru_task | 任务ID，关联act_ru_task |
| NAME_ | varchar(255) | NO | - | MUL | 名称 | 名称 |
| VAR_TYPE_ | varchar(100) | YES | NULL | - | 变量类型 | 变量类型 |
| REV_ | int(11) | YES | NULL | - | 乐观锁版本号，用于并发控制 | 乐观锁版本号，用于并发控制 |
| BYTEARRAY_ID_ | varchar(64) | YES | NULL | - | 字节数组ID，关联act_ge_bytearray | 字节数组ID，关联act_ge_bytearray |
| DOUBLE_ | double | YES | NULL | - | 双精度浮点值 | 双精度浮点值 |
| LONG_ | bigint(20) | YES | NULL | - | 长整型值 | 长整型值 |
| TEXT_ | varchar(4000) | YES | NULL | - | 文本值 | 文本值 |
| TEXT2_ | varchar(4000) | YES | NULL | - | 文本值2（存储长文本的第二部分） | 文本值2（存储长文本的第二部分） |
| CREATE_TIME_ | datetime(3) | YES | NULL | - | 创建时间 | 创建时间 |
| LAST_UPDATED_TIME_ | datetime(3) | YES | NULL | - | 最后更新时间 | 最后更新时间 |
...
| REV_ | int(11) | YES | NULL | - | 乐观锁版本号，用于并发控制 | 乐观锁版本号，用于并发控制 |
| NAME_ | varchar(255) | YES | NULL | - | 名称 | 名称 |
| TYPE_ | varchar(255) | YES | NULL | - | 组类型（如assignment, security-role等） | 组类型（如assignment, security-role等） |
...
| ID_ | varchar(64) | NO | '' | PRI | 主键ID | 主键ID |
| REV_ | int(11) | YES | NULL | - | 乐观锁版本号，用于并发控制 | 乐观锁版本号，用于并发控制 |
| USER_ID_ | varchar(64) | YES | NULL | - | 用户ID | 用户ID |
| TYPE_ | varchar(64) | YES | NULL | - | 信息类型（如account, userinfo等） | 信息类型（如account, userinfo等） |
| KEY_ | varchar(255) | YES | NULL | - | 信息键名 | 信息键名 |
| VALUE_ | varchar(255) | YES | NULL | - | 值 | 值 |
| PASSWORD_ | longblob | YES | NULL | - | 密码 | 密码 |
| PARENT_ID_ | varchar(255) | YES | NULL | - | 父信息ID | 父信息ID |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| USER_ID_ | varchar(64) | NO | '' | PRI, FK | 用户ID | 用户ID |
| GROUP_ID_ | varchar(64) | NO | '' | PRI, FK | 组ID | 组ID |
...
| ID_ | varchar(64) | NO | '' | PRI | 主键ID | 主键ID |
| REV_ | int(11) | YES | NULL | - | 乐观锁版本号，用于并发控制 | 乐观锁版本号，用于并发控制 |
| FIRST_ | varchar(255) | YES | NULL | - | 名 | 名 |
| LAST_ | varchar(255) | YES | NULL | - | 姓 | 姓 |
| EMAIL_ | varchar(255) | YES | NULL | - | 邮箱 | 邮箱 |
| PWD_ | varchar(255) | YES | NULL | - | 用户密码 | 用户密码 |
| PICTURE_ID_ | varchar(64) | YES | NULL | - | 头像资源ID，关联act_ge_bytearray | 头像资源ID，关联act_ge_bytearray |
...
|--------|----------|------|--------|------|----------|----------|
| ID_ | varchar(64) | NO | - | PRI | 主键ID | 主键ID |
| PROC_DEF_ID_ | varchar(64) | NO | - | UNI, FK | 流程定义ID，关联act_re_procdef | 流程定义ID，关联act_re_procdef |
| REV_ | int(11) | YES | NULL | - | 乐观锁版本号，用于并发控制 | 乐观锁版本号，用于并发控制 |
| INFO_JSON_ID_ | varchar(64) | YES | NULL | MUL, FK | 信息JSON数据ID，关联act_ge_bytearray | 信息JSON数据ID，关联act_ge_bytearray |
...
| CATEGORY_ | varchar(255) | YES | NULL | - | 分类 | 分类 |
| TENANT_ID_ | varchar(255) | YES | '' | - | 租户ID，多租户隔离 | 租户ID，多租户隔离 |
| DEPLOY_TIME_ | timestamp(3) | YES | NULL | - | 部署时间 | 部署时间 |
...
| REV_ | int(11) | YES | NULL | - | 乐观锁版本号，用于并发控制 | 乐观锁版本号，用于并发控制 |
| NAME_ | varchar(255) | YES | NULL | - | 名称 | 名称 |
| KEY_ | varchar(255) | YES | NULL | - | 模型标识Key | 模型标识Key |
| CATEGORY_ | varchar(255) | YES | NULL | - | 分类 | 分类 |
| VERSION_ | int(11) | YES | NULL | - | 版本号 | 版本号 |
| META_INFO_ | varchar(4000) | YES | NULL | - | 元信息（JSON格式） | 元信息（JSON格式） |
| DEPLOYMENT_ID_ | varchar(64) | YES | NULL | MUL, FK | 部署ID，关联act_re_deployment | 部署ID，关联act_re_deployment |
| EDITOR_SOURCE_VALUE_ID_ | varchar(64) | YES | NULL | MUL, FK | 编辑器源数据ID，关联act_ge_bytearray | 编辑器源数据ID，关联act_ge_bytearray |
| EDITOR_SOURCE_EXTRA_VALUE_ID_ | varchar(64) | YES | NULL | MUL, FK | 编辑器扩展源数据ID，关联act_ge_bytearray | 编辑器扩展源数据ID，关联act_ge_bytearray |
| TENANT_ID_ | varchar(255) | YES | '' | - | 租户ID，多租户隔离 | 租户ID，多租户隔离 |
| CREATE_TIME_ | timestamp(3) | YES | NULL | - | 创建时间 | 创建时间 |
| LAST_UPDATE_TIME_ | timestamp(3) | YES | NULL | - | 最后更新时间 | 最后更新时间 |
...
| CATEGORY_ | varchar(255) | YES | NULL | - | 分类 | 分类 |
| NAME_ | varchar(255) | YES | NULL | - | 名称 | 名称 |
| KEY_ | varchar(255) | NO | - | MUL | 流程定义Key（BPMN中的process id） | 流程定义Key（BPMN中的process id） |
| VERSION_ | int(11) | NO | - | - | 版本号 | 版本号 |
| DEPLOYMENT_ID_ | varchar(64) | YES | NULL | - | 部署ID，关联act_re_deployment | 部署ID，关联act_re_deployment |
| RESOURCE_NAME_ | varchar(4000) | YES | NULL | - | 资源文件名 | 资源文件名 |
| DGRM_RESOURCE_NAME_ | varchar(4000) | YES | NULL | - | 流程图资源文件名 | 流程图资源文件名 |
| DESCRIPTION_ | varchar(4000) | YES | NULL | - | 描述 | 描述 |
| HAS_START_FORM_KEY_ | tinyint(4) | YES | NULL | - | 是否有开始表单Key（0:否 1:是） | 是否有开始表单Key（0:否 1:是） |
| SUSPENSION_STATE_ | int(11) | YES | NULL | - | 挂起状态（1:激活 2:挂起） | 挂起状态（1:激活 2:挂起） |
| TENANT_ID_ | varchar(255) | YES | '' | - | 租户ID，多租户隔离 | 租户ID，多租户隔离 |
| HAS_GRAPHICAL_NOTATION_ | tinyint(4) | YES | NULL | - | 是否有图形化标记（0:否 1:是） | 是否有图形化标记（0:否 1:是） |
...
| ID_ | varchar(64) | NO | - | PRI | 主键ID | 主键ID |
| REV_ | int(11) | YES | NULL | - | 乐观锁版本号，用于并发控制 | 乐观锁版本号，用于并发控制 |
| EVENT_TYPE_ | varchar(255) | NO | - | - | 事件类型（如message, signal等） | 事件类型（如message, signal等） |
| EVENT_NAME_ | varchar(255) | YES | NULL | - | 事件名称 | 事件名称 |
| EXECUTION_ID_ | varchar(64) | YES | NULL | MUL, FK | 执行实例ID，关联act_ru_execution | 执行实例ID，关联act_ru_execution |
| PROC_INST_ID_ | varchar(64) | YES | NULL | - | 流程实例ID，关联act_ru_execution | 流程实例ID，关联act_ru_execution |
| ACTIVITY_ID_ | varchar(64) | YES | NULL | - | 关联活动节点ID | 关联活动节点ID |
| CONFIGURATION_ | varchar(255) | YES | NULL | MUL | 配置信息 | 配置信息 |
| TENANT_ID_ | varchar(255) | YES | '' | - | 租户ID，多租户隔离 | 租户ID，多租户隔离 |
| PROC_DEF_ID_ | varchar(64) | YES | NULL | - | 流程定义ID，关联act_re_procdef | 流程定义ID，关联act_re_procdef |
| CREATED_ | timestamp(3) | NO | CURRENT_TIMESTAMP(3) | - | 订阅创建时间 | 订阅创建时间 |
...
| ID_ | varchar(64) | NO | '' | PRI | 主键ID | 主键ID |
| REV_ | int(11) | YES | NULL | - | 乐观锁版本号，用于并发控制 | 乐观锁版本号，用于并发控制 |
| PROC_INST_ID_ | varchar(64) | YES | NULL | MUL, FK | 流程实例ID，关联act_ru_execution | 流程实例ID，关联act_ru_execution |
| BUSINESS_KEY_ | varchar(255) | YES | NULL | MUL | 业务主键 | 业务主键 |
| PARENT_ID_ | varchar(64) | YES | NULL | MUL, FK | 父执行实例ID | 父执行实例ID |
| PROC_DEF_ID_ | varchar(64) | YES | NULL | MUL, FK | 流程定义ID，关联act_re_procdef | 流程定义ID，关联act_re_procdef |
| SUPER_EXEC_ | varchar(64) | YES | NULL | MUL, FK | 父流程执行实例ID | 父流程执行实例ID |
| ACT_ID_ | varchar(255) | YES | NULL | - | 当前活动节点ID | 当前活动节点ID |
| IS_ACTIVE_ | tinyint(4) | YES | NULL | - | 是否激活（0:否 1:是） | 是否激活（0:否 1:是） |
| IS_CONCURRENT_ | tinyint(4) | YES | NULL | - | 是否并发（0:否 1:是） | 是否并发（0:否 1:是） |
| IS_SCOPE_ | tinyint(4) | YES | NULL | - | 是否作用域（0:否 1:是） | 是否作用域（0:否 1:是） |
| IS_EVENT_SCOPE_ | tinyint(4) | YES | NULL | - | 是否事件作用域（0:否 1:是） | 是否事件作用域（0:否 1:是） |
| SUSPENSION_STATE_ | int(11) | YES | NULL | - | 挂起状态（1:激活 2:挂起） | 挂起状态（1:激活 2:挂起） |
| CACHED_ENT_STATE_ | int(11) | YES | NULL | - | 缓存实体状态位掩码 | 缓存实体状态位掩码 |
| TENANT_ID_ | varchar(255) | YES | '' | - | 租户ID，多租户隔离 | 租户ID，多租户隔离 |
| NAME_ | varchar(255) | YES | NULL | - | 名称 | 名称 |
| LOCK_TIME_ | timestamp(3) | YES | NULL | - | 流程实例锁定时间 | 流程实例锁定时间 |
...
| ID_ | varchar(64) | NO | '' | PRI | 主键ID | 主键ID |
| REV_ | int(11) | YES | NULL | - | 乐观锁版本号，用于并发控制 | 乐观锁版本号，用于并发控制 |
| GROUP_ID_ | varchar(255) | YES | NULL | MUL | 组ID | 组ID |
| TYPE_ | varchar(255) | YES | NULL | - | 参与者关系类型（如candidate, participant, assignee等） | 参与者关系类型（如candidate, participant, assignee等） |
| USER_ID_ | varchar(255) | YES | NULL | MUL | 用户ID | 用户ID |
| TASK_ID_ | varchar(64) | YES | NULL | MUL, FK | 任务ID，关联act_ru_task | 任务ID，关联act_ru_task |
| PROC_INST_ID_ | varchar(64) | YES | NULL | MUL, FK | 流程实例ID，关联act_ru_execution | 流程实例ID，关联act_ru_execution |
| PROC_DEF_ID_ | varchar(64) | YES | NULL | MUL, FK | 流程定义ID，关联act_re_procdef | 流程定义ID，关联act_re_procdef |
...
| ID_ | varchar(64) | NO | - | PRI | 主键ID | 主键ID |
| REV_ | int(11) | YES | NULL | - | 乐观锁版本号，用于并发控制 | 乐观锁版本号，用于并发控制 |
| TYPE_ | varchar(255) | NO | - | - | 作业类型（如timer, message等） | 作业类型（如timer, message等） |
| LOCK_OWNER_ | varchar(255) | YES | NULL | - | 锁拥有者 | 锁拥有者 |
| EXCLUSIVE_ | tinyint(1) | YES | NULL | - | 是否独占执行（0:否 1:是） | 是否独占执行（0:否 1:是） |
| EXECUTION_ID_ | varchar(64) | YES | NULL | - | 执行实例ID，关联act_ru_execution | 执行实例ID，关联act_ru_execution |
| PROCESS_INSTANCE_ID_ | varchar(64) | YES | NULL | - | 流程实例ID | 流程实例ID |
| PROC_DEF_ID_ | varchar(64) | YES | NULL | - | 流程定义ID，关联act_re_procdef | 流程定义ID，关联act_re_procdef |
| RETRIES_ | int(11) | YES | NULL | - | 重试次数 | 重试次数 |
| EXCEPTION_STACK_ID_ | varchar(64) | YES | NULL | MUL, FK | 异常堆栈ID，关联act_ge_bytearray | 异常堆栈ID，关联act_ge_bytearray |
| EXCEPTION_MSG_ | varchar(4000) | YES | NULL | - | 异常消息 | 异常消息 |
| REPEAT_ | varchar(255) | YES | NULL | - | 重复执行表达式（如定时器的cron表达式） | 重复执行表达式（如定时器的cron表达式） |
| HANDLER_TYPE_ | varchar(255) | YES | NULL | - | 处理器类型 | 处理器类型 |
| HANDLER_CFG_ | varchar(4000) | YES | NULL | - | 处理器配置 | 处理器配置 |
| TENANT_ID_ | varchar(255) | YES | '' | - | 租户ID，多租户隔离 | 租户ID，多租户隔离 |
| LOCK_EXP_TIME_ | timestamp(3) | YES | NULL | - | 锁过期时间 | 锁过期时间 |
| DUEDATE_ | timestamp(3) | YES | NULL | - | 到期执行时间 | 到期执行时间 |
...
| TASK_DEF_KEY_ | varchar(255) | YES | NULL | - | 任务定义Key（BPMN中的任务标识） | 任务定义Key（BPMN中的任务标识） |
| OWNER_ | varchar(255) | YES | NULL | - | 任务拥有者（委托前的原受理人） | 任务拥有者（委托前的原受理人） |
| ASSIGNEE_ | varchar(255) | YES | NULL | MUL | 任务受理人/办理人 | 任务受理人/办理人 |
| DELEGATION_ | varchar(64) | YES | NULL | - | 委托状态（PENDING:待委托 RESOLVED:已委托） | 委托状态（PENDING:待委托 RESOLVED:已委托） |
| PRIORITY_ | int(11) | YES | NULL | - | 优先级 | 优先级 |
| SUSPENSION_STATE_ | int(11) | YES | NULL | - | 挂起状态（1:激活 2:挂起） | 挂起状态（1:激活 2:挂起） |
| CATEGORY_ | varchar(255) | YES | NULL | - | 分类 | 分类 |
| TENANT_ID_ | varchar(255) | YES | '' | - | 租户ID，多租户隔离 | 租户ID，多租户隔离 |
...
| DUE_DATE_ | datetime(3) | YES | NULL | - | 到期日期 | 到期日期 |
| FORM_KEY_ | varchar(255) | YES | NULL | - | 表单Key，关联表单标识 | 表单Key，关联表单标识 |
| varId | varchar(64) | YES | NULL | - | 变量ID（自定义扩展字段） | 变量ID（自定义扩展字段） |
| linkId | varchar(64) | YES | '' | - | 关联ID（自定义扩展字段） | 关联ID（自定义扩展字段） |
...
| ID_ | varchar(64) | NO | - | PRI | 主键ID | 主键ID |
| REV_ | int(11) | YES | NULL | - | 乐观锁版本号，用于并发控制 | 乐观锁版本号，用于并发控制 |
| TYPE_ | varchar(255) | NO | - | - | 变量类型（如string, integer, boolean等） | 变量类型（如string, integer, boolean等） |
| NAME_ | varchar(255) | NO | - | - | 名称 | 名称 |
| EXECUTION_ID_ | varchar(64) | YES | NULL | MUL, FK | 执行实例ID，关联act_ru_execution | 执行实例ID，关联act_ru_execution |
| PROC_INST_ID_ | varchar(64) | YES | NULL | MUL, FK | 流程实例ID，关联act_ru_execution | 流程实例ID，关联act_ru_execution |
| TASK_ID_ | varchar(64) | YES | NULL | MUL | 任务ID，关联act_ru_task | 任务ID，关联act_ru_task |
| BYTEARRAY_ID_ | varchar(64) | YES | NULL | MUL, FK | 字节数组ID，关联act_ge_bytearray | 字节数组ID，关联act_ge_bytearray |
| DOUBLE_ | double | YES | NULL | - | 双精度浮点值 | 双精度浮点值 |
| LONG_ | bigint(20) | YES | NULL | - | 长整型值 | 长整型值 |
| TEXT_ | varchar(4000) | YES | NULL | - | 文本值 | 文本值 |
| TEXT2_ | varchar(4000) | YES | NULL | - | 文本值2（存储长文本的第二部分） | 文本值2（存储长文本的第二部分） |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| contract_id | varchar(64) | YES | - | MUL | 合同内部ID（Firebird系统主键） | 合同内部ID（Firebird系统主键） |
| contract_code | varchar(25) | YES | - | MUL | 合同号（业务编号） | 合同号（业务编号） |
| office_code | varchar(15) | YES | - | MUL | 办事处编码 | 办事处编码 |
| contract_type | int(11) | YES | - | MUL | 合同类型（0销售合同/11维修合同等） | 合同类型（0销售合同/11维修合同等） |
| customer_name | varchar(512) | YES | - | - | 客户名称 | 客户名称 |
| project_name | varchar(512) | YES | - | - | 项目名称/申请原因 | 项目名称 |
| warranty | varchar(2) | YES | - | - | 维保年限 | 维保年限 |
| marketCode | varchar(10) | YES | - | - | 市场部编码 | 市场编码 |
| marketName | varchar(15) | YES | - | - | 市场部名称 | 市场名称 |
| systemId | int(11) | YES | - | - | 系统部ID | 体系ID |
| systemName | varchar(15) | YES | - | - | 系统部名称 | 体系名称 |
| remark | varchar(4096) | YES | - | - | 关于资源定义的备注说明 | 备注 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| item_id | int(11) | YES | - | MUL | 测试项ID | 测试项ID |
| serial_number | varchar(100) | YES | - | - | 序列号 | 设备序列号 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| result1_id | int(11) | YES | - | MUL | 关联一级测试结果ID | 关联一级测试结果ID |
| result_desc | text | YES | - | - | 测试结果描述（含release/cpld/boot/pcb版本信息） | 测试结果描述（含release/cpld/boot/pcb版本信息） |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | YES | - | - | 主键ID | 主键ID |
| item | varchar(25) | YES | - | MUL | 物料 | 物料编码 |
| describe_ | varchar(255) | YES | - | - | 物料描述 | 物料描述 |
| itemname | varchar(255) | YES | - | MUL | 物料型号名称 | 物料型号名称 |
...
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | YES | - | - | 主键ID | 主键ID |
| item | varchar(15) | YES | - | - | 物料 | 子公司物料编码 |
| describe_ | varchar(150) | YES | - | - | 物料描述 | 物料描述 |
| itemname | varchar(255) | YES | - | - | 物料型号名称 | 物料型号名称 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | varchar(64) | YES | - | MUL | 主键ID | 主键ID |
| con_xb | varchar(25) | YES | - | MUL | 续保合同编号 | 续保合同编号 |
| barcode | varchar(50) | YES | - | MUL | 设备序列号 | 设备序列号 |
| grade | varchar(15) | YES | - | - | 维保等级编码 | 维保等级编码 |
| begin_date | datetime | YES | - | - | 服务开始日期 | 服务开始日期 |
| end_date | datetime | YES | - | - | 服务结束日期 | 服务结束日期 |
| warranty | char(1) | YES | - | - | 维保标识 | 维保标识 |
| remark | text | YES | - | - | 关于资源定义的备注说明 | 备注 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| packlist_id | varchar(64) | YES | - | MUL | 装箱单ID | 装箱单ID |
| con_id | varchar(64) | YES | - | MUL | 关联合同ID | 关联合同ID |
| packdate | datetime | YES | - | MUL | 发货日期 | 发货日期 |
| warrantyStartTime | datetime | YES | - | - | 维保开始日期 | 维保开始时间 |
| warrantyEndTime | datetime | YES | - | - | 维保结束日期 | 维保结束时间 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | bigint(20) | NO | - | PRI, auto_increment | 主键ID | 主键ID |
| pack_id | varchar(64) | YES | - | MUL | 装箱单ID | 装箱单ID |
| item | varchar(16) | YES | - | MUL | 物料 | 物料编码 |
| barcode | varchar(50) | YES | - | MUL | 设备序列号 | 设备序列号 |
| com_barcode | varchar(50) | YES | - | - | 公司内部序列号 | 公司内部序列号 |
| rma_no | varchar(64) | YES | - | - | RMA单号 | RMA单号 |
...
| updateTime | datetime | YES | - | - | 最新更新时间 | 更新时间 |
| syncTime | datetime | YES | CURRENT_TIMESTAMP | - | 同步时间 | 同步时间 |
| uuid | varchar(64) | YES | - | UNI | 唯一标识UUID | 唯一标识UUID |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| logID | bigint(20) | NO | - | PRI, auto_increment | 日志ID | 日志ID |
| tableName | varchar(128) | YES | - | - | 变更表名 | 变更表名 |
| operation | varchar(50) | YES | - | - | 操作类型（INSERT/UPDATE/DELETE） | 操作类型（INSERT/UPDATE/DELETE） |
| changedBy | varchar(128) | YES | - | - | 变更操作人 | 变更操作人 |
| changeTime | datetime | YES | - | - | 变更时间 | 变更时间 |
| dataId | varchar(128) | YES | - | MUL | 数据实例ID | 数据记录ID |
| barCode | varchar(128) | YES | - | - | 设备序列号 | 设备序列号 |
| lasted | smallint(6) | YES | - | MUL | 是否最新记录标记 | 是否最新记录标记 |
| oldValues | longtext | YES | - | - | 变更前值（JSON） | 变更前值（JSON） |
| newValues | longtext | YES | - | - | 变更后值（JSON） | 变更后值（JSON） |
| syncTime | datetime | YES | CURRENT_TIMESTAMP | - | 同步时间 | 同步时间 |
...
|--------|----------|------|--------|------|----------|----------|
| pack_id | varchar(64) | YES | - | MUL | 装箱单ID | 装箱单ID |
| packlist_no | varchar(64) | YES | - | - | 装箱单编号 | 装箱单编号 |
| barcode | varchar(50) | YES | - | MUL | 设备序列号 | 设备序列号 |
| contractNo | varchar(50) | YES | - | - | 合同编号 | 合同号 |
| orderNumber | varchar(32) | YES | - | MUL | 订单号 | SAP订单号 |
| lineNum | int(11) | YES | - | - | 行号 | 订单行号 |
| orderQty | int(11) | YES | - | - | 订单数量 | 订单数量 |
| deliveredQty | int(11) | YES | - | - | 已发货数量 | 已发货数量 |
| profitCenter | varchar(32) | YES | - | - | 利润中心 | 利润中心 |
...
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI | 主键ID | 主键ID |
| sn1 | varchar(50) | YES | - | MUL | 序列号1 | 序列号1 |
| item1 | varchar(15) | YES | - | MUL | 物料编码1 | 物料编码1 |
| sn2 | varchar(50) | YES | - | MUL | 序列号2 | 序列号2 |
| item2 | varchar(15) | YES | - | MUL | 母子公司发货物料编码对应关系 | 物料编码2 |
| contract | varchar(25) | YES | - | MUL | 合同号 | 合同号 |
| createtime | varchar(50) | YES | - | - | 创建时间 | 创建时间 |
| updatetime | varchar(50) | YES | - | - | 更新时间 | 更新时间 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| serial_number | varchar(100) | YES | - | MUL | 序列号 | 设备序列号 |
| conp | varchar(100) | YES | - | MUL | CONP软件版本 | 主程序版本（release版本） |
| cpld | varchar(100) | YES | - | MUL | CPLD版本号 | CPLD版本 |
| boot | varchar(100) | YES | - | MUL | Boot版本号 | BOOT版本 |
| pcb | varchar(100) | YES | - | MUL | PCB版本号 | PCB版本 |
...
| data_creater | varchar(10) | YES | - | - | datacreater | datacreater |
| data_creatime | datetime | YES | - | - | datacrea时间 | datacrea时间 |
| data_updater | varchar(10) | YES | - | - | dataupdater | dataupdater |
| data_updatime | datetime | YES | - | - | dataupda时间 | dataupda时间 |
| data_from | datetime | YES | - | - | datafrom | datafrom |
| data_to | datetime | YES | - | - | datato | datato |
...
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 主键ID |
| tx_id | int(11) | YES | - | UNI | 交易号(关联application_transInfo表） | 关联tx_info的tx_id |
...
| spare_code | varchar(15) | YES | - | - | 流水号 | 流水号 |
...
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 主键ID |
| ocrCode | varchar(25) | NO | - | MUL | 办事处编码 | 办事处编码 |
| ocrName | varchar(25) | NO | - | - | 办事处名称 | 办事处名称 |
| isparam | int(11) | YES | - | - | 是否参数化 | 是否参数化 |
...
| purchId | varchar(25) | YES | - | - | 采购订单号 | 采购订单号 |
| lineNum | varchar(25) | YES | - | - | 采购订单行号 | 采购订单行号（与批次号二选一，有批次号按批次号收货） |
...
| purchId | varchar(25) | YES | - | - | 采购订单号 | 采购订单号 |
| deliveryDate | date | YES | - | - | 交货日期 | 交货日期 |
| documentDate | date | YES | - | - | document日期 | document日期 |
...
| isNew | varchar(1) | YES | y | - | 数据状态(0:历史数据；1：最新数据 2:转移申请被转移状态) | 数据状态(0:历史数据；1：最新数据 2:转移申请被转移状态) |
| isChange_duty | varchar(1) | YES | n | - | 转移类型(0为转移责任人，1为不转移责任人) | 转移类型(0为转移责任人，1为不转移责任人) |
| opinion | text | YES | - | - | 意见 | 意见 |
...
| insteadState | int(11) | YES | 0 | - | instead状态 | instead状态 |
...
|--------|----------|------|--------|------|----------|----------|
| id | int(10) | NO | - | PRI, auto_increment | 主键ID | 主键ID |
| rma_id | int(10) | YES | - | MUL | rmaID | rmaID |
| old_bar_code | varchar(50) | YES | - | - | 旧设备序列号 | 旧设备序列号 |
| item_code | varchar(50) | YES | - | - | 物料编码 | 物料编码 |
| item_name | varchar(1000) | YES | - | - | 物料名称 | 物料名称 |
| project_code | varchar(50) | YES | - | - | 项目订单号(针对维保类型为项目订单) | 项目订单号(针对维保类型为项目订单) |
| project_name | varchar(50) | YES | - | - | 项目名称/申请原因 | 项目名称/申请原因 |
| problem_description | text | YES | - | - | 问题描述 | 问题描述 |
| back_state | varchar(50) | YES | - | - | 返回类型说明 | 返回类型说明 |
| start_first_time | varchar(50) | YES | - | - | 初次运行时间 | 初次运行时间 |
| problem_first_time | varchar(50) | YES | - | - | 故障发生时间 | 故障发生时间 |
| analysis_process | varchar(200) | YES | - | - | 现场分析过程(上传) | 现场分析过程(上传) |
| tain_process | varchar(200) | YES | - | - | 检测报告 | 检测报告 |
...
| back_type | varchar(50) | YES | - | - | 返回类型('1'为"开坏箱",'2'为"开局坏",'3'为“网上运行坏”,'4'为"备件发货坏",'5'为"其他") | 返回类型('1'为"开坏箱",'2'为"开局坏",'3'为“网上运行坏”,'4'为"备件发货坏",'5'为"其他") |
| tain_type | varchar(50) | YES | - | - | 维保类型(‘1’为“服务合同”,'2'为"项目订单") | 维保类型(‘1’为“服务合同”,'2'为"项目订单") |
| serve_type | varchar(50) | YES | - | - | 服务类型('1'为“坏件先退”,'2'为“好件先行”) | 服务类型('1'为“坏件先退”,'2'为“好件先行”) |
| spare_code | varchar(15) | YES | - | - | 流水号 | 流水号 |
...
| barCode | varchar(50) | YES | - | - | 设备序列号 | 设备序列号/条码 |
| contractNo | varchar(25) | YES | - | - | 合同编号 | 合同编号，逻辑外键 -> pm_project_product_line.contractNo |
| result | tinytext | YES | - | - | 审批结果 | 逻辑外键 -> fnd_basic_data(dataTypeCode=26) |
| path | varchar(255) | YES | - | - | 文件存储路径 | 文件存储路径 |
...
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 主键ID |
| roleId | int(11) | NO | - | - | 关联角色ID，逻辑外键 -> fnd_roles.id | 关联角色ID，逻辑外键 -> fnd_roles.id |
| roleName | varchar(10) | NO | - | - | 角色名称 | 角色名称 |
| status | int(11) | YES | - | - | 有效性 | 有效性（1-有效，0-失效），默认有效 |
| mark | text | YES | - | - | SPMS系统参数说明/备注 | SPMS系统参数说明/备注 |
...
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 主键ID |
| stCode | varchar(25) | YES | - | MUL | 状态/类型分类编码 | 状态/类型分类编码 |
| stName | varchar(25) | YES | - | - | st名称 | st名称 |
| resolveCode | varchar(10) | YES | - | MUL | 解析编码 | 解析编码 |
| resolveName | varchar(25) | YES | - | - | 解析名称 | 解析名称 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| ID | int(32) unsigned | NO | - | PRI, auto_increment | 主键ID | 主键ID |
| USER_NAME | varchar(80) | NO |  | MUL | USENAME | USENAME |
| IP | char(20) | NO | 0 | - | IP地址 | IP地址 |
| ACTION | varchar(1024) | NO |  | - | 操作 | 操作 |
| RESULT | int(32) unsigned | NO | 0 | - | 结果 | 结果 |
| INFO | varchar(20000) | NO |  | - | 信息 | 信息 |
| TIME | int(32) | NO | - | - | 时间 | 时间 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| tx_id | int(11) | NO | - | PRI, auto_increment | 调拨ID（主键） | 调拨ID（主键） |
| sheetID | varchar(10) | YES | - | MUL | 单据代码 | 单据代码 |
...
| turnovertimes | int(11) | YES | - | - | 翻转次数 | 翻转次数 |
| allottimes | int(11) | YES | - | - | 分配次数 | 分配次数 |
| instead_time | datetime | YES | - | - | instead时间 | instead时间 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(8) | NO | - | PRI, auto_increment | 主键ID | 主键ID |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| realname | varchar(255) | YES | - | - | 姓名 | 姓名 |
| teamRole | varchar(255) | YES | - | - | 团队角色 | 团队角色 |
| mail | varchar(255) | YES | - | - | 邮箱 | 邮箱 |
| tel | varchar(255) | YES | - | - | 联系电话 | 公司联系电话 |
| department | varchar(255) | YES | - | - | 部门 | 部门 |
| province | varchar(255) | YES | - | - | 省份/直辖市 | 省份/直辖市 |
| addr | varchar(255) | YES | - | - | 地址/where | 地址/where |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| whs_id | int(11) | NO | - | PRI, auto_increment | whsID | whsID |
...
| department | varchar(25) | YES | - | - | 部门 | 部门 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| info_id | int(11) | NO | - | PRI, auto_increment | infoID | infoID |
| item_code | varchar(10) | YES | - | - | 物料编码 | 物料编码 |
| item_name | varchar(100) | YES | - | - | 物料名称 | 物料名称 |
| whs_code | varchar(10) | YES | - | - | 库房信息 | 库房信息 |
| quantity | int(11) | YES | - | - | 数量 | 数量 |
...
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | - | PRI, auto_increment | 主键ID | 主键ID |
| info_id | int(11) | YES | - | MUL | infoID | infoID |
| spare_serialNum | varchar(25) | YES | - | - | 备件序列号 | 备件序列号 |
| demand_type | varchar(25) | YES | - | - | 状态维护在sys_state_or_type | 状态维护在sys_state_or_type |
| tx_id | int(11) | YES | - | - | 交易号(关联application_transInfo表） | 交易号(关联application_transInfo表） |
...
| analyse_in_time | datetime | YES | - | - | analysein时间 | analysein时间 |
| analyse_out_time | datetime | YES | - | - | analyseout时间 | analyseout时间 |
| gaizhi_in_time | datetime | YES | - | - | gaizhiin时间 | gaizhiin时间 |
| gaizhi_out_time | datetime | YES | - | - | gaizhiout时间 | gaizhiout时间 |
| remark | text | YES | - | - | 关于资源定义的备注说明 | 备注 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| contract_code | varchar(25) | YES | - | MUL | 合同号 | 合同号 |
| marketCode | varchar(10) | YES | - | - | 市场部编码 | 市场编码 |
| marketName | varchar(15) | YES | - | - | 市场部名称 | 市场名称 |
| systemId | int(11) | YES | - | - | 系统部ID | 体系ID |
| systemName | varchar(15) | YES | - | - | 系统部名称 | 体系名称 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | NO | 0 | MUL | 主键ID | 主键ID |
| projectCode | varchar(25) | YES | - | MUL | 原始项目编码 | 项目编码 |
| orderExecNumber | varchar(25) | YES | - | - | 订单执行编号 | 订单执行单号 |
| serviceTypeName | varchar(10) | YES | - | - | 服务类型名称 | 服务类型 |
| channelName | varchar(255) | YES | - | - | 出货代理商名称 | 出货代理商名称 |
| agentName | varchar(500) | YES | - | - | 代理商名称 | 代理商名称 |
| salesManCode | varchar(10) | YES | - | - | 人员编码,外部人员为空 | 销售人员编码 |
| salesManName | varchar(10) | YES | - | - | 销售人员姓名 | 销售人员姓名 |
| corporationCode | varchar(25) | YES | 01 | - | 公司编码 | 公司编码 |
| customerProjectName | varchar(255) | YES | - | - | 客户项目名称 | 客户项目名称 |
| finalCustomerName | varchar(255) | YES | - | - | 最终客户名称 | 最终客户名称 |
...
| memberRole | varchar(2) | NO | 0 | - | 人员角色 | 10=销售人员,20=服务经理,30=项目经理 |
| memberCode | varchar(10) | YES | - | - | 人员编码 | 逻辑外键 -> fnd_user_info.username，外部人员为空 |
| memberName | varchar(10) | YES | - | - | 人员名称 | 项目成员的真实姓名 |
| phoneNum | varchar(45) | YES | - | - | 电话 | 项目成员联系电话 |
| email | varchar(100) | YES | - | - | 邮箱账号 | 项目成员邮箱地址 |
| fromFlag | int(1) | NO | 0 | - | 信息来源 | 1=来源于项目信息，2=来源于成员信息 |
| createTime | datetime | NO | - | - | 创建时间 | 记录创建时间（指定服务经理时间） |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| packlist_id | varchar(64) | YES | - | - | 装箱单ID | 装箱单ID |
| con_id | varchar(64) | YES | - | MUL | 合同ID | 合同ID |
| period | varchar(6) | YES | - | MUL | 期间 | 期间 |
...
|--------|----------|------|--------|------|----------|----------|
| pack_id | varchar(64) | YES | - | MUL | 装箱单ID | 装箱单ID |
| item | varchar(16) | YES | - | - | 物料 | 物料编码 |
| count | bigint(21) | NO | 0 | - | 数量 | 数量 |
...
| projectName | varchar(246) | YES | - | - | 由商务输入 | 项目的业务名称 |
| contractNos | text | YES | - | - | 关联的合同号 | 关联合同编号（多个逗号分隔） |
| officeName | varchar(20) | YES | - | - | 办事处名称 | 办事处名称（冗余自fnd_department） |
| ssfsName | varchar(255) | YES | - | - | 实施方式名称 | 实施方式名称 |
| rank | varchar(255) | YES | - | - | 排名 | 排名 |
| majorProjectLevel | varchar(255) | YES | - | - | 重大项目级别 | 重大项目级别 |
...
| executionStateName | varchar(255) | YES | - | - | executionState名称 | executionState名称 |
| closeProcessStateName | varchar(255) | YES | - | - | closeProcessState名称 | closeProcessState名称 |
| shipmentStateName | varchar(255) | YES | - | - | shipmentState名称 | shipmentState名称 |
| finalCustomerName | varchar(255) | YES | - | - | 最终客户名称 | 最终客户名称 |
| contractNo | varchar(25) | YES | - | MUL | 合同编号 | 合同号 |
| barCode | varchar(50) | YES | - | - | 设备序列号 | 设备序列号/条码 |
| itemCode | varchar(25) | YES | - | - | item编码 | ERP系统产品编码 |
| itemModel | varchar(255) | YES | - | - | item型号 | 忽略的物料型号 |
| itemName | varchar(255) | YES | - | - | 产品名称 | 忽略的物料名称 |
| receiveName | text | YES | - | - | 收件人 | 收件人 |
| emsNum | text | YES | - | - | 快递单号 | 快递单号 |
| packdate | datetime | YES | - | - | 发货日期 | 发货日期 |
| emsCompany | varchar(255) | YES | - | - | 快递公司名称 | 快递/物流公司名称 |
| installAddress | binary(0) | YES | - | - | 设备安装地址 | 设备安装地址 |
| chProjectId | binary(0) | YES | - | - | 串货转移之前的projectId | 串货转移前所属项目ID |
| chContractNo | binary(0) | YES | - | - | 串货转移之前的contractNo | 串货转移前合同编号 |
| transferProjectId | binary(0) | YES | - | - | 串货转移之后的projectId | 串货转移后目标项目ID |
| transferContractNo | binary(0) | YES | - | - | 串货转移之后的projectId | 串货转移后合同编号 |
| transferFlag | int(2) | NO | 0 | - | 转移标识 | -1=默认，1=转出，0=转入 |
| barCode2 | varchar(50) | YES | - | - | 母子公司发货序列号 | 母子公司发货序列号对应关系 |
| itemCode2 | varchar(25) | YES | - | - | 母子公司发货物料编码 | 母子公司发货物料编码对应关系 |
| itemModel2 | varchar(255) | YES | - | - | 产品型号2 | 产品型号2 |
| itemName2 | varchar(255) | YES | - | - | 产品名称2 | 产品名称2 |
| profitCenter | varchar(32) | YES | - | - | 利润中心 | 利润中心 |
...
| projectName | varchar(246) | YES | - | - | 由商务输入 | 项目的业务名称 |
| majorProjectLevel | varchar(255) | YES | - | - | 重大项目级别 | 重大项目级别 |
| projectStateName | varchar(255) | YES | - | - | 项目状态名称 | 项目状态名称 |
...
| teamMemberCodes | text | YES | - | - | 团队成员编码 | 团队成员编码 |
| teamMemberNames | text | YES | - | - | 团队成员名称 | 团队成员名称 |
| shipmentStateName | varchar(255) | YES | - | - | shipmentState名称 | shipmentState名称 |
| shipmentState | varchar(11) | YES | - | - | 项目发货状态 -1 已发货 1 未发货 2部分发货 | 项目发货状态 -1 已发货 1 未发货 2部分发货 |
| planStateName | varchar(255) | YES | - | - | planState名称 | planState名称 |
...
| projectStartTime | datetime | YES | - | - | 项目开始实施时间 | 项目开始实施时间 |
| projectCreateTime | datetime | YES | - | - | 创建时间 | 记录数据创建时间 |
| projectRefreshTime | datetime | YES | - | - | 项目相关数据最后编辑时间 | 项目相关数据最后编辑时间 |
| projectCloseTime | datetime | YES | - | - | 项目闭环时间点 | 项目闭环时间点 |
| ssfs | varchar(11) | YES | - | - | 实施方式 | 实施方式 |
| ssfsName | varchar(255) | YES | - | - | 实施方式名称 | 实施方式名称 |
| partnerChannel | varchar(91) | YES | - | - | 合作伙伴渠道名称 | 合作伙伴渠道名称 |
| serviceChannel | varchar(45) | YES | - | - | serviceChannel | serviceChannel |
| agentChannel | varchar(45) | YES | - | - | 下单代理商 | 下单代理商名称 |
| warrantyStatus | binary(0) | YES | - | - | 维保状态 | 项目维保状态 |
| warrantyStatusName | binary(0) | YES | - | - | 维保状态名称 | 维保状态中文名称 |
| 维保等级 | binary(0) | YES | - | - | 维保等级 | 维保等级 |
| 维保等级Name | binary(0) | YES | - | - | warranty等级名称 | warranty等级名称 |
| wafService | binary(0) | YES | - | - | wafService | wafService |
| wafServiceName | binary(0) | YES | - | - | wafService名称 | wafService名称 |
| finalCustomerName | varchar(255) | YES | - | - | 最终客户名称 | 最终客户名称 |
| salesType | varchar(25) | YES | - | - | 销售类型 | 销售类型 |
| compName | varchar(64) | YES | - | - | 组织机构简写 | 组织机构简写 |
| smsProjectCode | varchar(45) | YES | - | - | 原SMS项目编码 | 原SMS项目编码 |
| contractNo | varchar(45) | YES | - | MUL | 合同号 | 合同号 |
| sourceContractNo | varchar(45) | YES | - | MUL | 来源合同号 | 来源合同号 |
...
| projectCode | varchar(45) | NO | - | - | 项目名称 | 项目名称 |
| rank | varchar(255) | YES | - | - | 排名 | 排名 |
| projectName | varchar(246) | YES | - | - | 由商务输入 | 项目名称 |
| majorProjectLevel | varchar(255) | YES | - | - | 重大项目级别 | 重大项目级别 |
| projectStateName | varchar(255) | YES | - | - | 项目状态名称 | 项目状态名称 |
| projectState | varchar(11) | YES | - | - | 对应项目阶段中的不同状态 ，默认1为初始创建状态，0为不予跟踪状态 | 对应项目阶段中的不同状态 ，默认1为初始创建状态，0为不予跟踪状态 |
| contractNos | text | YES | - | - | 关联的合同号 | 关联合同编号（多个逗号分隔） |
...
| warrantyStatusName | binary(0) | YES | - | - | 维保状态名称 | 维保状态中文名称 |
| 维保等级 | binary(0) | YES | - | - | 维保等级 | 维保等级 |
| 维保等级Name | binary(0) | YES | - | - | 维保等级名称 | 维保等级名称 |
| wafService | binary(0) | YES | - | - | wafService | wafService |
| wafServiceName | binary(0) | YES | - | - | wafService名称 | wafService名称 |
| finalCustomerName | varchar(255) | YES | - | - | 最终客户名称 | 最终客户名称 |
| salesType | varchar(25) | YES | - | - | 销售类型 | 销售类型 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| projectId | int(11) | NO | 0 | - | 项目头信息主键,跟项目其他具体信息关联 | 逻辑外键 -> pm_project.projectId 或 pm_presales_project_header.presalesId |
| 项目名称 | varchar(246) | YES | - | - | 项目名称 | 项目名称 |
| 合同号 | mediumtext | YES | - | - | 合同号 | 合同号 |
| 办事处 | varchar(20) | YES | - | - | 办事处 | 办事处 |
| 实施方式 | varchar(255) | YES | - | - | 实施方式 | 实施方式 |
| 项目类型 | varchar(255) | YES | - | - | 项目类型 | 项目类型 |
| 重大项目级别 | varchar(255) | YES | - | - | 重大项目级别 | 重大项目级别 |
| 销售代表 | varchar(45) | YES | - | - | 销售代表 | 销售代表 |
| 服务经理 | varchar(45) | YES | - | - | 服务经理 | 服务经理 |
| 项目开始时间 | datetime | YES | - | - | 项目开始时间 | 项目开始时间 |
| 实施状态 | varchar(255) | YES | - | - | 实施状态 | 实施状态 |
| 流程状态 | varchar(255) | YES | - | - | 流程状态 | 流程状态 |
| 发货状态 | varchar(255) | YES | - | - | 发货状态 | 发货状态 |
| 最终客户单位 | varchar(255) | YES | - | - | 最终客户单位 | 最终客户单位 |
| 发货合同号 | varchar(50) | YES | - | MUL | 发货合同号 | 发货合同号 |
| 序列号 | varchar(50) | YES | - | - | 设备序列号 | 设备序列号 |
| 产品编码 | varchar(25) | YES | - | - | 产品编码 | 产品编码 |
| 产品型号 | varchar(255) | YES | - | - | 产品型号 | 产品型号 |
| 产品名称 | varchar(255) | YES | - | - | 产品名称 | 产品名称 |
| 收件人 | mediumtext | YES | - | - | 收件人 | 收件人 |
| 快递单号 | mediumtext | YES | - | - | 快递单号 | 快递单号 |
| 发货时间 | datetime | YES | - | - | 发货时间 | 发货时间 |
| 快递公司 | varchar(255) | YES | - | - | 快递公司 | 快递公司 |
| 安装地址 | mediumtext | YES | - | - | 安装地址 | 安装地址 |
| 序列号2 | varchar(50) | YES | - | - | 序列号2 | 序列号2 |
| 产品编码2 | varchar(25) | YES | - | - | 产品编码2 | 产品编码2 |
| 产品型号2 | varchar(255) | YES | - | - | 产品型号2 | 产品型号2 |
| 产品名称2 | varchar(255) | YES | - | - | 产品名称2 | 产品名称2 |
...
| emsNum | text | YES | - | - | 快递单号 | 快递单号 |
| packdate | datetime | YES | - | - | 发货日期 | 发货日期 |
| emsCompany | mediumtext | YES | - | - | 快递公司名称 | 快递公司 |
| packId | varchar(64) | YES | - | - | 装箱单ID | 装箱单ID |
...
|--------|----------|------|--------|------|----------|----------|
| contract_code | varchar(25) | YES | - | MUL | 合同号 | 合同号 |
| itemCode | varchar(16) | YES | - | - | item编码 | 物料编码 |
| itemModel | varchar(255) | YES | - | - | item型号 | 忽略的物料型号 |
| itemName | varchar(255) | YES | - | - | 产品名称 | 忽略的物料名称 |
| barcode | varchar(50) | YES | - | - | 设备序列号 | 设备序列号 |
| comBarcode | varchar(50) | YES | - | - | 组合编码 | 组合编码 |
| packId | varchar(64) | YES | - | - | 装箱单ID | 装箱单ID |
| itemCode2 | varchar(16) | YES | - | - | 母子公司发货物料编码对应关系 | 母子公司发货物料编码对应关系 |
| itemModel2 | varchar(255) | YES | - | - | 产品型号2 | 产品型号2 |
| itemName2 | varchar(255) | YES | - | - | 产品名称2 | 产品名称2 |
...
| projectCode | varchar(45) | NO | - | - | 项目名称 | 项目名称 |
| rank | varchar(255) | YES | - | - | 排名 | 排名 |
| projectName | varchar(246) | YES | - | - | 项目名称 | 项目名称 |
| majorProjectLevel | varchar(255) | YES | - | - | 重大项目级别 | 重大项目级别 |
| projectStateName | varchar(255) | YES | - | - | 项目状态名称 | 项目状态名称 |
| projectState | varchar(11) | YES | - | - | 对应项目阶段中的不同状态 ，默认1为初始创建状态，0为不予跟踪状态 | 对应项目阶段中的不同状态 ，默认1为初始创建状态，0为不予跟踪状态 |
| contractNos | text | YES | - | - | 关联的合同号 | 关联合同编号（多个逗号分隔） |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| ocrCode | varchar(25) | - | - | - | 办事处编码 | 办事处编码 |
| ocrName | varchar(25) | - | - | - | 办事处名称 | 办事处名称 |
| isparam | int(11) | - | - | - | 是否参数化 | 是否参数化 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| itemCode | varchar(25) | - | - | - | 产品编码 | 物料编码 |
| itemName | varchar(255) | - | - | - | 产品名称 | 物料描述 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| spare_serialNum | varchar(50) | - | - | - | 备件序列号 | 备件序列号 |
| sheetID | varchar(25) | - | - | - | RMA申请流水号 | RMA申请单据代码 |
| back_type | varchar(50) | - | - | - | 返回类型 | 退回类型('1'为"开坏箱",'2'为"开局坏",'3'为“网上运行坏”,'4'为"备件发货坏",'5'为"其他") |
| item_name | varchar(255) | - | - | - | 物料名称 | 物料名称 |
| project_name | varchar(255) | - | - | - | 项目名称 | 项目名称 |
| problem_desc | text | - | - | - | 问题描述 | 故障描述 |
| conk_out_time | varchar(25) | - | - | - | 故障发生时间 | 故障时间 |
| approve_time | datetime | - | - | - | 审批时间 | 审批时间 |
...
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | - | - | - | 主键ID | 主键ID |
| orderNumber | varchar(25) | - | - | - | 订单号 | ERP订单号 |
| contractNo | varchar(50) | - | - | - | 合同编号 | 合同编号，逻辑外键 -> pm_project_product_line.contractNo |
| orderExecNumber | varchar(50) | - | - | - | 订单执行编号 | ERP订单执行行号 |
| orderCreateTime | datetime | - | - | - | 订单创建时间 | 订单创建时间 |
| customerRequireTime | datetime | - | - | - | 客户要货时间 | 客户要货时间 |
| customerCode | varchar(55) | - | - | - | 客户编码 | 客户编码 |
| customerName | varchar(255) | - | - | - | 客户名称 | 客户名称 |
| projectName | varchar(255) | - | - | - | 项目名称 | 项目名称 |
| orderComment | varchar(2048) | - | - | - | 订单备注 | 订单备注 |
| orderType | int(11) | - | - | - | 订单类型 | 0=销售订单，1=退货订单(RMA) |
| compCode | varchar(25) | - | - | - | 公司编号 | 公司业务编码，如"01"代表总部 |
| salesType | varchar(25) | - | - | - | 销售类型 | 销售类型,01:正常合同，02:借转销，14:销售类借货 |
| source | varchar(25) | - | - | - | 数据来源 | 数据来源，默认:SAP,D365,总代借货:SMS |
| customInfo | json | - | - | - | 自定义信息 | JSON扩展字段，存储serviceManagerCode/programManagerCode/programManagerCodeB等动态属性 |
| syncTime | datetime | - | - | - | 同步时间 | 缓存数据最后同步刷新时间 |
...
| contractNo | varchar(50) | - | - | - | 合同编号 | 合同编号，逻辑外键 -> pm_project_product_line.contractNo |
| orderExecNumber | varchar(50) | - | - | - | 订单执行编号 | ERP订单执行行号 |
| orderExecNumberShort | varchar(50) | - | - | - | 忽略版本执行单号 | 去除分隔符的执行号 |
| orderCreateTime | datetime | - | - | - | 订单创建时间 | 订单创建时间 |
| customerRequireTime | datetime | - | - | - | 客户要货时间 | 客户要货时间 |
| customerCode | varchar(55) | - | - | - | 客户编码 | 客户编码 |
| customerName | varchar(255) | - | - | - | 客户名称 | 客户名称 |
...
| id | int(11) | - | - | - | 主键ID | 主键ID |
| orderNumber | varchar(25) | - | - | - | 订单号 | ERP订单号 |
| lineNum | varchar(25) | - | - | - | 行号 | 行号 |
| itemCode | varchar(25) | - | - | - | item编码 | ERP系统产品编码 |
| itemDesc | varchar(255) | - | - | - | 产品描述 | 产品描述 |
| orderQuantity | int(11) | - | - | - | 产品订单数量 | 已下单产品数量 |
| openQuantity | int(11) | - | - | - | 未发货数量 | 未发货产品数量 |
| bundleCode | varchar(25) | - | - | - | bundle编码 | bundle编码 |
| warrantyMonth | int(11) | - | - | - | 维保月数 | 维保月数 |
| lineType | int(11) | - | - | - | 行类型 | 行类型，orderLine:订单行，leaseLine:租赁行 |
| compCode | varchar(25) | - | - | - | 公司编号 | 公司业务编码，如"01"代表总部 |
| profitCenter | varchar(25) | - | - | - | 利润中心编码 | 利润中心编码 |
| realOrderExecNumber | varchar(25) | - | - | - | 真实执行单号 | 真实执行单号 |
| source | varchar(25) | - | - | - | 数据来源 | 数据来源，默认:SAP,D365,总代借货:SMS |
| customInfo | json | - | - | - | 自定义信息 | JSON扩展字段，存储serviceManagerCode/programManagerCode/programManagerCodeB等动态属性 |
| syncTime | datetime | - | - | - | 同步时间 | 缓存数据最后同步刷新时间 |
...
| lineType | int(11) | - | - | - | 行类型 | 行类型，orderLine:订单行，leaseLine:租赁行 |
| compCode | varchar(25) | - | - | - | 公司编号 | 公司业务编码，如"01"代表总部 |
| profitCenter | varchar(25) | - | - | - | 办事处编码 | 利润中心编码 |
| realOrderExecNumber | varchar(25) | - | - | - | 真实执行单号 | 真实执行单号 |
| source | varchar(25) | - | - | - | 数据来源 | 数据来源，默认:SAP,D365,总代借货:SMS |
| customInfo | json | - | - | - | 自定义信息 | JSON扩展字段，存储serviceManagerCode/programManagerCode/programManagerCodeB等动态属性 |
| syncTime | datetime | - | - | - | 同步时间 | 缓存数据最后同步刷新时间 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| projectId | int(11) | - | - | - | 项目头信息主键,跟项目其他具体信息关联 | 逻辑外键 -> pm_project.projectId 或 pm_presales_project_header.presalesId |
| projectType | varchar(45) | - | - | - | 项目数据类型 | 售前:20/售后:10，逻辑外键 -> fnd_basic_data(dataTypeCode=presalesType) |
| projectCode | varchar(45) | - | - | - | 原始项目编码 | 逻辑外键 -> pm_project.projectCode |
| projectName | varchar(200) | - | - | - | 项目名称 | 项目名称 |
| projectState | varchar(11) | - | - | - | 项目状态 | 项目状态，10=待开始 20=直接闭环 30=已创建 31=待指派项目经理 32=项目经理跟踪 33=工程管理部回访 34=服务经理审核 100=项目闭环 |
| isback | varchar(11) | - | - | - | 项目回退状态 | 项目回退状态，30=创建项目，32=指定项目经理，34=填写渠道信息，40=工程管理部不予跟踪，42=项目经理选择不予跟踪 |
| column001 | varchar(255) | - | - | - | 办事处编码 | 逻辑外键 -> fnd_department.departmentNum |
| column002 | varchar(255) | - | - | - | 客户编码 | ERP系统中的客户编码 |
| column003 | varchar(255) | - | - | - | 客户名称 | ERP系统中的客户名称 |
| column004 | varchar(255) | - | - | - | 市场部 | 市场部 |
| column005 | varchar(255) | - | - | - | 系统部 | 系统部 |
| column006 | varchar(255) | - | - | - | 拓展部 | 拓展部 |
| column007 | varchar(255) | - | - | - | 子行业 | 子行业 |
| column008 | varchar(255) | - | - | - | 不予跟踪原因 | notGrantTailCause，项目不予跟踪的原因说明 |
| column009 | datetime | - | - | - | 订单创建时间 | 来自SMS系统的订单创建时间 |
| column010 | varchar(10) | - | - | - | 项目等级类型 | 逻辑外键 -> fnd_basic_data(dataTypeCode=05)，项目等级分类 |
| column011 | varchar(10) | - | - | - | 项目业务类别 | 项目类别，对应pm_project_header |
| column012 | varchar(2) | - | - | - | 实施方式 | 实施方式编码，0/1/2/3/4对应不同实施模式 |
| columno12_readonly | int(2) | - | - | - | 实施方式只读标记 | 实施方式，-1=可修改，其他值=只读（来自SMS的不可修改） |
| column013 | varchar(255) | - | - | - | 最终客户名称 | 最终客户单位名称 |
| column014 | text | - | - | - | 回退说明 | 项目回退时的说明文字 |
| customerProjectName | varchar(255) | - | - | - | 客户项目名称 | 客户侧的项目名称 |
| salesType | varchar(25) | - | - | - | 销售类型 | 销售类型,01:正常合同，02:借转销，14:销售类借货 |
| majorProjectLevel | varchar(255) | - | - | - | 重大项目级别 | 重大项目等级标识 |
| compId | int(2) | - | - | - | 公司ID | 逻辑外键 -> fnd_company.id |
| createTime | datetime | - | - | - | 创建时间 | 记录创建时间（指定服务经理时间） |
| createBy | varchar(45) | - | - | - | 创建用户 | 记录创建用户编码 |
| updateTime | datetime | - | - | - | 最新更新时间 | 记录最后更新时间，自动更新（on update CURRENT_TIMESTAMP） |
| updateBy | varchar(45) | - | - | - | 最新更新用户 | 记录最新更新用户编码 |
| effectiveFrom | datetime | - | - | - | 有效开始时间 | 数据有效性开始时间（软删除模式） |
| effectiveTo | datetime | - | - | - | 有效结束时间 | 数据有效性结束时间，NULL=当前有效 |
| disabled | bit(1) | - | - | - | 数据是否失效 | 员工是否失效，0=正常 |
| projectStartTime | datetime | - | - | - | 项目开始实施时间 | 指定项目经理的时间 |
| projectRefreshTime | datetime | - | - | - | 项目相关数据最后编辑时间 | 项目相关数据最后编辑时间 |
| projectCloseTime | datetime | - | - | - | 项目闭环时间点 | 项目闭环的时间点 |
| customInfo | json | - | - | - | 自定义信息 | JSON扩展字段，存储serviceManagerCode/programManagerCode/programManagerCodeB等动态属性 |
| customConfig | json | - | - | - | 自定义配置 | JSON配置字段 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| contractNo | varchar(45) | - | - | - | 合同编号 | 合同编号，逻辑外键 -> pm_project_product_line.contractNo |
| referenceEventName | varchar(255) | - | - | - | 参考事件名称 | 回款参考事件 |
| referenceEvent | varchar(255) | - | - | - | 参照事件 | 回款参照事件 |
| eventPlanHappenDate | datetime | - | - | - | 款项计划发生日期 | 款项计划发生日期 |
| eventPlanHappenDateENG | datetime | - | - | - | 工程计划发生日期 | 工程计划发生日期 |
| eventActualFinishDate | datetime | - | - | - | 事件实际完成日期 | 事件实际完成日期 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| taskTypeId | varchar(25) | - | - | - | 任务类型ID | 如completeTest=完成测试，关联基础数据表 |
| projectId | int(11) | - | - | - | 项目头信息主键 | 项目头信息主键,跟项目其他具体信息关联，逻辑外键 -> pm_project.projectId 或 pm_presales_project_header.presalesId |
| taskTypeCode | varchar(45) | - | - | - | 任务类型编码 | 逻辑外键 -> fnd_basic_data，关联基础数据表 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| depID | int(11) | - | - | - | 部门ID，关联外键 | 部门唯一标识，逻辑外键 -> ehr_employee.depID, ehr_emp_power.depIDs |
| depCode | varchar(20) | - | - | - | 部门编码 | 部门业务编码 |
| depName | varchar(100) | - | - | - | 部门名称 | 办事处名称 |
| depAbbr | varchar(100) | - | - | - | 部门简称 | 部门缩写名称 |
| compID | int(11) | - | - | - | 公司ID，关联表外键 | 公司唯一标识，逻辑外键 -> ehr_department.compID, ehr_employee.compID, ehr_emp_power.compID |
| adminID | int(11) | - | - | - | 上级ID | 上级公司ID，用于构建公司层级关系，逻辑外键 -> ehr_company.compID |
| depGrade | int(11) | - | - | - | 部门级别 | 部门层级等级 |
| depType | int(11) | - | - | - | 部门类型 | 部门类型分类 |
| depProperty | int(11) | - | - | - | 部门属性 | 部门属性标记 |
| depCost | int(11) | - | - | - | 存在部门内分级计数用 | 部门内分级计数 |
| director | int(11) | - | - | - | 主管 | 部门主管员工ID，逻辑外键 -> ehr_employee.empID |
| director2 | int(11) | - | - | - | 分管领导 | 分管领导员工ID，逻辑外键 -> ehr_employee.empID |
| depEmp | int(11) | - | - | - | 部门员工数 | 部门内员工计数 |
| depNum | int(11) | - | - | - | 部门编号 | 部门业务编号，唯一标识，逻辑外键 -> fnd_department.departmentNum |
| effectDate | datetime | - | - | - | 成立时间 | 公司成立日期 |
| xOrder | varchar(20) | - | - | - | 排序 | 部门显示排序值 |
| isDisabled | bit(1) | - | - | - | 失效状态 | 公司是否已失效，0=正常，1=失效 |
| disabledDate | datetime | - | - | - | 失效时间 | 公司失效的时间戳 |
| remark | varchar(500) | - | - | - | 关于资源定义的备注说明 | 关于资源定义的备注说明 |
| depCustom1 | int(11) | - | - | - | 保留字段1 | 预留扩展字段 |
| depCustom2 | int(11) | - | - | - | 保留字段2、部门秘书 | 预留扩展字段，也用于存储部门秘书信息 |
| depCustom3 | int(11) | - | - | - | 保留字段3 | 预留扩展字段 |
| depCustom4 | int(11) | - | - | - | 保留字段4 | 预留扩展字段 |
| depCustom5 | int(11) | - | - | - | 保留字段5 | 预留扩展字段 |
| directorWorkNo | varchar(100) | - | - | - | directorWork编号 | directorWork编号 |
| directorName | varchar(200) | - | - | - | director名称 | director名称 |
| directorJobID | int(11) | - | - | - | directorJobID | directorJobID |
| directorWorkNo2 | varchar(100) | - | - | - | directorWorkNo | directorWorkNo |
| directorName2 | varchar(200) | - | - | - | directorName | directorName |
| directorJobID2 | int(11) | - | - | - | directorJobI | directorJobI |
| depLV1ID | bigint(11) | - | - | - | depLID | depLID |
| depLV1Code | varchar(20) | - | - | - | depL编码 | depL编码 |
| depLV1Name | varchar(100) | - | - | - | depL名称 | depL名称 |
| depLV2ID | bigint(11) | - | - | - | depLID | depLID |
| depLV2Code | varchar(20) | - | - | - | depL编码 | depL编码 |
| depLV2Name | varchar(100) | - | - | - | depL名称 | depL名称 |
| depLV3ID | bigint(11) | - | - | - | depLID | depLID |
| depLV3Code | varchar(20) | - | - | - | depL编码 | depL编码 |
| depLV3Name | varchar(100) | - | - | - | depL名称 | depL名称 |
| depAllName | varchar(304) | - | - | - | depAll名称 | depAll名称 |
| compName | varchar(100) | - | - | - | 组织机构简写 | 组织机构简写 |
...
| depLV3Code | varchar(20) | - | - | - | depL编码 | depL编码 |
| depLV3Name | varchar(100) | - | - | - | depL名称 | depL名称 |
| depLV4ID | bigint(11) | - | - | - | depLID | depLID |
| depLV4Code | varchar(20) | - | - | - | depL编码 | depL编码 |
| depLV4Name | varchar(100) | - | - | - | depL名称 | depL名称 |
| depAllName | varchar(406) | - | - | - | depAll名称 | depAll名称 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| empID | int(11) | - | - | - | 员工ID，外键 | 员工唯一标识，逻辑外键 -> ehr_emp_power.empID, ehr_login.empID |
| workNo | varchar(100) | - | - | - | 工号 | 员工工号，用于系统登录和身份识别 |
| name | varchar(200) | - | - | - | 组织机构全名 | 付款申请人/服务商姓名 |
| eName | varchar(200) | - | - | - | 英文名 | 员工英文名称 |
| compID | int(11) | - | - | - | 公司ID，关联表外键 | 公司唯一标识，逻辑外键 -> ehr_department.compID, ehr_employee.compID, ehr_emp_power.compID |
| depID | int(11) | - | - | - | 部门ID，关联外键 | 部门唯一标识，逻辑外键 -> ehr_employee.depID, ehr_emp_power.depIDs |
| jobID | int(11) | - | - | - | 岗位ID | 岗位唯一标识，逻辑外键 -> ehr_employee.jobID |
| reportTo | int(11) | - | - | - | 直接上级 | 直属上级员工ID，逻辑外键 -> ehr_employee.empID |
| wfreportTo | int(11) | - | - | - | 职能上级 | 职能上级员工ID，逻辑外键 -> ehr_employee.empID |
| empStatus | int(11) | - | - | - | 员工状态，1：在职，2：离职 | 员工状态，1：在职，2：离职 |
| jobStatus | int(11) | - | - | - | 岗位状态 | 岗位在岗状态 |
| empType | int(11) | - | - | - | 聘用类型：1：正式，3：实习生 | 聘用类型：1：正式，3：实习生 |
| joinDate | datetime | - | - | - | 加入公司日期 | 员工入职日期 |
| workBeginDate | datetime | - | - | - | 工作开始日期 | 员工开始工作日期 |
| jobBeginDate | datetime | - | - | - | 加入公司日期（未知） | 岗位开始日期 |
| pracBeginDate | datetime | - | - | - | 实习开始时间 | 实习期开始日期 |
| pracEndDate | datetime | - | - | - | 实习结束时间 | 实习期结束日期 |
| probBeginDate | datetime | - | - | - | 试用期开始时间 | 试用期开始日期（推断） |
| probEndDate | datetime | - | - | - | 试用期结束时间 | 试用期结束日期（推断） |
| leaveDate | datetime | - | - | - | 离职时间 | 员工离职日期 |
| gender | int(11) | - | - | - | 性别 | 1=男，2=女 |
| email | varchar(500) | - | - | - | 邮箱账号 | 项目成员邮箱地址 |
| mobile | varchar(50) | - | - | - | 手机 | 员工手机号码 |
| officePhone | varchar(50) | - | - | - | 座机 | 员工办公座机号码 |
| remark | varchar(100) | - | - | - | 关于资源定义的备注说明 | 关于资源定义的备注说明 |
| disabled | int(11) | - | - | - | 数据是否失效 | 员工是否失效，0=正常 |
| empCustom1 | int(11) | - | - | - | 预留字段1 | 预留扩展字段 |
| empCustom2 | int(11) | - | - | - | 预留字段2 | 预留扩展字段 |
| empCustom3 | int(11) | - | - | - | 预留字段3 | 预留扩展字段 |
| empCustom4 | varchar(50) | - | - | - | 预留字段4 | 预留扩展字段 |
| empCustom5 | int(11) | - | - | - | 预留字段5 | 预留扩展字段 |
| reportToWorkNo | varchar(100) | - | - | - | reportToWork编号 | reportToWork编号 |
| reportToName | varchar(200) | - | - | - | reportTo名称 | reportTo名称 |
| wfreportToWorkNo | varchar(100) | - | - | - | wfreportToWork编号 | wfreportToWork编号 |
| wfreportToName | varchar(200) | - | - | - | wfreportTo名称 | wfreportTo名称 |
| depGrade | int(11) | - | - | - | 部门级别 | 部门层级等级 |
| depCode | varchar(20) | - | - | - | 部门编码 | 部门业务编码 |
| depName | varchar(100) | - | - | - | 部门名称 | 办事处名称 |
| jobCode | varchar(10) | - | - | - | 岗位编码 | 岗位业务编码 |
| jobName | varchar(100) | - | - | - | 岗位名称 | 岗位名称 |
| depLV1ID | bigint(11) | - | - | - | depLID | depLID |
| depLV1Code | varchar(20) | - | - | - | depL编码 | depL编码 |
| depLV1Name | varchar(100) | - | - | - | depL名称 | depL名称 |
| depLV2ID | bigint(11) | - | - | - | depLID | depLID |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| contract_code | varchar(25) | - | - | - | 合同号 | 合同号 |
| emsNum | mediumtext | - | - | - | 快递单号 | 快递单号 |
| receiveName | mediumtext | - | - | - | 收货人 | 收件人 |
| emsCompany | mediumtext | - | - | - | 快递公司名称 | 快递公司 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| contractNo | varchar(25) | - | - | - | 合同编号 | 合同编号，逻辑外键 -> pm_project_product_line.contractNo |
| deliverableName | varchar(255) | - | - | - | 交付件名称 | 交付件名称 |
| deliverablePath | varchar(255) | - | - | - | 交付件路径 | 交付件路径 |
| smsDeliverType | varchar(255) | - | - | - | smsDeliver类型 | smsDeliver类型 |
| uploadUser | varchar(174) | - | - | - | 上传者 | 上传者 |
| uploadTime | datetime | - | - | - | 上传时间 | 文件上传时间 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| presalesId | int(11) | - | - | - | 售前项目主表 | 逻辑外键 -> pm_presales_project_header.presalesId |
| instId | varchar(64) | - | - | - | 工作流流程ID | CRM Activiti流程实例ID |
| applyDuration | varchar(128) | - | - | - | applyDuration | applyDuration |
| totalDuration | varchar(216) | - | - | - | 开始时间 | 项目开始到结束的时间间隔 |
| serviceDuration | varchar(216) | - | - | - | 服务经理指派耗时 | 服务经理指派耗时 |
| programDuration | varchar(216) | - | - | - | 项目经理指派耗时 | 项目经理指派耗时 |
| testDuration | varchar(216) | - | - | - | 测试跟踪耗时间 | 测试跟踪耗时 |
| callbackDuration | varchar(216) | - | - | - | 回访耗时 | 回访耗时 |
| serviceApproveDuration | varchar(216) | - | - | - | 服务经理审批耗时 | 服务经理审批耗时 |
...
| presalesId | int(11) | - | - | - | 售前项目主表 | 逻辑外键 -> pm_presales_project_header.presalesId |
| instId | varchar(64) | - | - | - | 工作流流程ID | CRM Activiti流程实例ID |
| applyDuration | bigint(25) | - | - | - | applyDuration | applyDuration |
| totalDuration | bigint(26) | - | - | - | 开始时间 | 项目开始到结束的时间间隔 |
| allDuration | decimal(46,0) | - | - | - | allDuration | allDuration |
| serviceDuration | decimal(46,0) | - | - | - | 服务经理指派耗时 | 服务经理指派耗时 |
| programDuration | decimal(46,0) | - | - | - | 项目经理指派耗时 | 项目经理指派耗时 |
| testDuration | decimal(46,0) | - | - | - | 测试跟踪耗时间 | 测试跟踪耗时 |
| callbackDuration | decimal(46,0) | - | - | - | 回访耗时 | 回访耗时 |
| serviceApproveDuration | decimal(46,0) | - | - | - | 服务经理审批耗时 | 服务经理审批耗时 |
...
| projectId | int(11) | - | - | - | 项目头信息主键,跟项目其他具体信息关联 | 逻辑外键 -> pm_project.projectId 或 pm_presales_project_header.presalesId |
| projectCode | varchar(45) | - | - | - | 原始项目编码 | 逻辑外键 -> pm_project.projectCode |
| rank | varchar(255) | - | - | - | 排名 | 排名 |
| projectName | varchar(246) | - | - | - | 由商务输入 | 项目的业务名称 |
| projectStateName | varchar(255) | - | - | - | 项目状态名称 | 项目状态名称 |
| projectState | varchar(11) | - | - | - | 对应项目阶段中的不同状态 ，默认1为初始创建状态，0为不予跟踪状态 | 项目状态，10=待开始 20=直接闭环 30=已创建 31=待指派项目经理 32=项目经理跟踪 33=工程管理部回访 34=服务经理审核 100=项目闭环 |
| contractNo | text | - | - | - | 合同编号 | 合同编号，逻辑外键 -> pm_project_product_line.contractNo |
| officeCode | varchar(255) | - | - | - | 办事处或部门编码 | 办事处编码，逻辑外键 -> fnd_department.departmentNum |
| officeName | varchar(20) | - | - | - | 办事处名称 | 办事处名称（冗余自fnd_department） |
| salesManCode | varchar(45) | - | - | - | 人员编码,外部人员为空 | 人员编码,外部人员为空 |
| salesManName | varchar(45) | - | - | - | 销售人员姓名 | 销售人员姓名 |
| orderCreateTime | datetime | - | - | - | 订单创建时间 | 订单创建时间 |
| serviceManager | varchar(45) | - | - | - | 人员编码,外部人员为空 | 服务经理姓名（冗余自pm_project） |
| serviceManagerName | varchar(45) | - | - | - | 人员名称 | 人员名称 |
| projectManager | varchar(45) | - | - | - | 人员编码,外部人员为空 | 人员编码,外部人员为空 |
| projectManagerName | varchar(45) | - | - | - | 人员名称 | 人员名称 |
| currentTask | varchar(255) | - | - | - | 当前工程阶段 | 当前工程阶段名称 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| projectCode | varchar(64) | - | - | - | 原始项目编码 | 逻辑外键 -> pm_project.projectCode |
| projectName | varchar(255) | - | - | - | 由商务输入 | 项目的业务名称 |
| contractNo | varchar(341) | - | - | - | 合同编号 | 合同编号，逻辑外键 -> pm_project_product_line.contractNo |
| officeName | varchar(20) | - | - | - | 办事处名称 | 办事处名称（冗余自fnd_department） |
| customerName | varchar(255) | - | - | - | 客户名称 | 客户名称 |
| marketName | varchar(255) | - | - | - | 市场部名称 | 市场部名称 |
| systemName | varchar(255) | - | - | - | 系统部名称 | 系统部名称 |
| expendName | varchar(255) | - | - | - | 拓展部名称 | 拓展部名称 |
| industryName | varchar(255) | - | - | - | 客户所属行业 | 客户所属行业名称 |
| salesManCode | varchar(45) | - | - | - | 人员编码,外部人员为空 | 人员编码,外部人员为空 |
| salesManName | varchar(68) | - | - | - | 销售人员姓名 | 销售人员姓名 |
| salesManTel | varchar(45) | - | - | - | 销售人员电话 | 销售人员电话 |
| salesManMail | varchar(100) | - | - | - | 销售人员邮箱 | 销售人员邮箱 |
| smCode | varchar(45) | - | - | - | 服务经理编码 | 服务经理编码 |
| smName | varchar(45) | - | - | - | 服务经理姓名 | 服务经理姓名 |
| pmCode1 | varchar(45) | - | - | - | 项目经理1编码 | 项目经理1编码 |
| pmName1 | varchar(45) | - | - | - | 项目经理1姓名 | 项目经理1姓名 |
| pmCode2 | varchar(45) | - | - | - | 项目经理2编码 | 项目经理2编码 |
| pmName2 | varchar(45) | - | - | - | 项目经理2姓名 | 项目经理2姓名 |
| compId | int(11) | - | - | - | 公司ID | 逻辑外键 -> fnd_company.id |
| compName | varchar(128) | - | - | - | 组织机构简写 | 组织机构简写 |
| ssfsName | varchar(255) | - | - | - | 实施方式名称 | 实施方式名称 |
| partnerChannel | varchar(45) | - | - | - | 合作伙伴渠道名称 | 合作伙伴渠道名称 |
| projectType | varchar(4) | - | - | - | 项目类型，售前:20/售后:10 | 逻辑外键 -> fnd_basic_data(dataTypeCode=presalesType) |
| finalCustomerName | varchar(255) | - | - | - | 最终客户单位 | 最终客户名称 |
| customerProjectName | varchar(255) | - | - | - | 客户项目名称 | 客户侧的项目名称 |
...
| projectName | varchar(255) | - | - | - | 由商务输入 | 项目的业务名称 |
| projectStateName | varchar(255) | - | - | - | 项目状态名称 | 项目状态名称 |
| projectState | varchar(255) | - | - | - | 对应项目阶段中的不同状态 ，默认1为初始创建状态，0为不予跟踪状态 | 项目状态，10=待开始 20=直接闭环 30=已创建 31=待指派项目经理 32=项目经理跟踪 33=工程管理部回访 34=服务经理审核 100=项目闭环 |
| contractNo | varchar(341) | - | - | - | 合同编号 | 合同编号，逻辑外键 -> pm_project_product_line.contractNo |
| officeCode | varchar(255) | - | - | - | 办事处或部门编码 | 办事处编码，逻辑外键 -> fnd_department.departmentNum |
| officeName | varchar(20) | - | - | - | 办事处名称 | 办事处名称（冗余自fnd_department） |
| salesManCode | varchar(45) | - | - | - | 人员编码,外部人员为空 | 人员编码,外部人员为空 |
...
| projectId | int(11) | - | - | - | 项目头信息主键,跟项目其他具体信息关联 | 逻辑外键 -> pm_project.projectId 或 pm_presales_project_header.presalesId |
| projectCode | varchar(45) | - | - | - | 原始项目编码 | 逻辑外键 -> pm_project.projectCode |
| projectName | varchar(200) | - | - | - | 由商务输入 | 项目的业务名称 |
| projectType | int(11) | - | - | - | 项目类型，售前:20/售后:10 | 逻辑外键 -> fnd_basic_data(dataTypeCode=presalesType) |
| projectExecutionState | varchar(45) | - | - | - | 项目实施状态 | 项目当前执行状态编码 |
| contractNo | varchar(255) | - | - | - | 合同编号 | 合同编号，逻辑外键 -> pm_project_product_line.contractNo |
| officeCode | varchar(25) | - | - | - | 办事处或部门编码 | 办事处编码，逻辑外键 -> fnd_department.departmentNum |
| type | varchar(45) | - | - | - | 交付件类型,0:用服交付合同，1：用服服务单，2：工程合同 | 0=用服交付合同，1=用服服务单，2=工程合同 |
| category | varchar(45) | - | - | - | 任务分类 | 服务任务分类编码 |
| subCategory | varchar(45) | - | - | - | 维保子分类 | 维保服务子分类编码 |
| processTime | datetime | - | - | - | 处理时间 | 服务处理时间 |
| processDesc | varchar(1024) | - | - | - | 事项描述 | 维保处理过程描述 |
| processStep | varchar(1024) | - | - | - | 解决进展 | 维保处理步骤说明 |
| remainProblem | varchar(1024) | - | - | - | 遗留问题 | 维保后仍遗留的问题 |
| transitHour | float | - | - | - | 在途耗时(h) | 工程师在途耗时（小时） |
| processHour | float | - | - | - | 处理耗时(h) | 工程师现场处理耗时（小时） |
| itemModel | varchar(255) | - | - | - | item型号 | 忽略的物料型号 |
| softVersion | varchar(255) | - | - | - | 在网版本 | 设备在网软件版本 |
| enabledFeatures | varchar(255) | - | - | - | 已启用特性 | 设备已启用的功能特性 |
| customTos | varchar(512) | - | - | - | 自定义主送 | 自定义邮件主送人 |
| customCcs | varchar(512) | - | - | - | 自定义抄送 | 自定义邮件抄送人 |
| hasReport | bit(1) | - | - | - | 是否有巡检报告 | 是否上传了维保报告，0=无，1=有 |
| quesnaireId | int(11) | - | - | - | 回访问卷ID | 逻辑外键 -> pm_cl_quesnaire_result_header.id |
| deliverFileIds | varchar(255) | - | - | - | 交付件，fnd_files id | 逻辑外键 -> fnd_files.id |
| warrantyStatus | varchar(25) | - | - | - | 维保状态 | 项目维保状态 |
| industryName | varchar(25) | - | - | - | 客户所属行业 | 客户所属行业名称 |
| userOffice | varchar(25) | - | - | - | 用户办事处 | 维保人员所属办事处编码 |
| remark | varchar(2048) | - | - | - | 关于资源定义的备注说明 | 关于资源定义的备注说明 |
| createTime | datetime | - | - | - | 创建时间 | 记录创建时间（指定服务经理时间） |
| createBy | varchar(45) | - | - | - | 创建用户 | 记录创建用户编码 |
| updateTime | datetime | - | - | - | 最新更新时间 | 记录最后更新时间，自动更新（on update CURRENT_TIMESTAMP） |
| updateBy | varchar(45) | - | - | - | 最新更新用户 | 记录最新更新用户编码 |
| officeName | varchar(20) | - | - | - | 办事处名称 | 办事处名称（冗余自fnd_department） |
| userOfficeName | varchar(20) | - | - | - | 用户办事处名称 | 维保人员所属办事处名称 |
| serviceManager | varchar(45) | - | - | - | 人员编码,外部人员为空 | 服务经理姓名（冗余自pm_project） |
| programManagerA | varchar(45) | - | - | - | 项目经理A | 第一项目经理姓名 |
| programManagerB | varchar(45) | - | - | - | 项目经理B | 第二项目经理姓名 |
| createUser | varchar(174) | - | - | - | 创建用户名 | 创建人姓名（冗余，含工号+姓名拼接） |
| typeName | varchar(255) | - | - | - | 类型名称 | 维保类型中文名称（冗余自fnd_basic_data） |
| projectExecutionStateName | varchar(255) | - | - | - | 项目执行状态名称 | 项目执行状态中文名称 |
| categoryName | varchar(258) | - | - | - | 分类名称 | 维保分类中文名称 |
| subCategoryName | varchar(255) | - | - | - | 子分类名称 | 维保子分类中文名称 |
| marketName | varchar(255) | - | - | - | 市场部名称 | 市场部名称 |
| systemName | varchar(255) | - | - | - | 系统部名称 | 系统部名称 |
| expendName | varchar(255) | - | - | - | 拓展部名称 | 拓展部名称 |
| industryNameN | varchar(255) | - | - | - | 行业名称N | 子行业名称（冗余，与industryName区分） |
| finalCustomerName | varchar(255) | - | - | - | 最终客户单位 | 最终客户名称 |
| salerName | varchar(91) | - | - | - | 销售人员名称 | 销售人员姓名 |
| quesnaireResultHeaderId | int(11) | - | - | - | 回访结果头信息Id | 逻辑外键 -> pm_cl_quesnaire_result_header.id |
| 工程师技术能力 | longtext | - | - | - | 工程师技术能力评分 | 问卷评分维度：工程师技术能力（中文列名） |
| 服务水平及规范性 | longtext | - | - | - | 服务水平及规范性评分 | 问卷评分维度：服务水平及规范性（中文列名） |
| 服务及时性 | longtext | - | - | - | 服务及时性评分 | 问卷评分维度：服务及时性（中文列名） |
| warrantyStatusName | varchar(4) | - | - | - | 维保状态名称 | 维保状态中文名称 |
| syncTime | datetime | - | - | - | 同步时间 | 缓存数据最后同步刷新时间 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| barcode | varchar(50) | - | - | - | 设备序列号 | 设备序列号/条码 |
| contract_code | varchar(25) | - | - | - | 合同号（业务编号） | 合同号（业务编号） |
| contract_type | varchar(25) | - | - | - | 合同类型（0销售合同/11维修合同等） | 合同类型（0销售合同/11维修合同等） |
| project_num | varchar(25) | - | - | - | projectnum | projectnum |
| project_name | varchar(512) | - | - | - | 项目名称/申请原因 | 项目名称/申请原因 |
| custom_name | varchar(512) | - | - | - | custom名称 | custom名称 |
| final_customer | varchar(512) | - | - | - | finalcustomer | finalcustomer |
| office_name | varchar(25) | - | - | - | 办事处名称 | 办事处名称 |
| delivery_time | bigint(11) | - | - | - | delivery时间 | delivery时间 |
| order_num | varchar(32) | - | - | - | ordernum | ordernum |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| taskId | int(11) | - | - | - | activity任务ID | Activiti工作流任务实例ID |
| projectCode | varchar(45) | - | - | - | 原始项目编码 | 逻辑外键 -> pm_project.projectCode |
| executeId | binary(0) | - | - | - | executeID | executeID |
| contractId | varchar(45) | - | - | - | 标识已经同步 | 标识已经同步 |
| nodeTypeCode | varchar(25) | - | - | - | nodeType编码 | nodeType编码 |
| nodeBeginTime | datetime | - | - | - | nodeBegin时间 | nodeBegin时间 |
| nodeEndTime | datetime | - | - | - | nodeEnd时间 | nodeEnd时间 |
| dataUpdateTime | binary(0) | - | - | - | dataUpdate时间 | dataUpdate时间 |
| nodeAttached | varchar(11) | - | - | - | nodeAttached | nodeAttached |
| nodeRemark | varchar(255) | - | - | - | nodeRe标记 | nodeRe标记 |
| updateTime | datetime | - | - | - | 最新更新时间 | 记录最后更新时间，自动更新（on update CURRENT_TIMESTAMP） |
| effectiveTo | datetime | - | - | - | 有效结束时间 | 数据有效性结束时间，NULL=当前有效 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| taskId | binary(0) | - | - | - | activity任务ID | Activiti工作流任务实例ID |
| projectCode | varchar(45) | - | - | - | 原始项目编码 | 逻辑外键 -> pm_project.projectCode |
| executeId | binary(0) | - | - | - | executeID | executeID |
| contractId | varchar(45) | - | - | - | 标识已经同步 | 标识已经同步 |
| nodeTypeCode | varchar(11) | - | - | - | nodeType编码 | nodeType编码 |
| nodeBeginTime | binary(0) | - | - | - | nodeBegin时间 | nodeBegin时间 |
| nodeEndTime | binary(0) | - | - | - | nodeEnd时间 | nodeEnd时间 |
| dataUpdateTime | binary(0) | - | - | - | dataUpdate时间 | dataUpdate时间 |
| nodeAttached | varchar(11) | - | - | - | nodeAttached | nodeAttached |
| nodeRemark | varchar(255) | - | - | - | nodeRe标记 | nodeRe标记 |
| updateTime | binary(0) | - | - | - | 最新更新时间 | 记录最后更新时间，自动更新（on update CURRENT_TIMESTAMP） |
| effectiveTo | binary(0) | - | - | - | 有效结束时间 | 数据有效性结束时间，NULL=当前有效 |
...
| projectName | varchar(255) | - | - | - | 由商务输入 | 项目的业务名称 |
| projectStateName | varchar(255) | - | - | - | 项目状态名称 | 项目状态名称 |
| projectState | varchar(255) | - | - | - | 项目状态 | 项目状态，10=待开始 20=直接闭环 30=已创建 31=待指派项目经理 32=项目经理跟踪 33=工程管理部回访 34=服务经理审核 100=项目闭环 |
| contractNo | varchar(50) | - | - | - | 合同编号 | 合同编号，逻辑外键 -> pm_project_product_line.contractNo |
| officeCode | varchar(15) | - | - | - | 办事处编码 | 办事处编码，逻辑外键 -> fnd_department.departmentNum |
| officeName | varchar(20) | - | - | - | 办事处名称 | 办事处名称（冗余自fnd_department） |
| salesManCode | varchar(45) | - | - | - | 销售人员编码 | 销售人员编码 |
| salesManName | varchar(45) | - | - | - | 销售人员姓名 | 销售人员姓名 |
| orderCreateTime | datetime | - | - | - | 订单创建时间 | 订单创建时间 |
| systemName | varchar(255) | - | - | - | 系统部名称 | 系统部名称 |
...
|--------|----------|------|--------|------|----------|----------|
| contractNo | varchar(50) | - | - | - | 合同编号 | 合同编号，逻辑外键 -> pm_project_product_line.contractNo |
| marketCode | varchar(64) | - | - | - | 市场部编码 | 市场部编码 |
| marketName | varchar(255) | - | - | - | 市场部名称 | 市场部名称 |
| systemId | varchar(64) | - | - | - | 系统部ID | 系统部ID |
| systemName | varchar(255) | - | - | - | 系统部名称 | 系统部名称 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| sheetID | varchar(25) | - | - | - | RMA申请流水号 | RMA申请流水号，多个合同号_n |
| spare_serialNum | varchar(50) | - | - | - | 备件序列号 | 备件序列号 |
| instead_of_num | varchar(25) | - | - | - | 好件替换坏件关系 | 好件替换坏件关系 |
| item_code | varchar(15) | - | - | - | 物料编码 | 物料编码 |
| item_name | varchar(255) | - | - | - | 物料名称 | 物料名称 |
| customer_name | varchar(255) | - | - | - | 客户名称 | 客户名称 |
| contractNo | varchar(25) | - | - | - | 合同号 | 合同号 |
| contractRemark | varchar(4096) | - | - | - | 合同备注 | 合同备注 |
| project_name | varchar(255) | - | - | - | 项目名称 | 项目名称 |
| back | varchar(10) | - | - | - | 返回类型 | 退回类型编码 |
| serve | varchar(10) | - | - | - | 服务类型 | 服务编码 |
| tain | varchar(10) | - | - | - | 维保类型 | 维修编码 |
| data_state | char(1) | - | - | - | 数据状态（0：最新；1：历史数据） | 数据状态（0：最新；1：历史数据） |
| department | varchar(50) | - | - | - | 部门 | 部门 |
| application_time | datetime | - | - | - | 申请发起时间 | 申请发起时间 |
| approve_time | datetime | - | - | - | 审批时间 | 审批时间 |
| is_pass | varchar(2) | - | - | - | 是否通过审批(0为未处理，1为通过，2为未通过 , -1 作废处理) | 是否通过审批(0为未处理，1为通过，2为未通过 , -1 作废处理) |
| applicant | varchar(10) | - | - | - | 申请发起人 | 申请发起人 |
| EMS_num | varchar(255) | - | - | - | 快递单号 | 快递单号 |
| EMS_company | varchar(255) | - | - | - | 快递公司 | 快递公司 |
| addressee | varchar(25) | - | - | - | 收件人 | 收件人 |
| send_time | datetime | - | - | - | 出库时间 | 出库时间 |
| isBack | char(1) | - | - | - | 坏件是否返回（0：未返回;1:已返回） | 坏件是否返回（0：未返回;1:已返回） |
| back_time | datetime | - | - | - | 返回时间 | 返回时间 |
| doa_path | varchar(100) | - | - | - | doa故障分析单（下载路径） | doa故障分析单（下载路径） |
| check_path | varchar(100) | - | - | - | 检测报告(下载路径) | 检测报告(下载路径) |
| duty_person | varchar(10) | - | - | - | 代理公司和负责人 | 代理公司和负责人 |
| isOK | char(1) | - | - | - | 设备状态(是否核销，0为未核销，1为核销) | 设备状态(是否核销，0为未核销，1为核销) |
| hexiao_time | datetime | - | - | - | 核销时间 | 核销时间 |
| problem_desc | text | - | - | - | 问题描述 | 问题描述 |
| tx_id | int(11) | - | - | - | 交易号(关联application_transInfo表） | 交易号(关联application_transInfo表） |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | varchar(64) | - | - | - | 主键ID | 主键ID |
| barcode | varchar(50) | - | - | - | 设备序列号 | 设备序列号/条码 |
| end_date | datetime | - | - | - | 服务结束日期 | 服务结束日期 |
...
|--------|----------|------|--------|------|----------|----------|
| barcode | varchar(50) | - | - | - | 设备序列号 | 设备序列号/条码 |
| maxEndDate | datetime | - | - | - | maxEnd日期 | maxEnd日期 |
...
|--------|----------|------|--------|------|----------|----------|
| contract_code | varchar(25) | - | - | - | 合同号（业务编号） | 合同号（业务编号） |
| itemCode | varchar(16) | - | - | - | item编码 | ERP系统产品编码 |
| barcode | varchar(50) | - | - | - | 设备序列号 | 设备序列号/条码 |
| itemCode2 | varchar(16) | - | - | - | 母子公司发货物料编码对应关系 | 母子公司发货物料编码对应关系 |
| barcode2 | varchar(50) | - | - | - | 母子公司发货序列号对应关系 | 母子公司发货序列号对应关系 |
...
|--------|----------|------|--------|------|----------|----------|
| contract_code | varchar(25) | - | - | - | 合同号（业务编号） | 合同号（业务编号） |
| receiveName | text | - | - | - | 收货人 | 收货人姓名 |
| emsNum | text | - | - | - | 快递单号 | 快递/物流单号 |
| packdate | datetime | - | - | - | 发货日期 | 发货日期 |
| emsCompany | mediumtext | - | - | - | 快递公司名称 | 快递/物流公司名称 |
| packId | varchar(64) | - | - | - | 装箱单ID | 装箱单ID |
...
| itemCode | varchar(16) | - | - | - | item编码 | ERP系统产品编码 |
| itemModel | varchar(255) | - | - | - | item型号 | 忽略的物料型号 |
| itemName | varchar(255) | - | - | - | 产品名称 | 忽略的物料名称 |
| barcode | varchar(50) | - | - | - | 设备序列号 | 设备序列号/条码 |
| comBarcode | varchar(50) | - | - | - | 组合编码 | 组合编码 |
| packId | varchar(64) | - | - | - | 装箱单ID | 装箱单ID |
| itemCode2 | varchar(16) | - | - | - | 母子公司发货物料编码对应关系 | 母子公司发货物料编码对应关系 |
| itemModel2 | varchar(255) | - | - | - | 产品型号2 | 产品型号2 |
| itemName2 | varchar(255) | - | - | - | 产品名称2 | 产品名称2 |
| barcode2 | varchar(50) | - | - | - | 母子公司发货序列号对应关系 | 母子公司发货序列号对应关系 |
| profitCenter | varchar(32) | - | - | - | 办事处编码 | 利润中心编码 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| serial_number | varchar(100) | - | - | - | 序列号 | 设备序列号 |
| conp | mediumtext | - | - | - | CONP软件版本 | 主程序版本（release版本） |
| cpld | mediumtext | - | - | - | CPLD版本号 | CPLD（复杂可编程逻辑器件）版本号 |
| boot | mediumtext | - | - | - | Boot版本号 | BOOT引导程序版本号 |
| pcb | mediumtext | - | - | - | PCB版本号 | 受影响PCB版本号 |
...
|--------|----------|------|--------|------|----------|----------|
| id | int(11) | - | - | - | 主键ID | 主键ID |
| subcontractName | varchar(512) | - | - | - | 转包名称 | 转包项目名称 |
| subcontractNo | varchar(64) | - | - | - | 转包合同号 | 逻辑外键 -> pm_subcontract_project_header.subcontractNo，关联转包项目 |
| contractNos | varchar(2048) | - | - | - | 关联的合同号 | 关联合同编号（多个逗号分隔） |
| projectIds | varchar(1024) | - | - | - | 转包的项目ID | 逻辑外键 -> pm_project.projectId |
| type | int(11) | - | - | - | 交付件类型,0:用服交付合同，1：用服服务单，2：工程合同 | 0=用服交付合同，1=用服服务单，2=工程合同 |
| state | int(11) | - | - | - | (1:为最新审批结果；0：为旧审批结果) | (1:为最新审批结果；0：为旧审批结果) |
| callbackState | int(11) | - | - | - | 回访状态 | 回访状态 |
| facilitatorId | int(11) | - | - | - | 服务商表ID | 逻辑外键 -> pm_subcontract_facilitator.id |
| facilitatorName | varchar(64) | - | - | - | 服务商名 | 服务商名称 |
| bankInfo | varchar(255) | - | - | - | 服务商开户地址 | 服务商开户行信息 |
| bankAccount | varchar(64) | - | - | - | 服务商收款账户 | 服务商收款银行账号 |
| officeCode | varchar(25) | - | - | - | 办事处或部门编码 | 办事处编码，逻辑外键 -> fnd_department.departmentNum |
| profitDepCode | varchar(25) | - | - | - | 收益部门 | 收益部门编码 |
| isAccrued | bit(1) | - | - | - | 是否计提 | 0=未计提，1=已计提 |
| isInvoiced | bit(1) | - | - | - | 是否提供发票 | 0=未提供发票，1=已提供发票 |
| subcontractAmount | varchar(25) | - | - | - | 转包价 | 转包合同金额 |
| reason | varchar(512) | - | - | - | 转包原因 | 转包原因说明 |
| remark | varchar(512) | - | - | - | 关于资源定义的备注说明 | 关于资源定义的备注说明 |
| effectiveForm | datetime | - | - | - | 有效开始时间 | 有效开始时间 |
| effectiveTo | datetime | - | - | - | 有效结束时间 | 有效结束时间，NULL=当前有效 |
| zrApproveTime | datetime | - | - | - | 最新主任审批通过时间 | 最新主任审批时间 |
| createBy | varchar(25) | - | - | - | 创建用户 | 记录创建用户编码 |
| createTime | datetime | - | - | - | 创建时间 | 记录创建时间（指定服务经理时间） |
| updateBy | varchar(25) | - | - | - | 最新更新用户 | 记录最新更新用户编码 |
| updateTime | datetime | - | - | - | 最新更新时间 | 记录最后更新时间，自动更新（on update CURRENT_TIMESTAMP） |
| stateName | varchar(255) | - | - | - | state名称 | state名称 |
| callbackStateName | varchar(255) | - | - | - | callbackState名称 | callbackState名称 |
| createName | varchar(154) | - | - | - | create名称 | create名称 |
| officeName | varchar(20) | - | - | - | 办事处名称 | 办事处名称（冗余自fnd_department） |
| profitDepName | varchar(20) | - | - | - | profitDep名称 | profitDep名称 |
| typeName | varchar(255) | - | - | - | 类型名称 | 维保类型中文名称（冗余自fnd_basic_data） |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| sheetID | varchar(15) | - | - | - | RMA申请流水号，多个合同号_n | RMA申请流水号，多个合同号_n |
| beforeChange_sheetID | varchar(15) | - | - | - | 发起转移申请之前的备件所涉及的单据号，此字段是为了保持备件经过转移流转后涉及单据号不变 | 发起转移申请之前的备件所涉及的单据号，此字段是为了保持备件经过转移流转后涉及单据号不变 |
| applicant | varchar(25) | - | - | - | 申请发起人 | 申请发起人 |
| app_time | datetime | - | - | - | 申请时间 | 申请时间 |
| app_dptNo | varchar(10) | - | - | - | 申请办事处名称 | 申请办事处名称 |
| prt_name | varchar(255) | - | - | - | 项目名称 | 项目名称 |
| app_reason | text | - | - | - | 申请原因 | 申请原因 |
| promise_returntime | datetime | - | - | - | 承诺备件归还时间 | 承诺备件归还时间 |
| trade_classify | varchar(100) | - | - | - | 行业分类（手动填写） | 行业分类（手动填写） |
| signing_state | char(1) | - | - | - | 签单状态（0：已签单；1：未签单） 废弃字段 | 签单状态（0：已签单；1：未签单） 废弃字段 |
| kept_place | varchar(10) | - | - | - | 备件存放地 | 备件存放地 |
| demand_type | varchar(8) | - | - | - | 需求类型（维护在sys_state_or_type） | 需求类型（维护在sys_state_or_type） |
| his_zipCode | varchar(25) | - | - | - | 处理历史数据 | 处理历史数据 |
| his_addr | varchar(1024) | - | - | - | 地址/where | 地址/where |
| addre_id | int(11) | - | - | - | 关联收件人表ID | 关联收件人表ID |
| duty_person | varchar(10) | - | - | - | 代理公司和负责人 | 代理公司和负责人 |
| spare_serialNum | varchar(50) | - | - | - | 备件序列号 | 备件序列号 |
| start_use_time | datetime | - | - | - | 开始使用时间 | 开始使用时间 |
| send_time | datetime | - | - | - | 出库时间 | 出库时间 |
| EMS_num | varchar(255) | - | - | - | 快递单号 | 快递单号 |
| EMS_company | varchar(255) | - | - | - | 快递公司 | 快递公司 |
| item_code | varchar(25) | - | - | - | 物料编码 | 物料编码 |
| item_name | varchar(255) | - | - | - | 物料名称 | 物料名称 |
| isOK | char(1) | - | - | - | 设备状态(是否核销，0为未核销，1为核销) | 设备状态(是否核销，0为未核销，1为核销) |
| remark | text | - | - | - | 关于资源定义的备注说明 | 关于资源定义的备注说明 |
| tx_id | int(11) | - | - | - | 交易号(关联application_transInfo表） | 交易号(关联application_transInfo表） |
| action_time | datetime | - | - | - | 操作时间 | 操作时间 |
| shiftimes | int(11) | - | - | - | 备件经过转移次数 | 备件经过转移次数 |
| turnovertimes | int(11) | - | - | - | 翻转次数 | 翻转次数 |
| allottimes | int(11) | - | - | - | 分配次数 | 分配次数 |
| take_place | varchar(15) | - | - | - | 备件出处(0:未选择 1:供应链；2：库存) 此时的备件出处只是记录临时的状态，但也可算真实的状态，根据系统设定已不可更改，只需等审批确定后 | 备件出处(0:未选择 1:供应链；2：库存) 此时的备件出处只是记录临时的状态，但也可算真实的状态，根据系统设定已不可更改，只需等审批确定后 |
| approve_time | datetime | - | - | - | 审批时间 | 审批时间 |
| receive_time | datetime | - | - | - | 收货时间 | 收货时间 |
| sendout_whsCode | varchar(10) | - | - | - | 备件发出库房 | 备件发出库房 |
| isNew | char(1) | - | - | - | 数据状态(0:历史数据；1：最新数据 2:转移申请被转移状态) | 数据状态(0:历史数据；1：最新数据 2:转移申请被转移状态) |
| extend_returntime | datetime | - | - | - | 延长归还时间 | 延长归还时间 |
| hexiao_time | datetime | - | - | - | 核销时间 | 核销时间 |
| isUnion | int(11) | - | - | - | 是否联合供应链发货 | 是否联合供应链发货 |
...
| 字段名 | 数据类型 | 可空 | 默认值 | 约束 | 字段描述 | 业务含义 |
|--------|----------|------|--------|------|----------|----------|
| id | bigint(20) | - | - | - | 主键ID | 主键ID |
| projectName | varchar(512) | - | - | - | 由商务输入 | 项目的业务名称 |
| contractNo | varchar(25) | - | - | - | 合同编号 | 合同编号，逻辑外键 -> pm_project_product_line.contractNo |
| barcode | varchar(50) | - | - | - | 设备序列号 | 设备序列号/条码 |
| item | varchar(16) | - | - | - | 物料 | 子公司物料编码 |
| itemName | varchar(255) | - | - | - | 产品名称 | 忽略的物料名称 |
| itemDesc | varchar(255) | - | - | - | 产品描述 | 产品描述 |
| barcode2 | varchar(50) | - | - | - | 母子公司发货序列号对应关系 | 母子公司发货序列号对应关系 |
| item2 | varchar(16) | - | - | - | 母子公司发货物料编码对应关系 | 母子公司发货物料编码对应关系 |
| itemName2 | varchar(255) | - | - | - | 母公司产品名称 | 母公司产品名称 |
| itemDesc2 | varchar(255) | - | - | - | itemDesc | itemDesc |
| gradeName | varchar(125) | - | - | - | grade名称 | grade名称 |
| warranty | varchar(2) | - | - | - | 维保年限 | 维保年限 |
| warrantyStartTime | datetime | - | - | - | 维保开始日期 | 维保合同开始日期 |
| warrantyEndTime | datetime | - | - | - | 维保结束日期 | 维保合同结束日期 |
| diff | int(7) | - | - | - | 差异 | 差异 |
...
| barcode | varchar(50) | - | - | - | 设备序列号 | 设备序列号/条码 |
| comBarCode | varchar(50) | - | - | - | 组合编码 | 组合编码 |
| old_warrantyEndTime | datetime | - | - | - | 维保结束时间（旧规则） | 维保结束时间（旧规则） |
| warrantyEndTime | datetime | - | - | - | 维保结束日期 | 维保合同结束日期 |
| old_diff | int(7) | - | - | - | 差异（旧规则） | 差异（旧规则） |
| diff | int(7) | - | - | - | 差异 | 差异 |
| warrantyStartTime | datetime | - | - | - | 维保开始日期 | 维保合同开始日期 |
| old_warrantyStartTime | datetime | - | - | - | 维保开始时间（旧规则） | 维保开始时间（旧规则） |
| item | varchar(16) | - | - | - | 物料 | 子公司物料编码 |
| describe_ | varchar(255) | - | - | - | 物料描述 | 物料描述 |
| itemName | varchar(255) | - | - | - | 产品名称 | 物料名称 |
| gradeName | varchar(125) | - | - | - | grade名称 | grade名称 |
| gradeCode | varchar(25) | - | - | - | grade编码 | grade编码 |
| packdate | datetime | - | - | - | 发货日期 | 发货日期 |
| contract_code | varchar(25) | - | - | - | 合同号 | 合同号（业务编号） |
| contract_type | int(11) | - | - | - | 合同类型 | 合同类型（0销售合同/11维修合同等） |
| contract_type_name | varchar(25) | - | - | - | 合同类型名称 | 合同类型名称 |
| project_name | varchar(512) | - | - | - | 项目名称 | 项目名称 |
| customer_name | varchar(512) | - | - | - | 客户名称 | 客户名称 |
| office_code | varchar(25) | - | - | - | 办事处编码 | 办事处编码 |
| office_name | varchar(25) | - | - | - | 办事处名称 | 办事处名称 |
| marketCode | varchar(10) | - | - | - | 市场部编码 | 市场部编码 |
| marketName | varchar(15) | - | - | - | 市场部名称 | 市场部名称 |
| systemId | int(11) | - | - | - | 系统部ID | 系统部ID |
| systemName | varchar(15) | - | - | - | 系统部名称 | 系统部名称 |
| warranty | varchar(2) | - | - | - | 维保年限 | 维保年限 |
| warrantyMonth | double | - | - | - | 维保月数 | 维保月数 |
| barcode2 | varchar(50) | - | - | - | 母子公司发货序列号对应关系 | 母子公司发货序列号对应关系 |
| item2 | varchar(16) | - | - | - | 母子公司发货物料编码对应关系 | 母子公司发货物料编码对应关系 |
| syncTime | datetime | - | - | - | 同步时间 | 缓存数据最后同步刷新时间 |
