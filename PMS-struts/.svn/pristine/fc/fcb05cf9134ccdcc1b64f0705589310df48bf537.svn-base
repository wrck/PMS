...
<body>
<s:form method="post" action="work/AddProcDefDelegate.action" id="AddProcDefDelegate">
				...
				<table class="edittable" width="100%" border="0">
					<tbody align="left">
						...
						<tr>
							...
							<td>
								<INPUT type="text" class="normalInput" style="width: 200px;"
									id="startTime" name="procdefDelegate.startTime"
							...
							<td>
								<INPUT type="text" class="normalInput" style="width: 200px;"
									id="endTime" name="procdefDelegate.endTime"
									size=10 /> <a href="javascript:void(0);"><img src="images/right_riqi.jpg"
						...
						<tr>
							...
							<td colspan="3"><s:radio name="procdefDelegate.status" id="status" list="#{0:'失效',1:'有效'}" value="1"/></td>
						</tr>
						<tr>
