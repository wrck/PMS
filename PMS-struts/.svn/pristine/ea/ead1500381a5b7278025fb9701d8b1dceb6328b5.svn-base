						...
						<div class="content_pm_proplem">
							...
							<div class="yl_one_item">
								...
								<tr>
									...
									<s:if test="#obja.questionType==3">
										<s:if test="pmClQuesnaireResultLineList==null">
											<td><textarea name="pmClQuesnaireResultLineList[<s:property value="%{#indexa.index}"/>].questionAnswer" id="" name="" class="form-control" rows="3"  style="float:left; width: 350px;"></textarea></td>
										</s:if>
										<s:else>
											<s:iterator value="pmClQuesnaireResultLineList" id="objRLine" status="indexRLine">
												<s:if test="#objRLine.quesnaireTemplateLineId==#obja.id">
													<td><textarea readonly="readonly" name="pmClQuesnaireResultLineList[<s:property value="%{#indexa.index}"/>].questionAnswer" id="" name="" class="form-control" rows="3" textSize="small" style="float:left; width: 350px;"><s:property value="%{#objRLine.questionAnswer}"/></textarea><span class="content_pm_proplem_type">[双击可放大或缩小]</span></td>
												</s:if>
											</s:iterator>
										</s:else>
									</s:if>
