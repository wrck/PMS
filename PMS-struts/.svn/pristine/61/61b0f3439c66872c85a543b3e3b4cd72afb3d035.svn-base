...
<script>
	...
	$(document).ready(function(){
		...
		if("<s:property value =  'user.isHasRole(11)'/>"){//服务经理
			$(".serviceManagerTxt").removeAttr("disabled");
			$(".submitBtn").removeAttr("disabled");
		}
		if("<s:property value =  'user.isHasRole(12)'/>"){//项目经理
		...
		if(isRead != -1){
			$("#column012").attr("disabled","disabled");
			 $("#isRead").attr("name","project.column012");
		}
...
<body>
	<s:form enctype="multipart/form-data" method="POST" action="module/ProjectCreate.action" cssClass="form-inline" id="mainForm">
		<s:hidden name="project.contractNo"></s:hidden>
		...
		<div class="form-group form-group-query">
	    	...
	    	<s:textfield disabled="true" name="project.contractNo" id="contractNo" placeholder="合同号..." cssClass="form-control" cssStyle="width: 180px;display: inline-block;" />
		</div><br/>
		<div class="form-group form-group-query">
		...
		<div class="form-group form-group-query">
	    	...
	    	<s:textfield disabled="true" name="project.column004" id="column004" placeholder="市场部..." cssClass="form-control" cssStyle="width: 100px;display: inline-block;" />
	    	<s:textfield disabled="true" name="project.column005" id="column005" placeholder="系统部..." cssClass="form-control" cssStyle="width: 80px;display: inline-block;" />
	    	<s:textfield disabled="true" name="project.column006" id="column006" placeholder="拓展部..." cssClass="form-control" cssStyle="width: 80px;display: inline-block;" />
	    	<s:textfield disabled="true" name="project.column007" id="column007" placeholder="子行业..." cssClass="form-control" cssStyle="width: 80px;display: inline-block;" />
		</div><br/>
		<div class="form-group form-group-query">
		...
		<div class="form-group form-group-query">
	    	...
	    	<s:textfield disabled="true" name="project.projectStartTime" id="projectStartTime" placeholder="项目开始时间..." cssClass="form-control" cssStyle="width: 180px;display: inline-block;" />
		</div>
		<div class="form-group form-group-query">
        ...
        <%-- <div class="form-group form-group-query">
            ...
            <s:select name="project.salesType" id="salesType" cssClass="form-control writeTxt engineeManagerTxt" onchange="changeProgramManagerTxt(this)" 
                list="#{'01':'正常项目','02':'借转销', '14':'总代借货'}" style="width: 180px;display: inline-block;"/>
        </div>
        <br/> --%>
		<div class="form-group form-group-query">
	...
	<nav class="navbar navbar-default" role="navigation" style="margin-top: 20px;">
		<div>
		    <ul class="nav navbar-nav">
		    	<li name="navli" class="active nav0"><a href="javascript:void(0)">设备清单</a></li>
			</ul>
		</div>
	</nav>
	<!-- 设备清单 -->
	<div class="navDiv orderListDiv">
		<display:table
			name="orderDataList" pagesize="${orderDataList.size()}" id="displaytable2"
			size="${orderDataList.size()}" sort="external" export="false"
