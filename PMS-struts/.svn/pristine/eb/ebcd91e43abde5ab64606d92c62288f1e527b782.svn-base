...
public class PmClCBData {
	...
	public double getEquScore() {
		return equScore;
	}
	public void setEquScore(double equScore) {
	...
	public int getCbResult() {
		return cbResult;
	}
	public void setCbResult(int cbResult) {
	...
	public void setPmRealName(String pmRealName) {
		this.pmRealName = pmRealName;
	}
	public int getEvaResult() {
		return evaResult;
	}
	public void setEvaResult(int evaResult) {
