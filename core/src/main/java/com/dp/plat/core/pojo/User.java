...
public class User implements Serializable {
	...
	// 用户类型，0为普通用户，1为系统用户(管理员，特殊用户)
	private Short isSysUser;
	...
	/**
	 * 获取用户类型，0为普通用户，1为系统用户(管理员，特殊用户)
	 * @return isSysUser - 用户类型，0为普通用户，1为系统用户(管理员，特殊用户)
	 */
	public Short getIsSysUser() {
		return isSysUser;
	}

	/**
	 * 设置用户类型，0为普通用户，1为系统用户(管理员，特殊用户)
	 * 
	 * @param isSysUser
	 *            用户类型，0为普通用户，1为系统用户(管理员，特殊用户)
	 */
	public void setIsSysUser(Short isSysUser) {
