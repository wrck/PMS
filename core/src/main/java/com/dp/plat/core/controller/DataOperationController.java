...
public class DataOperationController {
    ...
    public String create(DataOperation dataOperation, Model model) {
    ...
    public String update(@PathVariable("id") Integer id, DataOperation dataOperation) {
    ...
    public void exportOperation(DataOperation dataOperation, HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            String script = dataOperation.getScript();
            script = script.replaceAll("<[^>]+>", "").replaceAll("&lt;", "<").replaceAll("&gt;", ">").replaceAll("&amp;", "&");
            pageParam.setCustomField(script);
