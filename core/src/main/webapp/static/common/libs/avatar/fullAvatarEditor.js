function fullAvatarEditor() {
	...
	var file			= basePath+'/static/common/libs/avatar/fullAvatarEditor.swf';		//flash文件的路径
	var	version			= "10.1.0";						//播放该flash所需的最低版本
	var	expressInstall	= basePath+'/static/common/libs/avatar/expressInstall.swf';			//expressInstall.swf的路径
	var	width			= "100%";							//flash文件的宽度
	var	height			= "100%";							//flash文件的高度
