    ...
    place: function () {
      ...
      this.picker.css({
    	...
    	if (!this.zIndex) {
          ...
          var yorient, bottom_overflow = scrollTop + windowHeight - (offset.top + this.height + this.picker.outerHeight());
          ...
          this.picker.removeClass("datetimepicker-dropdown-bottom-right datetimepicker-dropdown-top-right");
