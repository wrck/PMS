			...
			<div class="col-md-9">
				<div class="box box-primary">
					<div class="box-header with-border">
						<div class="btn-group">
						    <button type="button" class="btn btn-default" data-btn-type="addRoot"><li class="fa fa-plus">&nbsp;新增根菜单</li></button>
						...
						<form class="form-horizontal" id="function-form">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									...
									<label class="control-label"> <input type="radio"  name="deleted" class="flat-red"	value="1"> 禁用
									</label>
								</div>
							</div>
							<div class="form-group">
