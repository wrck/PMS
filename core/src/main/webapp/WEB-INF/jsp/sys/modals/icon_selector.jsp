...
<head>
	...
	<cssTag>
		<style>
			...
			.bs-glyphicons li:hover, #fa-icons div.col-md-3:hover {
...
<body>
	<div class="modal-header">
		...
		<h5 class="modal-title">图标选择器</h5>
	</div>

	<div class="modal-body" id="iconlist">
		<!-- Main content -->
		<section>
			<div class="row">
			<div class="col-xs-12">
				...
				<ul class="nav nav-tabs">
					<li class="active"><a href="#fa-icons" id="tab-fa" data-toggle="tab">Font Awesome</a></li>
					<li><a href="#glyphicons" id="tab-gl" data-toggle="tab">Glyphicons</a></li>
				</ul>
