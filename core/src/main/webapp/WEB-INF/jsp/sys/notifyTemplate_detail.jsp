...
<jsTag>
    ...
    <script src="${pageContext.request.contextPath}/static/plugins/datetimepicker/js/bootstrap-datetimepicker.js"></script>
    ...
    <script>
        ...
        $(function() {
            ...
            //回填id
            if(id!="0"){
                $("#notifyTemplate-form").prepend('<input type="hidden" name="_method" value="PUT">');
